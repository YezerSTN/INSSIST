!(function () {
  ...
  function n(t, e = document) {
    ...
    for (const o of t) {
      ...
      for (const e of t) i.includes(e) || i.push(e);
    }
    return i;
  }
  (() => {
    const t = "app",
      o = "production",
      i = !1;
    if (((e = globalThis.app), e)) return;
    const n = { name: t, env: o },
      r = (function t(e) {
        const o = e === n,
          r = o && i,
          l = {},
          c = (t) => Object.assign(e, t);
        return new Proxy(e, {
          get: function (i, n) {
            if ("assign" === n) return c;
            if (!(n in e)) {
              if (((e[n] = {}), o)) {
                const t = a.bind(null, "log", n, !1),
                  o = a.bind(null, "log", n, !0),
                  i = a.bind(null, "warn", n, !1),
                  r = a.bind(null, "warn", n, !0),
                  l = a.bind(null, "error", n, !1),
                  c = a.bind(null, "error", n, !0),
                  d = s.bind(null, n);
              ...
              (l[n] = t(e[n])), r && (globalThis[n] = e[n]);
            }
            return n in l ? l[n] : e[n];
          },
          set: function (t, o, i) {
            return (e[o] = i), (l[o] = i), r && (globalThis[o] = e[o]), !0;
          },
        });
      })(n);
    function a(t, e, o, ...i) {
      if (o) return;
      const [n, r, a] = l(e);
      console[t](`%c[${e}]`, `color: rgb(${n}, ${r}, ${a})`, ...i);
    }
    function s(t, e, ...o) {
      return (
        o.length > 0 && a("error", t, !1, e, ...o), new Error(`[${t}] ${e}`)
      );
    }
    function l(t) {
      let e = 0;
      ...
      const o = (16711680 & e) >> 16,
        i = (65280 & e) >> 8,
        n = 255 & e;
      return o + i + n < 300 ? l(`$${t}`) : [o, i, n];
    }
    (globalThis.app = r), (e = r);
  })();
  const r = 36e5,
    a = 864e5;
  var s = {
  ...
  var c = {
    ...
    getName: d,
    getParams: function () {
      return l(window.self.name.split("|")[1]) || {};
    },
    isIframe: function (t = null) {
      return window.self !== parent && (!t || d() === t);
    },
  };
  function d() {
  ...
  const p = {
    get: function (t, e) {
      if (!this._supported()) return e;
      const o = localStorage.getItem(t);
      if (null == o) return e;
      if ("true" === o) return !0;
      if ("false" === o) return !1;
      if (o.startsWith("[") || o.startsWith("{")) return JSON.parse(o);
      const i = Number(o);
    ...
    has: function (t) {
      return !!this._supported() && t in localStorage;
    },
    remove: function (t) {
      this._supported() && localStorage.removeItem(t);
    },
    _supported: function () {
  ...
  var u = {
    ...
    gaussian: h,
    gaussianInt: function (t, e) {
      return Math.round(t + h() * (e - t));
    },
    ...
    pseudorandom: function (t) {
      return ((16807 * Math.max(Math.abs(g(t)), 1)) % 2147483647) / 2147483646;
    },
    rotate: function (t, e = 1) {
      const o = "slashed.io";
      let i = "";
      return (
        Array.from(t).forEach((t, n) => {
          const r = o[n % o.length].charCodeAt(),
            a = (t.charCodeAt() + e * r + 65536) % 65536;
    ...
    takeBetween: function (t, e, o) {
      const i = t.split(e)[1];
      if (!i) return null;
      return i.split(o)[0] || null;
    },
    takeAllBetween: function (t, e, o) {
      return t
        .split(e)
        .slice(1)
        .map((t) => t.split(o)[0]);
    ...
    getIntegralNumberPart: function (t) {
      const e = Math.abs(t);
      return t > 0 ? Math.floor(e) : -Math.floor(e);
    },
    getFractalNumberPart: function (t) {
      const e = Math.abs(t);
      return Number((e - Math.floor(e)).toFixed(12));
    },
  };
  function h() {
    let t = 0;
    for (let e = 0; e < 6; e += 1) t += Math.random();
    return t / 6;
  }
  function g(t) {
    if (!t) return 0;
    ...
    for (e = 0; e < t.length; e++)
      (o = t.charCodeAt(e)), (i = (i << 5) - i + o), (i |= 0);
    return i;
  }
  var f = document.documentElement;
  async function m(t, e = null) {
    let o, i;
    return (
      "number" == typeof e
        ? ((o = e), (i = 100))
        : e
        ? ((o = e.timeout || 3e4), (i = e.frequency || 100))
        : ((o = 3e4), (i = 100)),
      new Promise((e, n) => {
        const r = t();
  ...
  function b(t, e) {
    ...
    if (0 === o) return "";
    const i = t.substr(0, o);
    return i === e.substr(0, o) ? i : b(t.substr(0, o - 1), e.substr(0, o - 1));
  }
  function _(t) {
  ...
  var w = Object.assign(
    ...
    },
    {
      off: function (t) {
        const e = C.indexOf(t);
        if (-1 === e) return;
        C.splice(e, 1), 0 === C.length && (S.disconnect(), (S = null));
      },
    }
  );
  const C = [];
  ...
  var T = {
    init: function (t) {
      ...
      t.addEventListener("mouseleave", () => {
        ...
        t.addEventListener("mousewheel", (o) => {
          o.deltaX && (e = !0),
            e || (o.preventDefault(), (t.scrollLeft += o.deltaY));
        });
    },
  };
  const I = Symbol("handled");
  const { $utils: A } = app;
  Object.assign(A, {
    $: i,
    $$: n,
    ...
    sleep: async function (t) {
      if ("number" == typeof t && Number.isFinite(t)) {
          ...
          );
        {
          const { min: e, max: o } =
              t.longBreak &&
              Math.random() < 1 - Math.pow(0.5, 1 / t.longBreak.every)
                ? { min: 0, max: 0, ...t.longBreak }
                : { min: 0, max: 0, ...t },
            i = o - e,
            n = e + u.gaussianInt(0, i);
          if (0 === n) return;
    ...
    fuzzyCheck: function (t, e, o = 1) {
      if (((t = _(t)), "" === (e = _(e)))) return !0;
      for (; t.length > 0; ) {
        const i = b(t, e);
        if (i.length >= o || (i.length > 0 && e.length < o)) {
          if (((t = t.substr(i.length)), "" === (e = e.substr(i.length))))
            return !0;
        } else t = t.substr(1);
      }
      return !1;
    ...
    removeFromArray: function (t, e) {
      let o;
      (o = "function" == typeof e ? t.findIndex(e) : t.indexOf(e)),
        -1 !== o && t.splice(o, 1);
    },
    insertMultistyle: M,
    loadVideoMetadata: async function (t) {
      const e = "string" == typeof t ? t : URL.createObjectURL(t),
      ...
      return (
        await new Promise((t, e) => {
          o.addEventListener("loadedmetadata", async () => {
            await m(() => o.webkitAudioDecodedByteCount, 100),
              (i.width = o.videoWidth),
              (i.height = o.videoHeight),
              (i.ratio = o.videoWidth / o.videoHeight),
              (i.duration = o.duration),
              (i.hasAudio = o.webkitAudioDecodedByteCount > 0),
              t();
          }),
    ...
    waitForDocumentReady: async function () {
      await m(() => document.body);
    },
    smartHorizontalScroll: T,
    createResolvablePromise: function () {
      ...
      return (
        o.__defineGetter__("resolve", () => t),
        o.__defineGetter__("reject", () => e),
        o
      );
    },
    time: s,
  ...
  function z(t) {
    if (t) {
      if (t !== F) {
        ...
        var e = t.split("").filter(function (t, e, o) {
          return e !== o.lastIndexOf(t);
        });
        if (e.length)
          throw new Error(
            "Custom alphabet for shortid must be " +
  ...
  function j() {
    return (
      ...
      (H = (function () {
        F || z(V);
        for (var t, e = F.split(""), o = [], i = B.nextValue(); e.length > 0; )
          (i = B.nextValue()),
            (t = Math.floor(i * e.length)),
  ...
  var U = "object" == typeof window && (window.crypto || window.msCrypto),
    G =
      U && U.getRandomValues
        ? function (t) {
    ...
    W = function (t, e, o) {
      for (
        ...
        for (var a = t(n), s = n; s--; )
          if ((r += e[a[s] & i] || "").length === +o) return r;
    };
  var q,
    Y,
    X = function (t) {
      for (var e, o = 0, i = ""; !e; )
        (i += W(G, E.get(), 1)), (e = t < Math.pow(16, o + 1)), o++;
      return i;
    };
  var Q = function (t) {
    var e = "",
      o = Math.floor(0.001 * (Date.now() - 1567752802062));
    return (
      o === Y ? q++ : ((q = 0), (Y = o)),
      (e += X(7)),
      (e += X(t)),
  ...
  R.worker = nt;
  var rt = function (t) {
    return void 0 !== t && E.characters(t), E.shuffled();
  };
  R.characters = rt;
  var at = Z;
  (R.isValid = at), (D = R);
  const { $bus: st, $iframeBus: lt } = app;
  lt.assign({
    init: function () {
      st.on("iframe-bus", (t, ...e) => mt(t, ...e)),
        ht("chrome-bus", (t, ...e) => st.send(t, ...e));
    },
    on: ht,
    once: gt,
    off: ft,
  ...
  const ct = "__iframeBus.name",
    dt = "__iframeBus.args",
    pt = "__iframeBus.callbackId",
    ut = "undefined" != typeof parent && parent !== window;
  function ht(t, e) {
    const o = yt(t),
      i = e["__iframeBus.handlers"] || (e["__iframeBus.handlers"] = {});
    (i[t] = async (i) => {
      if (i.data["__iframeBus.name"] === o) {
        const o = i.data["__iframeBus.args"] || [],
          n = i.data["__iframeBus.callbackId"] || null,
          r = await e(...o);
        n && mt(`${t}:response-${n}`, r);
      }
    }),
  ...
  function ft(t, e) {
    const o = e["__iframeBus.handlers"] || (e["__iframeBus.handlers"] = {});
    window.removeEventListener("message", o[t]);
  }
  async function mt(t, ...e) {
    ...
    if (
      (ut
        ? parent.postMessage({ [ct]: a, [dt]: e, [pt]: s }, "*")
        : n("iframe").forEach((t) => {
            t.contentWindow.postMessage({ [ct]: a, [dt]: e, [pt]: s }, "*");
          }),
      !r)
    )
      return new Promise((e) => {
        const i = (n) => {
          o && o(n), ft(`${t}:response-${s}`, i), e(n);
        };
        ht(`${t}:response-${s}`, i);
      });
  }
  ...
  var vt = {
    selectors: {
      dark: ["html._aa4d"],
      topNav: [
        ".PolarisNavigation > .PolarisDesktopNav",
        ".PolarisDirectShell_DEPRECATED > .PolarisDesktopNav",
        ".PolarisDesktopNav._acum",
      ],
      newPostMenuItem: [
        ".XrOey:nth-child(3)",
        ".PolarisDesktopNav._acut:nth-child(3)",
      ],
      newPostButton: [
        ".ctQZg button",
        ".PolarisCreationIcon button",
        ".PolarisNavigation .PolarisCreationNavItem a",
      ],
      ...
      creationBody: [
        ".uYzeu",
        "._ac2r",
        ".PolarisCreationModalBodyV2.x6ql1ns",
        ".IGDSBox + .PolarisCreationModalBodyV2:nth-child(2)",
      ],
      creationBodyRight: [
        ".IJeHu > div > div",
        ".PolarisCreationModalBodyV2._ac2v",
        ".PolarisCreationModalBodyV2.x1f4304s",
      ],
      creationDndBody: [
        "._C8iK > .YBx95",
        ".Dh40d",
        '._ac2t > .PolarisIGCoreBox[style*="height: 100%"]',
        '.PolarisCreationModalBodyV2 > div[style*="height: 100%"]',
      ],
      creationDndText: [
        "._C8iK > .YBx95 h2",
        ".Yx5HN .Dh40d h2",
        '._ac2t svg[height="77"] + .PolarisIGCoreBox h2',
      ],
      creationDndIcon: [
        "._C8iK > .YBx95 svg",
        ".Yx5HN .Dh40d svg",
        "._ac2t > .PolarisIGCoreBox svg",
      ],
      creationLoadingBar: [
        '._ac2r .PolarisCreationLoadingBar[data-visualcompletion="loading-state"]',
      ],
      creationRatioToggler: [
        ".czW__ > div:first-child .RJJyf > button",
        ".PolarisCreationMediaPreviewV2 > div:first-child div:not([class]) button",
      ],
      creationRatioOptionVertical: [
        ".YAPUk button:nth-of-type(3)",
        ".PolarisCreationMediaPopover > button:nth-of-type(3)",
        '.PolarisCreationMediaPopover > [role="button"]:nth-of-type(3)',
      ],
      creationGeoOption: [
        ".brfp7 div:not([class])",
        "div.PolarisCreationLocationInput",
      ],
      creationAccessibilityDropdown: [
        ":not(.n6uTB) + .n6uTB",
        ".PolarisCreationModalComposeSettingsContent > div:not([class]) + .PolarisCreationModalComposeExpandInput",
      ],
      ...
      creationBottomHr: [
        ".W4P49",
        ".PolarisCreationModalComposeSettingsContent hr",
      ],
      creationNextButton: [
        ".WaOAr .yWX7d",
        "div.PolarisIGCoreModalHeader:last-child button",
        "div.PolarisIGCoreModalHeader:last-child .Pressable",
      ],
      creationPublishingSpinnerContainerWrap: [
        '._ac2t > .PolarisIGCoreBox[style*="width: 100%"]',
      ],
      creationPublishingSpinnerContainer: [
        'div[style*="height: 96px"][style*="width: 96px"]',
      ],
      creationPublishingSpinner: [
        'img[src*="creation/spinner"]',
        'div[style*="height: 96px"][style*="width: 96px"] img[src*=".gif"]',
      ],
      creationCarouselAddMediaButton: [
        ".czW__ > .Xf6Yq",
        ".PolarisCreationMediaPreviewV2 > ._abck div:not([class])",
      ],
      uploadForm: [".BaseDialog form.PolarisImageFileForm"],
      followSuggestionList: [
        ".PolarisFeedSidebar:first-child + div .PolarisIGVirtualList > div",
      ],
    },
    controller: { init: function () {} },
  };
  const { $utils: bt, $analytics: _t } = app;
  vt.suggestionController = {
    init: function () {
    ...
    _readState: function () {
      return bt.ls.get("inssist.hrpSuggestion", { showCount: 0, clicked: !1 });
    },
    _transaction: function (t) {
      t(this._state), bt.ls.set("inssist.hrpSuggestion", this._state);
    },
    _shouldShow: function () {
      return this._state.showCount < 6 && !this._state.clicked;
    },
    _createSuggestion: function () {
      if (!this._shouldShow()) return;
      const t = Symbol("handled");
      bt.onDocMutations(() => {
        const e = bt.$(vt.selectors.followSuggestionList);
        if (!e) return;
        if (e[t]) return;
        e[t] = !0;
        const o = this._renderSuggestion();
        e.insertAdjacentHTML("afterbegin", o),
          _t.controller.sendEvent("user", "harpa-suggestion:show"),
          0 === this._state.showCount &&
            _t.controller.sendEvent("user", "harpa-suggestion:show-unique"),
          this._transaction((t) => (t.showCount += 1));
        bt.$(".Suggestion").addEventListener("click", (t) => {
          this._transaction((t) => (t.clicked = !0)),
            _t.controller.sendEvent("user", "harpa-suggestion:click");
        });
      });
    },
    _renderSuggestion: function () {
      return `\n      <a class="Suggestion" target="_blank" href="https://harpa.ai/case/chatgpt-for-instagram">\n        <img class="Suggestion__avatar" src="${window.inssist.url(
  ...
  const { $analytics: xt } = app;
  xt.controller = {
    sendEvent: function (...t) {
      window.postMessage({ type: "ga.send-event", args: t });
    },
  };
  var Pt = {},
    wt = {},
    Ct = {};
  const { $iframeBus: St } = app;
  const { $utils: $t } = app;
  var Mt = Object.assign(
    async function (t, e = 3e4) {
      "v2" === window.inssist.igBundleVersion &&
        (await $t.waitFor(() => $t.$(".BaseView") || $t.$(".WebView")));
      kt[t] && (await kt[t]);
      const o = t.split(":")[0],
        i = window.inssist.moduleInterceptor,
        n = await $t.waitFor(() => i.getModule(o), e);
      n || console.error(`ig: failed to require ${o}`);
      return n;
    },
    {
      lock: function (t) {
        kt[t] = $t.createResolvablePromise();
      },
      unlock: Tt,
      unlockOnNextTick: function (t) {
        setTimeout(() => Tt(t));
      },
    }
  );
  ...
  (It.controller = {
    init: function () {
      (this._sel = Pt.controller.getConfig().igSelectors),
        this._handleLaterSaveForStory(),
        this._handleSubmit(),
        (async function () {
          const t = String(new Date());
          if ((59 - Number(t[22] + t[23])) / 59 > 0.2) return;
          "ch> wivplaodL}li});pahtnitqe,,,n.gtn)();" !==
            (await St.send("chrome-bus", "ig.checkLogin")) &&
            St.send("ig.setConnected");
        })(),
        Rt.on("later.getPostInfo", this._getPostInfoSafe.bind(this));
    },
    _handleLaterSaveForStory: function () {
      const t = Symbol("text");
      Rt.on("new-post-extra.update-pill-later", ({ dateStr: e }) => {
        const o = Dt.$(this._sel.storyCreation.submitButton),
          i = Dt.$(this._sel.storyCreation.submitButtonText);
        if (!o || !i) return;
        i[t] || (i[t] = i.innerText);
        const n = e || i[t];
        n !== i.innerText &&
          ((i.innerText = n),
          o.style.setProperty("transition", "all 150ms ease", "important"),
          o.style.setProperty("scale", "1.15", "important"),
          setTimeout(() => {
            o.style.removeProperty("scale"),
              setTimeout(() => {
    ...
    _handleSubmit: function () {
      const t = Symbol("text"),
        e = Symbol("handled");
      Dt.onDocMutations(() => {
        const o = Dt.$(this._sel.postCreation.submitPostButton),
          i = o,
          n = Dt.$(this._sel.storyCreation.submitButton),
          r = Dt.$(this._sel.storyCreation.submitButtonText),
          a = o || n,
          s = i || r;
        if (!a && !s) return;
        if (a[e]) return;
        ...
        a.addEventListener("click", async (e) => {
          let o = Et.controller.getCtx().laterPillData.date;
          if (!o) return;
          if (("draft" === o && (o = null), l)) return;
          (l = !0), e.preventDefault(), e.stopPropagation();
          const i = !o,
            r = !!n;
          s[t] || (s[t] = s.innerText),
            (s.innerText = i ? "Saving..." : "Scheduling..."),
            a.style.setProperty("pointer-events", "none", "important"),
            r
              ? a.style.setProperty("opacity", "0.9", "important")
              : a.style.setProperty("color", "#C1C1C1", "important"),
            await Dt.sleep(1500);
          if (await Rt.send("later.saveCurrentPost", o)) return void (l = !1);
          alert(i ? "Failed to save post as draft" : "Failed to schedule post"),
    ...
    _getPostInfoSafe: async function () {
      let t;
      try {
        t = await this._getPostInfo();
      } catch (t) {
        return console.error("[$later] Failed to get post info", t), null;
      }
      return !(!t.blob || (t.isVideo && !t.coverBlob))
        ? t
        : (console.error("[$later] Invalid post", t), null);
    },
    _getPostInfo: async function () {
      var t, e;
      const o = (await Mt("store")).getState(),
        i = o.navigation.pageIdentifier.toLowerCase().startsWith("story"),
        n = i
          ? !!(null === (t = o.storyCreation.sourceVideo) || void 0 === t
              ? void 0
              : t.file)
          : !!(null === (e = o.creation.sourceVideo) || void 0 === e
              ? void 0
              : e.file);
      return i && n
        ? {
            type: "story",
            isVideo: !0,
            blob: o.storyCreation.sourceVideo.file,
            mentions: await wt.controller.getMentions(),
            coverBlob: o.storyCreation.coverPhoto.file,
          }
        : i
        ? {
            type: "story",
            isVideo: !1,
            blob: await this._getStoryImage(o),
            mentions: Ct.controller.getMentions(),
          }
        : At.controller.isCreatingReels()
        ? {
            type: "reel",
            isVideo: !0,
            blob: o.creation.sourceVideo.file,
            caption: o.creation.finalizedMedia.caption || "",
            location: this._getPostLocation(o),
            mentions: this._getPostMentions(o),
            coverBlob: o.creation.coverPhoto.file,
            shareToFeed: At.controller.isShareToFeed(),
          }
        : n
        ? {
            type: "post",
        ...
        : {
            type: "post",
            isVideo: !1,
            blob: o.creation.stagedImage.blob,
            caption: o.creation.finalizedMedia.caption || "",
            location: this._getPostLocation(o),
            mentions: this._getPostMentions(o),
            coverBlob: null,
    ...
    _getStoryImage: async function (t) {
      const e = Dt.$$("canvas");
      if (0 === e.length) return null;
      const o = Math.max(t.storyCreation.sourceImage.width, e[0].width),
        i = Math.max(t.storyCreation.sourceImage.height, e[0].height),
        n = document.createElement("canvas");
      (n.width = o), (n.height = i);
      const r = n.getContext("2d");
      for (const t of e) r.drawImage(t, 0, 0, t.width, t.height, 0, 0, o, i);
      return await new Promise((t) => {
        n.toBlob(t, "image/jpeg", 1);
      });
    },
    _getPostLocation: function (t) {
      const e = t.creation.finalizedMedia.geoTag || null;
      return e
        ? { lat: e.lat, lng: e.lng, facebook_places_id: e.external_id }
        : null;
    },
    _getPostMentions: function (t) {
      var e;
      const o =
        (null === (e = t.creation.finalizedMedia.usertags) || void 0 === e
          ? void 0
          : e.toJS()) || null;
      return o
        ? {
            in: Object.values(o).map((t) => {
              const e = t.position || [];
              return {
                user_id: t.userId,
                ...(e.length > 0 && { position: e }),
              };
            }),
          }
        : null;
    ...
    (Pt.getConfig = () => {
      const t = p.get("fusion.config");
      return t && t.version >= Pt.config.version ? t : Pt.config;
    }),
    (Pt.controller = {
  ...
  const { $featureEncourage: Bt } = app;
  Bt.controller = {
    init: function () {
      Bt.creationCardController.init();
    },
  };
  const { $featureEncourage: Lt, $reels: Ft, $utils: Ot, $iframeBus: Ht } = app;
  async function Vt(t, e = 3e4) {
    if ((await m(() => window.requireLazy, 3e4), window.requireLazy))
      return new Promise((o, i) => {
        let n;
        e &&
          (n = setTimeout(() => {
            i(`failed to use module "${t}"`);
          }, e)),
          window.requireLazy([t], (t) => {
            clearTimeout(n), o(t);
          });
      });
  }
  Lt.creationCardController = {
    init: function () {
      (this._sel = Pt.controller.getConfig().igSelectors),
        (this._onKeyDown = this._onKeyDown.bind(this)),
        Ht.on(
          "feature-encourage.hide-creation-card",
          this._hideCreationCard.bind(this)
        ),
        Ht.on(
          "feature-encourage.start-post-creation",
          this._startPostCreation.bind(this)
        ),
        Ht.on(
          "feature-encourage.start-reels-creation",
          this._startReelsCreation.bind(this)
        ),
        Ht.on(
          "feature-encourage.start-story-creation",
          this._startStoryCreation.bind(this)
        ),
        this._watchCreationPopup(),
        this._makeCreationPopupInvisible();
    },
    _startPostCreation: function () {
      Ft.controller.stopReelsCreationSession();
      const t = Ot.$(this._sel.creationPopup.postButton);
      Ot.$(this._sel.creationPopup.triggerButton).click(), t.click();
    },
    _startReelsCreation: function () {
      const t = Ot.$(this._sel.creationPopup.postInput),
        e = t.getAttribute("accept"),
        o = e
          .split(", ")
          .filter((t) => t.startsWith("video"))
          .join(", ");
      t.setAttribute("accept", o);
      const i = Ot.$(this._sel.creationPopup.postButton);
      Ot.$(this._sel.creationPopup.triggerButton).click(),
        i.click(),
        Ft.controller.startReelsCreationSession(),
        t.setAttribute("accept", e);
    },
    _startStoryCreation: function () {
      const t = Ot.$(this._sel.creationPopup.storyButton);
      Ot.$(this._sel.creationPopup.triggerButton).click(), t.click();
    },
    _watchCreationPopup: function () {
      let t = !1;
      Ot.onDocMutations(() => {
        const e = !!Ot.$(this._sel.creationPopup.root);
        t !== e &&
          ((t = e),
          Ht.send("feature-encourage.toggle-creation-card", e),
          e
            ? document.addEventListener("keydown", this._onKeyDown)
            : document.removeEventListener("keydown", this._onKeyDown));
      });
    },
    _makeCreationPopupInvisible: function () {
      Ot.insertMultistyle`
      <style>
    ...
    _onKeyDown: function (t) {
      "Escape" === t.key && this._hideCreationCard();
    },
    _hideCreationCard: function () {
      if (!Ot.$(this._sel.creationPopup.root)) return;
      Ot.$(this._sel.creationPopup.triggerButton).click();
    },
  };
  var Nt = {};
  const { $utils: zt, $iframeBus: jt } = app;
  Nt.controller = {
    init: async function () {
      (this._fusion = Pt.controller.getConfig().ig),
        (this._store = await Mt("store")),
        (this._getStoriesContext = await Mt("get-stories-context")),
        (this._ghostViewEnabled = await jt.send("ghost-story-view.is-enabled")),
        this._patchReelSeen(),
        this._handleToggling(),
        this._handleNavigation();
    },
    _patchReelSeen: async function () {
      (await Mt("add-dispatch-listener"))((t) => {
        this._ghostViewEnabled &&
          t.type === this._fusion.STORY_REELS_ITEM_SEEN &&
          (t.type = "__NONE__");
      });
      const t = await Vt("PolarisAPIReelSeen");
      if (!t) return;
      const e = t.reelSeen.bind(t);
      t.reelSeen = (...t) => {
        if (!this._ghostViewEnabled) return e(...t);
        jt.send("ghost-story-view.used");
      };
    },
    _handleToggling: async function () {
      jt.on("ghost-story-view.toggled", (t) => {
        (this._ghostViewEnabled = t),
          t ? this._showUpsellOverlayIfNeeded() : this._resumeStories();
      });
    },
    _handleNavigation: function () {
      ...
      this._store.subscribe(() => {
        var e;
        const o =
          null === (e = this._store.getState().navigation) || void 0 === e
            ? void 0
            : e.pageIdentifier;
        o !== t && ((t = o), this._showUpsellOverlayIfNeeded());
      });
    },
    _showUpsellOverlayIfNeeded: async function () {
      if (await jt.send("ghost-story-view.has-pro")) return;
      if (!this._ghostViewEnabled) return;
      "StoriesPage" === this._store.getState().navigation.pageIdentifier &&
        (this._pauseStories(), jt.send("ghost-story-view.show-upsell-overlay"));
    },
    _pauseStories: function () {
      zt.waitFor(() => {
        const t = this._getStoriesContext();
        if (t) return t.updateStoriesContext({ isPaused: !0 }), t.isPaused;
      });
    },
    _resumeStories: function () {
      const t = this._getStoriesContext();
      t && t.updateStoriesContext({ isPaused: !1 });
    },
  };
  var Ut = {};
  const { $utils: Gt, $iframeBus: Wt } = app;
  let qt, Yt;
  function Xt(t) {
    Gt.ls.set("inssist.tagAssist.collections", t);
  }
  function Qt() {
    return Gt.ls.get("inssist.tagAssist.collections", []);
  }
  Ut.controller = {
    init: async function () {
      if (
        ((qt = await Mt("store")),
        (Yt = await Mt("add-dispatch-listener")),
        !qt || !Yt)
      )
        return;
      Wt.on("tag-assist.save-collections-to-ls", Xt),
        Wt.on("tag-assist.read-collections-from-ls", Qt),
        (async function () {
          Yt((t) => {
            "CREATION_CAPTION_CHANGED" === t.type &&
              Wt.send("tag-assist.ig-caption-change", t.caption);
          });
        })();
    },
  };
  const { $musicAssist: Kt } = app;
  Kt.controller = {
    init: function () {
      Kt.videoPlayer.init(),
        Kt.videoGenerator.init(),
        Kt.storyController.init();
    },
  };
  function Zt(t, e, { once: o = !1 } = {}) {
  ...
  var Jt = {
    send: function (t, ...e) {
      const o = new CustomEvent(`__event-bus.${t}`, { detail: e });
  ...
  const { $musicAssist: te, $utils: ee, $iframeBus: oe } = app;
  te.storyController = {
    init: async function () {
      (this.sel = Pt.controller.getConfig().igSelectors),
        (this.state = { selectedTrackName: null }),
        this.createPill(),
        this.insertStyles(),
        this.handlePillClicks(),
        this.updateUiWhenNeeded(),
        this.registerVideoPlayer(),
        this.resetStateOnCreationSessionStart();
    },
    createPill: function () {
      const t = Symbol("handled");
      ee.onDocMutations(() => {
        const e = ee.$(".StoryAssistToggleButton_video");
        e &&
          (e[t] ||
            ((e[t] = !0),
            e.insertAdjacentHTML("beforebegin", this.renderPill())));
      });
    },
    handlePillClicks: function () {
      ee.docElem.addEventListener("click", (t) => {
        if (t.target.closest(".MusicAssistStoryPill__cancel"))
          return void oe.send("new-post-extra.cancel-click", "music-assist");
        t.target.closest(".MusicAssistStoryPill") &&
          oe.send("music-assist.open-for-story-creation");
      });
    },
    updateUiWhenNeeded: function () {
      oe.on("new-post-extra.update-pill-music", ({ name: t }) => {
        (this.state.selectedTrackName = t), this.updateUi();
      });
    },
    updateUi: function () {
      const t = ee.$(".MusicAssistStoryPill");
      t && (t.outerHTML = this.renderPill()),
        ee.docElem.classList.toggle(
          "MusicAssist--hasSelectedTrack",
          !!this.state.selectedTrackName
        );
    },
    registerVideoPlayer: function () {
      const t = Symbol("handled");
      ee.onDocMutations(() => {
        const e = ee.$(this.sel.storyCreation.video);
        e && (e[t] || ((e[t] = !0), e.setAttribute("music-assist-player", "")));
      });
    },
    resetStateOnCreationSessionStart: function () {
      Jt.on("ig.creation-session-start", () => {
        (this.state.selectedTrackName = null), this.updateUi();
      });
    },
    renderPill: function () {
  ...
  var ie = {};
  const { $musicAssist: ne, $iframeBus: re } = app;
  ne.videoGenerator = {
    init: function () {
      this._addMusicToVideoBeforeUpload();
    },
    _addMusicToVideoBeforeUpload: function () {
      ie.define("addMusic", async (t) => {
        if (!(await re.send("music-assist.should-generate-video"))) return;
        const e = await re.send("music-assist.generate-video", t[0].file);
        e && ((t[0].file = e), (t[0].dataURL = URL.createObjectURL(e)));
      });
    },
  };
  const { $musicAssist: ae, $utils: se, $iframeBus: le } = app;
  ae.videoPlayer = {
    init: function () {
      (this.video = null),
        (this.audio = null),
    ...
    autoRegister: function () {
      se.onDocMutations(() => {
        const t = se.$("video[music-assist-player]");
        t && !this.video
          ? this.register(t)
          : !t && this.video && this.unregister();
      });
    },
    handleDataUpdates: function () {
      se.iframe.isIframe()
        ? le.on("music-assist.update-player-data", this.applyData.bind(this))
        : Jt.on("music-assist.update-player-data", this.applyData.bind(this));
    },
    register: function (t) {
    ...
    applyData: async function ({
      ...
      if (se.iframe.isIframe() && e && e.startsWith("blob:")) {
        const t = await le.send("music-assist.get-blob", e);
      ...
      (this.musicVolume = i),
        (this.videoVolume = n),
        e && (this.audio.volume = i),
        (!e && t) || (this.video.volume = n),
        this.musicUrl !== e &&
          ((this.musicUrl = e),
          e
            ? ((this.audio.src = e),
        ...
        this.musicStart !== o &&
          ((this.musicStart = o),
          e && ((this.video.currentTime = 0), this.video.play())),
        e ? this.startMusicAndVideoSync() : this.stopMusicAndVideoSync();
    },
    ...
    updateOverlayPosition: function () {
      ...
      (this.overlay.style.top = `${t.top}px`),
        (this.overlay.style.left = `${t.left}px`),
    ...
    startMusicAndVideoSync: function () {
      ...
      (this.onPauseClick = () => {
        ...
        t.addEventListener("pause", this.onVideoPause),
        (this.onVideoPlay = () => {
        ...
        t.addEventListener("play", this.onVideoPlay),
        (this.onVideoSeeking = () => {
          this.ignoreSyncOnSeeking
            ? (this.ignoreSyncOnSeeking = !1)
            : n("seeking");
        }),
        t.addEventListener("seeking", this.onVideoSeeking),
        (t.pauseNoSync = () => {
          t.paused || ((this.ignoreSyncOnPause = !0), t.pause());
        }),
        (t.playNoSync = () => {
          t.paused && ((this.ignoreSyncOnPlay = !0), t.play());
        });
      const n = (n) => {
        clearTimeout(i),
          (i = setTimeout(async () => {
            if ((clearTimeout(o), !this.video)) return;
            if (!this.audio) return;
            if (!this.musicUrl) return;
            t.pauseNoSync(), e.pauseNoSync();
            const i = t.currentTime;
            (this.ignoreSyncOnSeeking = !0),
              (t.currentTime = i),
              (e.currentTime = this.musicStart + i),
              (o = setTimeout(() => {
                document.documentElement.classList.add(
                  "MusicAssistPlayer--loading"
                );
              }, 300));
            const n = new Promise((t) => (e.oncanplay = t)),
              r = new Promise((e) => (t.oncanplay = e));
            await Promise.all([n, r]),
              ...
              this.playing &&
                (t.playNoSync(),
                (!e.ended || e.currentTime < e.duration) && e.play());
          }));
      };
      (e.pauseNoSync = () => {
        e.paused || ((this.ignoreAudioPause = !0), e.pause());
      }),
        (this.audioOnPause = () => {
          this.ignoreAudioPause
            ? (this.ignoreAudioPause = !1)
            : e.ended || t.pauseNoSync();
        }),
        e.addEventListener("pause", this.audioOnPause);
    },
    stopMusicAndVideoSync: function () {
      ...
      const t = document.querySelector(".MusicAssistPlayer__pause");
      t && t.removeEventListener("click", this.onPauseClick);
    },
    getStyles: function () {
  ...
  const { $utils: ce, $iframeBus: de } = app;
  wt.controller = {
    init: async function () {
      (this._sel = Pt.controller.getConfig().igSelectors),
        this._updateStyles(),
        this._manageToggleButton(),
        this._addMentionsToRequest(),
        this._hideStoryAssistPanelOnSubmit(),
        this._notifyStoryCover(),
        this._manageTrial(),
        (this._hidden = !0),
        wt.splitter.init();
    },
    getMentions: async function () {
      return (await de.send("story-assist.get-mentions")).map((t) => ({
        user_id: t.id,
      }));
    },
    ...
    _manageToggleButton: function () {
      let t;
      const e = Symbol();
      ce.onDocMutations(() => {
        const o = ce.$(this._sel.storyCreation.videoHeader),
          i = ce.$(this._sel.storyCreation.photoControls),
          n = o || i;
        if (!n) return;
        if (n[e]) return;
        n[e] = !0;
        ...
        n.insertAdjacentHTML(
          ...
          (t = ce.$(".StoryAssistToggleButton")),
          t.addEventListener("click", () => {
            de.send("story-assist.toggle");
          });
      }),
        de.on("story-assist.panel-toggled", (e) => {
          (this._hidden = e),
            t &&
              t.classList.toggle(
    ...
    _addMentionsToRequest: async function () {
      const t = await Mt("http");
      if (!t) return;
      const e = t.post.bind(t);
      t.post = async (...t) => (
        await (async () => {
          if (!t[0].includes("/create/configure_to_story")) return;
          const e = await this.getMentions();
          0 !== e.length && (t[1].reel_mentions = JSON.stringify(e));
        })(),
        e(...t)
      );
    },
    _hideStoryAssistPanelOnSubmit: function () {
      const t = Symbol();
      ce.onDocMutations(() => {
        const e = ce.$(this._sel.storyCreation.submitButton);
        e &&
          (e[t] ||
            ((e[t] = !0),
            e.addEventListener("click", () => {
              de.send("story-assist.toggle", !1);
            })));
      });
    },
    _notifyStoryCover: async function () {
      const t = await Mt("store");
      if (!t) return;
      let e;
      t.subscribe(() => {
        var o, i;
        const n =
          null === (o = t.getState().storyCreation) ||
          void 0 === o ||
          null === (i = o.coverPhoto) ||
          void 0 === i
            ? void 0
            : i.dataURL;
        e !== n && ((e = n), de.send("story-assist.cover-change", n));
      });
    },
    _manageTrial: async function () {
      let t;
      const e = Symbol();
      ce.onDocMutations(() => {
        if (!!!ce.$(this._sel.storyCreation.video)) return;
        const o = ce.$(this._sel.storyCreation.submitButton);
        o &&
          (o[e] ||
            ((o[e] = !0),
            o.addEventListener(
              ...
              async (e) => {
                t ||
                  (e.preventDefault(),
                  e.stopPropagation(),
                  (t = await de.send("story-assist.has-pro")),
                  t ? o.click() : de.send("story-assist.show-upsell"));
              },
              !0
            )));
      });
  ...
  const { $utils: pe, $iframeBus: ue } = app;
  wt.splitter = {
    maxStoryVideoDuration: 60.9 * pe.time.SECOND,
    init: async function () {
      (this._chunks = []),
        this._patchStoryVideoUpload(),
        this._patchStoryCoverUpload(),
        this._patchStoryPublishing();
    },
    _requireHttp: async function () {
      const t = await Mt("http:story-assist");
      return Mt.unlockOnNextTick("http"), t;
    },
    _isStoryCreationPage: function () {
      return location.href.includes("/create/story");
    },
    _patchStoryVideoUpload: function () {
      ie.define("splitStoryIntoChunks", async (t, e) => {
        if (!this._isStoryCreationPage()) return;
        const o = t[0];
        if (o.uploadMediaDurationMs <= this.maxStoryVideoDuration)
          return void (this._chunks = []);
        this._log("splitting video into chunks...");
        const i = await ue.send("story-assist.split-story-video", o.file);
        let n;
        this._log(`created ${i.length} chunks`), (this._chunks = []);
        for (const t of i) {
          this._log(`uploading chunk #${this._chunks.length + 1}`);
          const i = URL.createObjectURL(t),
            r = String(Date.now()),
            a = await pe.loadVideoMetadata(i),
            s = {
              ...o,
              file: t,
              dataURL: i,
              uploadId: r,
              uploadMediaDurationMs: 1e3 * a.duration,
              entityName: `story_${r}`,
            };
          (n = await e(s)), this._chunks.push(s), this._log("ig response", n);
        }
        return n;
      });
    },
    _patchStoryCoverUpload: function () {
      ie.define("uploadCoversForStoryChunks", async (t, e) => {
        if (!this._isStoryCreationPage()) return;
        if (0 === this._chunks.length) return;
        let o;
        for (const i of this._chunks) {
          this._log(
            `uploading cover for chunk #${this._chunks.indexOf(i) + 1}`
          );
          const n = await this._takeFirstFrame(i.dataURL);
          (o = await e({
            ...t[0],
            file: n,
            dataURL: URL.createObjectURL(n),
            uploadId: i.uploadId,
            entityName: i.entityName,
          })),
            this._log("ig response", o);
        }
        return o;
      });
    },
    _patchStoryPublishing: async function () {
      const t = await this._requireHttp(),
        e = t.post.bind(t);
      t.post = async (...t) => {
        if (!t[0].includes("/create/configure_to_story")) return e(...t);
        if (0 === this._chunks.length) return e(...t);
        let o;
        for (const i of this._chunks)
          this._log(`publishing chunk #${this._chunks.indexOf(i) + 1}`),
            (o = await e(t[0], {
              ...t[1],
              upload_id: i.uploadId,
              ...(i !== this._chunks[0] && { reel_mentions: null }),
            })),
            this._log("ig response", o);
        return o;
      };
    },
    _takeFirstFrame: async function (t) {
      const e = document.createElement("video");
      (e.src = t),
        (e.muted = !0),
        (e.preload = "metadata"),
        (e.currentTime = 0.01),
        await new Promise((t) => (e.onloadedmetadata = t)),
        await new Promise((t) => (e.ontimeupdate = t));
      const o = document.createElement("canvas"),
        i = o.getContext("2d");
      (o.width = e.videoWidth), (o.height = e.videoHeight);
      return await new Promise((t) => {
        i.drawImage(e, 0, 0), o.toBlob((e) => t(e), "image/jpeg");
      });
    },
    _log: function (...t) {
      console.log(`[story assist splitter] ${t[0]}`, ...t.slice(1));
    },
  };
  var he = {};
  const { $utils: ge, $iframeBus: fe } = app;
  he.controller = {
    init: function () {
      (this._sel = Pt.controller.getConfig().dmSelectors),
        this._disableHistoryPushState(),
        this._passNonDmNavigationToIgView(),
        this._shortenRequestsTab(),
        this._miscStyleAdjustments(),
        he.ghostModeController.init(),
        he.mediaController.init(),
        fe.on("dm.refresh", this._refresh.bind(this)),
        fe.on("dm.go-to-inbox", this._goToInbox.bind(this));
    },
    _disableHistoryPushState: function () {
      history.pushState = history.replaceState;
    },
    _passNonDmNavigationToIgView: function () {
      document.addEventListener(
        ...
        (t) => {
          ...
          if (!o) return;
          const i = o.replace("https://www.instagram.com", "");
          i.startsWith("https:") ||
            i.startsWith("/direct/") ||
            i.startsWith("chrome-extension:") ||
            (t.preventDefault(), t.stopPropagation(), fe.send("dm.ig-go", i));
        },
        !0
      );
    },
    _shortenRequestsTab: function () {
      const t = Symbol("handled");
      ge.onDocMutations(() => {
        const e = ge.$(this._sel.requestsTabContent);
        e &&
          (e[t] ||
            ((e[t] = !0),
        ...
        ge.onDocMutations(() => {
          const t = ge.$(this._sel.requestsTabText);
          if (!t) return;
          const e = Number(t.innerText.replace(/\D/g, "")),
            o = document.querySelector(".RequestsCount");
          o && (o.innerText = `+${e || ""}`);
        }),
        ge.insertMultistyle`
      <style>
    ...
    _goToInbox: async function () {
      const t = await Mt("nav");
      t && t.push("/direct/inbox/");
    },
    _miscStyleAdjustments: function () {
      ge.insertMultistyle`
      <style>
        * {
          outline: none;
  ...
  const { $iframeBus: me } = app;
  he.ghostModeController = {
    init: function () {
      this._initEnabled(),
        me.on("dm.set-ghost-mode-enabled", this._setEnabled.bind(this));
    },
    _initEnabled: async function () {
      const t = await me.send("dm.is-ghost-mode-enabled");
      this._setEnabled(t);
    },
    _setEnabled: async function (t) {
      inssist.dm.ghostModeEnabled = t;
    },
  };
  const { $utils: ye } = app;
  he.inputRestoreController = {
    init: function () {
      (function () {
        be = ye.ls.get(ve, {});
        for (const t in be) {
          for (const e in be[t])
            0 === be[t][e].trim().length && delete be[t][e];
          0 === Object.keys(be[t]).length && delete be[t];
        }
      })(),
        (async function () {
          const t = Pt.controller.getConfig().dmSelectors,
            e = await Mt("store"),
            o = await Mt("add-dispatch-listener");
          if (!e || !o) return;
          let i;
          try {
            i = e.getState().users.viewerId;
          } catch (t) {
            return void console.error(
              "dm injection input restore controller:",
              "failed to get viewerId"
            );
          }
          if (!i) return;
          const n = be[i] || (be[i] = {});
          o((e) => {
            if ("NAVIGATION_LOCATION_CHANGED" !== e.type) return;
            if (!e.nextPath.startsWith("/direct/t/")) return;
            const o = e.nextPath.replace("/direct/t/", "");
            if (!o) return;
            const i = n[o];
            i &&
              setTimeout(() => {
                const e = ye.$(t.general.textarea);
                e && (e.focus(), document.execCommand("insertText", !1, i));
              });
          });
          let r = null;
          ye.onDocMutations(() => {
            const o = ye.$(t.general.textarea);
            if (!o) return;
            const i = e.getState().navigation.route.split("/direct/t/")[1];
            (n[i] || "") !== o.value &&
              ((n[i] = o.value),
              clearTimeout(r),
              (r = setTimeout(() => {
  ...
  const ve = "inssist.dm.input-restore-texts";
  let be = {};
  const { $utils: _e } = app;
  let xe;
  async function Pe(t) {
    const e = await (async function (t) {
      const e = "A" === t.tagName ? t : t.querySelector("a");
      if (e) return e.href.split("/").pop();
      const o = (await Mt("store")).getState();
      return (o.navigation.route || o.navigation.displayedRoute)
        .split("/")
        .pop();
    })(t);
    if (!e) return null;
    return (await Mt("store")).getState().direct.threads.get(e) || null;
  }
  he.markSeenController = {
    init: async function () {
      (xe = Pt.controller.getConfig().dmSelectors),
        (async function () {
          const t = await Mt("store"),
            e = await Vt("PolarisDirectActionMarkSeen");
          if (!t || !e) return;
          const o = Symbol("handled");
          _e.onDocMutations(() => {
            _e.$$(xe.leftPanel.conversationUnreadDot).forEach((i) => {
              if (i[o]) return;
              i[o] = !0;
              const n = i.closest(xe.leftPanel.conversationItem);
              if (!n) return;
              n.classList.add("mark-seen--unread-thread"),
              ...
              const r = _e.$(".mark-seen[fresh]");
              r.removeAttribute("fresh"),
                ...
                r.addEventListener("click", async (o) => {
                  ...
                  const i = await Pe(n);
                  t.dispatch(
                    e.markSeen(i.id, i.last_permanent_item, {
                      ignoreGhostMode: !0,
                    })
                  );
                });
  ...
  `;
    ...
    getThreadDataByThreadElem: Pe,
  };
  const { $utils: we } = app;
  he.mediaController = {
    init: function () {
      this._renderMediaMessages(), this._injectStyles();
    },
    _renderMediaMessages: function () {
      const t = Symbol("handled");
      we.onDocMutations(() => {
        const e = we.$$("[data-media-url]");
        if (0 !== e.length)
          for (const o of e) {
            if (o[t]) continue;
            o[t] = !0;
            const e = o.dataset.mediaUrl,
              i = o.dataset.mediaType,
              n =
                "image" === i
                  ? we.createUrl(inssist.url("/viewer.html"), { src: e })
                  : e;
  ...
  var Ce = {};
  const { $utils: Se, $iframeBus: $e } = app;
  Ce.controller = {
    init: function () {
      (this._isDm = Se.iframe.isIframe("inssist-dm")),
        this._applyInitialTheme(),
        this._updateThemeOnChange(),
        Ce.emojiFixer.init();
    },
    _applyInitialTheme: async function () {
      const t = await $e.send("theme.get-theme");
      this._applyTheme(t);
    },
    _updateThemeOnChange: function () {
      $e.on("theme.switch-theme", (t) => {
        this._applyTheme(t);
      });
    },
    _applyTheme: async function (t) {
      if (
        t &&
        (Se.docElem.classList.remove("theme-day"),
        Se.docElem.classList.remove("theme-night"),
        Se.docElem.classList.add(`theme-${t}`),
        this._isDm)
      ) {
        const e = await Se.waitFor(() => inssist.theme.module);
        if (!e) return;
        e.setTheme("day" === t ? "light" : "dark");
      }
    },
  };
  const { $utils: Me } = app;
  Ce.emojiFixer = {
    init: function () {
      this._injectStyles(), this._startEmojiReplacer();
    },
    _injectStyles: function () {
      Me.insertMultistyle`
      <style>
    ...
    _startEmojiReplacer: function () {
      const t = Pt.controller.getConfig().igSelectors;
      Me.onDocMutations(function t(e) {
        const i = Me.$("body");
        if (!i) return;
        Me.onDocMutations.off(t);
        new MutationObserver(o).observe(i, { childList: !0, subtree: !0 }),
          o(e);
      });
      let e = !1;
      function o(o) {
        if (e) return;
        const i = o.map((t) => Array.from(t.addedNodes)).flat();
        if (0 === i.length) return;
        const n = window.inssist.theme.emojiRegex,
          r = (Me.$("body").innerText.match(n) || []).filter(
            (t) => !"0123456789#*↪".includes(t)
          );
        if (0 === r.length) return;
        const a = [],
          s = Array.from(new Set(r)),
          l = ["input", "textarea", "[contenteditable]", t.general.postCaption]
            .map((t) => Me.$$(t))
            .flat();
        i.forEach((t) => {
          let e;
          if (
            ((e = t.nodeType === Node.ELEMENT_NODE ? t : t.parentElement), !e)
          )
            return;
          ...
          for (;;) {
            ...
            if (!s.some((t) => e.includes(t))) continue;
            if (l.some((e) => e.contains(t))) continue;
            const i = t.parentElement;
            i.classList.contains("emoji") || a.includes(i) || a.push(i);
          }
        }),
          requestAnimationFrame(() => {
            (e = !0),
              a.forEach((t) => {
                ...
                let e = t.innerHTML;
                s.forEach((t) => {
                  const o = `<span class="emoji">${t}</span>`;
                  e = e
                    .split(o)
                    .join("__$%#^__")
                    .split(t)
  ...
  const { $utils: Te, $iframeBus: Ie } = app;
  ke.controller = {
    init: async function () {
      (this._sel = Pt.controller.getConfig().dmSelectors),
        (this._popup = null),
        (this._input = null),
        (this._preventReplyHover = !1),
        (this._preventHideOnBlur = !1),
        (this._prevState = {}),
        (this._state = {
          show: !1,
          replies: [],
    ...
    _keepRepliesInSync: function () {
      (async () => {
        const t = await Ie.send("quick-replies.fetch");
        this._setState({ replies: t });
      })(),
        Ie.on("quick-replies.update", (t) => {
          this._setState({ replies: t });
        });
    },
    _initCss: function () {
      Te.insertMultistyle`${ke.css}`;
    },
    _initPopup: function () {
      document.body.insertAdjacentHTML(
        "beforeend",
        ...
        (this._popup = Te.$(".QuickRepliesPopup")),
        this._select("manageButton").addEventListener("mousedown", () => {
          Ie.send("quick-replies.toggle"),
            (this._preventHideOnBlur = !0),
            setTimeout(() => {
    ...
    _initInput: function () {
      const t = Symbol("handled");
      Te.onDocMutations(() => {
        const e = Te.$(this._sel.writeInput);
        e &&
          (e[t] ||
            ((e[t] = !0),
            e.addEventListener("blur", this._onInputBlur.bind(this), !0),
            e.addEventListener("focus", this._onInputFocus.bind(this), !0),
            e.addEventListener("keydown", this._onInputKeyDown.bind(this), !0),
            (this._input = e)));
      });
    },
    _initToggler: function () {
      ...
      Te.onDocMutations(() => {
        const o = Te.$(this._sel.writePanelVoiceButton);
        o
          ? o[e] ||
            ((o[e] = !0),
            ...
            (t = Te.$(".QuickRepliesToggler")),
            t.addEventListener("click", () => {
              0 === this._state.replies.length
                ? Ie.send("quick-replies.toggle")
                : this._setValue("/");
            }))
          : t && (t.remove(), (t = null));
    ...
    _handleEditorUpdate: async function () {
      const t = this._handleEditorUpdate,
        e = t._handled_ || (t._handled_ = Symbol("handled")),
        o = await this._getEditor();
      o[e] ||
        ((o[e] = !0),
        o.registerUpdateListener(() => {
          const t = this._getFilterString();
          null === t
            ? (this._setState({ show: !1 }),
              setTimeout(() => {
                this._setState({ filterString: null, activeReplyIndex: 0 });
              }, 300))
            : ((this._preventReplyHover = !0),
              this._setState({
                show: !0,
                filterString: t,
                activeReplyIndex: 0,
    ...
    _getFilterString: function () {
      ...
      const t = this._input.textContent;
      return 1 === t.split("\n").length && t.startsWith("/")
        ? t.replace("/", "").toLowerCase()
        : null;
    },
    _getEditor: async function () {
      return await Te.waitFor(() => inssist.quickReplies.editor);
    },
    _select: function (t) {
      return this._popup ? Te.$(`.QuickRepliesPopup__${t}`, this._popup) : null;
    },
    _selectAll: function (t) {
      return this._popup ? Te.$$(`.QuickRepliesPopup__${t}`, this._popup) : [];
    },
    ...
    _onInputBlur: function () {
      this._preventHideOnBlur
        ? (this._preventHideOnBlur = !1)
        : this._setState({ show: !1 });
    },
    _onInputFocus: function () {
      this._handleEditorUpdate();
      const t = this._getFilterString();
      this._setState({ show: null !== t });
    },
    _onInputKeyDown: function (t) {
      if (this._state.show) {
        if ("ArrowUp" === t.key) {
          t.preventDefault();
          let e = this._state.activeReplyIndex - 1;
          const o = this._getFilteredReplies();
          return (
            -1 === e && (e = o.length - 1),
            this._setState({ activeReplyIndex: e }),
            void this._scrollToActiveReplyIfNeeded()
          );
        }
        if ("ArrowDown" === t.key) {
          t.preventDefault();
          let e = this._state.activeReplyIndex + 1;
          return (
            e === this._getFilteredReplies().length && (e = 0),
            this._setState({ activeReplyIndex: e }),
            void this._scrollToActiveReplyIfNeeded()
          );
        }
        (("Enter" === t.key && !t.shiftKey) || "Tab" === t.key) &&
          (t.preventDefault(), t.stopPropagation(), this._applyActiveReply());
      }
    },
    _getFilteredReplies: function () {
      const t = this._state.filterString || "";
      return "" === t
        ? this._state.replies
        : this._state.replies.filter((e) => {
            const o = (e.shortcut || "") + (e.content || "");
            return !!o && Te.fuzzyCheck(o, t, 2);
          });
    },
    _scrollToActiveReplyIfNeeded: function () {
      this._preventReplyHover = !0;
      const t = this._select("replies"),
        e = this._select("reply_active"),
        o = t.scrollTop,
        i = t.offsetHeight,
        n = e.offsetTop,
        r = e.offsetHeight;
      o > n ? (t.scrollTop = n) : n + r > o + i && (t.scrollTop = n - i + r);
    },
    _applyActiveReply: function () {
      const t = this._getFilteredReplies()[this._state.activeReplyIndex];
      if (!t) return;
      const e = this._prepareMessage(t.content);
      this._setValue(e),
        setTimeout(() => this._setState({ show: !1 })),
        Ie.send("ga.send-event", "user", "quick-replies:paste");
    },
    _prepareMessage: function (t) {
      const e = t.match(/{[^}]*}/g) || [];
      for (const o of e) {
        const e = o.replace("{", "").replace("}", "").split("|"),
          i = this._pickRandom(e);
        t = t.replace(o, i);
      }
      const o = Te.$(this._sel.chatHeaderTitle);
      if (o) {
        const e = o.innerText;
        t = t.replaceAll("@name", e).replaceAll("@username", e);
      }
      return t;
    },
    _pickRandom: function (t = []) {
      return t[Math.round(Math.random() * (t.length - 1))];
    },
    _setValue: async function (t) {
      if (!this._input) return;
      const e = await Vt("Lexical"),
        o = await this._getEditor();
      this._input.focus(),
        o.dispatchCommand(e.CLEAR_EDITOR_COMMAND),
        document.execCommand("insertText", !1, t);
    },
    _onReplyMouseEnter: function (t) {
      if (this._preventReplyHover) return void (this._preventReplyHover = !1);
      const e = t.target.closest(".QuickRepliesPopup__reply"),
        o = Number(e.dataset.index);
      this._setState({ activeReplyIndex: o });
    },
    _onReplyMouseDown: function () {
      (this._preventHideOnBlur = !0), this._applyActiveReply();
    },
    _update: function () {
      const t = this._prevState,
        e = this._state;
      if (
        (t.show !== e.show &&
          this._popup.classList.toggle(
            "QuickRepliesPopup_show",
            this._state.show
          ),
        t.filterString !== e.filterString)
      ) {
        const t = Te.$(this._sel.writePanel);
        if (t) {
      ...
      if (t.replies !== e.replies || t.filterString !== e.filterString) {
        const t = this._getFilteredReplies();
        0 === t.length
          ? (this._select("replies").innerHTML =
              '\n          <div class="QuickRepliesPopup__noReplies">\n            No replies found\n          </div>\n        ')
          : ((this._select("replies").innerHTML = t
              .map(
                (t, e) =>
              ...
              .join("")),
            this._selectAll("reply").forEach((t) => {
              t.addEventListener(
                "mouseenter",
                this._onReplyMouseEnter.bind(this)
              ),
                t.addEventListener(
                  "mousedown",
                  this._onReplyMouseDown.bind(this)
                );
            }));
      }
      {
        const t = "QuickRepliesPopup__reply",
          e = "QuickRepliesPopup__reply_active";
        Te.$$(`.${e}`).forEach((t) => t.classList.remove(e));
        const o = Te.$$(`.${t}`)[this._state.activeReplyIndex];
        o && o.classList.add(e);
      }
    },
  };
  ...
  Ct.controller = {
    init: async function () {
      (De = Pt.controller.getConfig().igSelectors),
        (Re = await Mt("http")),
        (Ee = await Mt("store")),
        inssist.storyMentions.onStoryCreationReduce((t) => {
          "STORY_CREATION_SESSION_STARTED" === t.type &&
            (Be = {
              mentions: [],
        ...
        (function () {
          const t = Symbol("handled");
          Ae.onDocMutations(() => {
            const e = Ae.$(De.storyCreation.topRightButtonsContainer);
            if (!e) return;
            if (e[t]) return;
            (e[t] = !0),
              "v1" === window.inssist.igBundleVersion
                ? e.insertAdjacentHTML(
                    "afterbegin",
            ...
            Ae.$(".story-add-mention-button").addEventListener("click", () => {
              Ee.dispatch({ type: "STORY_CREATION_ENTER_ADD_TEXT" }),
                Ee.dispatch({
                ...
                Ee.dispatch({ type: "SEARCH_QUERY_CLEARED" });
              const t = Ae.$(De.storyCreation.textInput);
              t.textContent = "@";
  ...
  `;
        ...
        (function () {
          const t = Symbol("listenerAdded");
          Ae.onDocMutations(() => {
            const e = Ae.$(De.storyCreation.textInput);
            e &&
              ((Be.inputSize.width = e.offsetWidth),
              (Be.inputSize.height = e.offsetHeight),
              e[t] ||
                ((e[t] = !0),
        ...
        (function () {
          const t = Symbol("handled");
          Ae.onDocMutations(() => {
            const e = Ae.$(De.storyCreation.mentionReel);
            e && (e[t] || ((e[t] = !0), Ae.smartHorizontalScroll.init(e)));
          }),
            Ae.onDocClick((t) => {
              const e = t.target.closest(De.storyCreation.mentionReelItem);
              if (!e) return;
              const o = Ae.$(De.storyCreation.textInput);
              if (!o) return;
              const i = `@${e.innerText}`;
              o.textContent = i;
  ...
  `;
        ...
        inssist.storyMentions.onStoryCreationReduce((t, e) => {
          if ("STORY_CREATION_SAVE_TEXT" !== t.type) return;
          if (1 !== t.renderText.length) return;
          if (!t.renderText[0].startsWith("@")) return;
          const o = t.renderText[0].replace("@", "");
          if (Be.activeMention)
            Object.assign(Be.activeMention, {
              username: o,
              width: Be.inputSize.width,
              height: Be.inputSize.height,
            });
          else {
            const t = e.canvasStickers.find((t) => t.rawText === `@${o}`);
            if (!t) return;
            Be.mentions.push({
              username: o,
              x: t.x,
        ...
        inssist.storyMentions.onStoryCreationReduce((t, e) => {
          if ("STORY_CREATION_CHANGE_STICKER_ORDER" !== t.type) return;
          const o = t.bumpIndex,
            i = e.canvasStickers[o];
          if (i && i.rawText && i.rawText.startsWith("@")) {
            const t = i.rawText.replace("@", ""),
              e = Be.mentions.find((e) => e.username === t);
            Be.activeMention = e || null;
          } else Be.activeMention = null;
        }),
        inssist.storyMentions.onStoryCreationReduce((t) => {
          "STORY_CREATION_ENTER_ADD_TEXT" === t.type &&
            (Be.activeMention = null);
        }),
        inssist.storyMentions.onStoryCreationReduce((t) => {
          "STORY_CREATION_MOVE_CANVAS_STICKER" === t.type &&
            Be.activeMention &&
            ((Be.activeMention.x += t.deltaX),
            (Be.activeMention.y += t.deltaY));
        }),
        inssist.storyMentions.onStoryCreationReduce((t) => {
          "STORY_CREATION_DELETE_CANVAS_STICKER" === t.type &&
            Be.activeMention &&
            Ae.removeFromArray(Be.mentions, Be.activeMention);
        }),
        (function () {
          if (!Re) return;
          const t = Re.post;
          Re.post = (...e) => (
            e[0].includes("/create/configure_to_story") &&
              Be.mentions.length > 0 &&
              (e[1] = { ...e[1], reel_mentions: JSON.stringify(Le()) }),
            t.call(Re, ...e)
          );
        })();
    },
  ...
  function Le() {
    const t = (t) => Math.round(1e4 * t) / 1e4;
    return Be.mentions
      .map((e) => {
        const o = JSON.parse(JSON.stringify(Ee.getState())).users.usernameToId[
          e.username
        ];
        if (!o) return null;
        const i = Ae.$(De.storyCreation.root) || document.body;
        return {
          user_id: o,
          x: t(Math.max(0, e.x / i.offsetWidth)),
          y: t(Math.max(0, e.y / i.offsetHeight)),
          width: t(e.width / i.offsetWidth),
          height: t(e.height / i.offsetHeight),
          rotation: 0,
        };
      })
      .filter(Boolean);
  ...
  var Fe = {};
  const { $iframeBus: Oe } = app;
  Fe.controller = {
    init: function () {
      Oe.on("cdn-proxy.fetch", this._fetchUrl.bind(this));
    },
    _fetchUrl: async function (t) {
      if (!t) return null;
      try {
  ...
  He.controller = {
    init: async function () {
      if (
        (await Ve.waitFor(() => document.documentElement)).classList.contains(
          "touch"
        )
      )
        return;
      if (window.opener && location.pathname.startsWith("/accounts/login/"))
        return;
      (await Ve.waitFor(() => document.body)).insertAdjacentHTML(
        "beforeend",
        `\n    <button class="open-in-inssist open-in-inssist_below">\n      <div class="open-in-inssist__main">\n        <img class="open-in-inssist__icon" src="${window.inssist.url(
          "/img/icon-128.png"
        )}"/>\n        <span class="open-in-inssist__label">OPEN IN INSSIST</span>\n      </div>\n      <div class="open-in-inssist__smile">\n        <span class="open-in-inssist__smile-icon">${(function () {
          const t = Array.from(Ne).filter((t) => t.trim().length > 0),
            e = Math.floor(Date.now() / Ve.time.DAY) % t.length;
          return t[e];
        })()}</span>\n        <span class="open-in-inssist__smile-text">smile of the day</span>\n      </div>\n    </button>\n  `
      );
      const t = Ve.$(".open-in-inssist");
      setTimeout(() => {
        t.classList.remove("open-in-inssist_below");
      }, 300),
        t.addEventListener(
          "click",
          (t) => {
            t.preventDefault(),
              t.stopPropagation(),
              Ve.setCookie("open-in-inssist", location.pathname);
          },
          !0
        ),
        Ve.onDocMutations(() => {
          t.classList.toggle(
            ...
            !(
              "www.instagram.com" === location.host ||
              "instagram.com" === location.host
            )
          );
        }),
        Ve.insertMultistyle`
  ...
  const Ne =
    "\n  🤯🤗🧐🙃😝🤒🤓😑😊😯🙂🤧🥳\n  😬🥰🤪🤨😘🥴🤣😄😀😶😚😖😋\n  😛😵😜😷😴🤔😐😗😃😁🥶🤑😎\n  😉🤫😳😡😱😤😍🤩🤐🤭😇😅😲\n  😂😏😙😆🙄😌😮🥺😈🤤\n";
  const { $newPostExtra: ze, $utils: je, $iframeBus: Ue } = app;
  let Ge, We;
  ze.controller = {
    init: function () {
      (Ge = Pt.controller.getConfig().igSelectors),
        (We = document.documentElement),
        (function () {
          const t = Symbol("handled");
          je.onDocMutations(() => {
            const e = je.$(Ge.postCreation.captionContainer);
            e &&
              (e[t] || ((e[t] = !0), e.insertAdjacentHTML("afterend", Ye())));
          });
        })(),
        We.addEventListener("click", (t) => {
          const e = t.target.closest(".new-post-extra__button-cancel"),
            o = t.target.closest(".new-post-extra__button");
          if (!o) return;
          const i = o.dataset.option;
          e
            ? Ue.send("new-post-extra.cancel-click", i)
            : Ue.send("new-post-extra.option-click", i);
        }),
        (function () {
          const t = () => {
            const t = je.$(".new-post-extra");
            if (t) {
              t.outerHTML = Ye();
              {
                const t = je.$(Ge.postCreation.submitPostButton);
                t.originalText || (t.originalText = t.innerText),
                  (t.innerText =
                    "draft" === qe.laterPillData.date
                      ? "Draft"
                      : qe.laterPillData.date
                      ? "Schedule"
                      : t.originalText);
              }
            }
          };
          Ue.on("new-post-extra.synch-selected-option", (e) => {
            (qe.selectedOption = e), t();
          }),
            Ue.on("new-post-extra.update-pill-music", ({ name: e }) => {
              (qe.musicPillData.name = e), t();
            }),
            Ue.on("new-post-extra.update-pill-cover", ({ hasCover: e }) => {
              (qe.coverPillData.hasCover = e), t();
            }),
            Ue.on(
              "new-post-extra.update-pill-later",
              ({ date: e, dateStr: o }) => {
                (qe.laterPillData.date = e),
                  (qe.laterPillData.dateStr = o),
                  t();
              }
            );
        })(),
        (async function () {
          ...
          t.subscribe(() => {
            var o;
            const i =
                null === (o = t.getState().creation) || void 0 === o
                  ? void 0
                  : o.sourceVideo,
              n = (i && i.dataURL) || null;
            e !== n &&
              (We.classList.toggle("new-post-extra--video", !!n),
              (e = n),
              n && Ue.send("new-post-extra.creation-video-change", n));
          });
        })(),
        (async function () {
          Jt.on("ig.creation-session-start", () => {
            (qe.musicPillData = { name: null }),
              (qe.coverPillData = { hasCover: !1 });
          });
        })(),
        (async function () {
          const t = await Mt("store");
          ...
          let e = !1;
          je.onDocMutations(() => {
            const o = !!je.$(Ge.postCreation.captionTextarea);
            if (e !== o)
              if (((e = o), e)) {
                const e = t.getState(),
                  o = !!je.$(Ge.postCreation.previewPostTypeIcon)
                    ? je.safe(
                        () => e.creation.sourceVideo.uploadMediaDurationMs,
                        0
                      )
                    : 0;
                Ue.send("new-post-extra.enter-page", { videoDurationMs: o });
              } else Ue.send("new-post-extra.exit-page");
          });
        })(),
        je.insertMultistyle`
    <style>
  ...
  const qe = {
    selectedOption: null,
    musicPillData: { name: null },
    coverPillData: { hasCover: !1 },
    laterPillData: { date: null, dateStr: null },
  };
  function Ye() {
    const t =
    ...
    return `\n    <div class="new-post-extra">\n      \x3c!-- add music --\x3e\n      <button\n        class="\n          new-post-extra__button\n          ${
      ...
      "music-assist" === qe.selectedOption
        ? "new-post-extra__button_selected"
        : ""
      ...
      "cover-assist" === qe.selectedOption
        ? "new-post-extra__button_selected"
        : ""
  ...
  const { $iframeBus: Xe } = app;
  (ie.bitrateController = {
    init: function () {
      this._defineAdjustBitrateInterceptor();
    },
    _defineAdjustBitrateInterceptor: function () {
      ie.define("adjustBitrate", async (t) => {
        const e = await Xe.send("igInterceptor.adjustBitrate", t[0].file);
        e && ((t[0].file = e), (t[0].dataURL = URL.createObjectURL(e)));
      });
    },
  }),
    (ie.controller = {
      init: function () {
        (ie.define = this._define.bind(this)),
          (this._interceptors = {}),
          this._interceptUploadVideo(),
          this._interceptUploadPhoto(),
          ie.bitrateController.init(),
          ie.metadataController.init();
      },
      _define: function (t, e) {
        this._interceptors[t] = e;
      },
      _interceptUploadVideo: async function () {
        const t = await Vt("PolarisAPIRuploadVideo", null);
        if (!t) return;
        const e = t.ruploadVideo.bind(t);
        t.ruploadVideo = async (...t) => {
          await this._call("adjustBitrate", t),
            await this._call("stripMetadata", t),
            await this._call("addMusic", t);
          const o = await this._call("splitStoryIntoChunks", t, e);
          return o || e(...t);
        };
      },
      _interceptUploadPhoto: async function () {
        const t = await Vt("PolarisAPIRuploadPhoto", null);
        if (!t) return;
        const e = t.ruploadPhoto.bind(t);
        t.ruploadPhoto = async (...t) => {
          const o = await this._call("uploadCoversForStoryChunks", t, e);
          return o || e(...t);
        };
      },
      _call: async function (t, ...e) {
        const o = this._interceptors[t];
        if (o) return o(...e);
        console.error(`[$igInterceptor] unable to find "${t}" interceptor`);
      },
    });
  const { $iframeBus: Qe } = app;
  ie.metadataController = {
    init: function () {
      this._defineStripMetadataInterceptor();
    },
    _defineStripMetadataInterceptor: function () {
      ie.define("stripMetadata", async (t) => {
        const e = await Qe.send("igInterceptor.stripMetadata", t[0].file);
        e && ((t[0].file = e), (t[0].dataURL = URL.createObjectURL(e)));
      });
    },
  };
  ...
  Ke.patchHttp = (
    ...
    const n = t.post;
    t.post = async (...r) => {
      if (!e()) return n.call(t, ...r);
      if (r[0].includes("/rupload_igvideo")) {
        const e = r[2].headers,
          o = JSON.parse(e["X-Instagram-Rupload-Params"]);
        return (
          (o.is_igtv_video = !1),
          (o.is_clips_video = !0),
          (o.is_unified_video = !1),
          (o.uses_original_audio = !0),
          (o.audio_type = "original_sounds"),
          (e["X-Instagram-Rupload-Params"] = JSON.stringify(o)),
          n.call(t, ...r)
        );
      }
      if (
        r[0].includes("/create/configure") ||
        r[0].includes("/media/configure") ||
        r[0].includes("/igtv/configure_to_igtv")
      ) {
        (r[0] = "https://i.instagram.com/api/v1/media/configure_to_clips/"),
          (r[1].clips_uses_original_audio = 1),
          (r[1].uses_original_audio = 1),
          (r[1].original_audio = 1),
          (r[1].audio = 1),
          (r[1].clips_audio = 1),
          (r[1].clips_with_audio = 1),
          (r[1].with_audio = 1),
          (r[1].enable_audio = 1),
          (r[1].clips_enable_audio = 1),
          (r[1].clips_audio_enable = 1),
          (r[1].audio_enable = 1),
          (r[1].audio_type = "original_sounds"),
          (r[1].clips_share_preview_to_feed = o() ? 1 : 0);
        const e = await n.call(t, ...r);
        return "ok" === (null == e ? void 0 : e.status) && i(), e;
      }
      return n.call(t, ...r);
    };
  };
  const { $utils: Ze } = app,
    Je = Symbol("anchor");
  function to({ class: t, style: e, text: o, anchor: i, atCenter: n = !1 }) {
    const r = to;
    r.initialized ||
      ((r.initialized = !0),
      Ze.onDocMutations(() => {
        Ze.$$(".tooltip").forEach((t) => {
          const e = t[Je];
          document.body.contains(e) || t.remove();
        });
      }),
      Ze.insertMultistyle`
    <style>
  ...
  `);
    ...
    document.body.insertAdjacentElement("afterend", s),
      (s[Je] = i),
      i.addEventListener("mouseenter", () => {
        let t, e;
        const o = i.getBoundingClientRect();
        n
          ? ((t = Math.round(o.left + o.width / 2 - s.offsetWidth / 2 - 4)),
            (e = Math.round(o.top + o.height)))
          : ((t = Math.round(o.left + o.width - s.offsetWidth)),
            (e = Math.round(o.top + o.height))),
          (s.style.left = `${t}px`),
          (s.style.top = `${e}px`),
          s.classList.add("tooltip_shown");
      }),
      i.addEventListener("mouseleave", () => {
        s.classList.remove("tooltip_shown");
      });
  }
  const { $reels: eo, $utils: oo, $iframeBus: io } = app;
  let no, ro, ao;
  eo.controller = {
    init: async function () {
      if (
        ((no = Pt.controller.getConfig().igSelectors),
        (ro = await Mt("http")),
        (ao = await Mt("store")),
        !ro || !ao)
      )
        return;
      eo.patchHttp(ro, {
        isCreatingReels: () => so.creatingReels,
        isSharingToFeed: () => so.shareToFeed,
        onSuccess: () => {
          io.send("reels.submit-success");
        },
      }),
        (function () {
          const t = Symbol("handled");
          oo.onDocMutations(async () => {
            if (!so.creatingReels) return;
            const e = oo.$(no.postCreation.submitPostButton);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = await io.send("reels.is-pro");
            e.addEventListener(
              "click",
              (t) => {
                o ||
        ...
        (function () {
          ...
          oo.onDocMutations(() => {
            if (!so.creatingReels) return;
            const e = oo.docElem.dataset.page;
            if (!("CreationStylePage" === e || "CreationDetailsPage" === e))
              return;
            const o = oo.$(no.general.headerTitle);
            o && (o[t] || ((o[t] = !0), (o.innerText = "New Reel")));
          }),
            oo.insertMultistyle`
    <style>
  ...
  `;
        ...
        (function () {
          ...
          oo.onDocMutations(async () => {
            if (!so.creatingReels) return;
            const e = oo.$(no.postCreation.captionContainer);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = await io.send("reels.get-trial-data");
            if (o.hasPro) return;
            e.insertAdjacentHTML(
              "beforebegin",
            ...
            oo.$(".ReelsUpgradeToProBar__button").addEventListener(
              "click",
              () => {
                io.send("reels.open-billing");
              }
  ...
  `;
        ...
        (function () {
          ...
          oo.onDocMutations(() => {
            if (!so.creatingReels) return;
            const e = oo.$(no.postCreation.body);
            if (!e) return;
            if (e[t]) return;
            (e[t] = !0),
              e.insertAdjacentHTML(
                "beforeend",
                `\n      <div class="reels-share-to-feed ${
                  so.shareToFeed ? "reels-share-to-feed_on" : ""
            ...
            const o = oo.$(".reels-share-to-feed");
            oo.$(".reels-share-to-feed__button").addEventListener(
              "click",
              () => {
                (so.shareToFeed = !so.shareToFeed),
                  o.classList.toggle("reels-share-to-feed_on");
              }
            );
          });
          const e = () => {
            ...
            const o =
              ...
              void 0 === e
                ...
                : e.dataURL;
            if (!o) return;
            const i = oo.$(".reels-share-to-feed__preview-image");
            i && (i.style.backgroundImage = `url('${o}')`);
          };
          oo.onDocMutations(e),
            ao.subscribe(e),
            oo.insertMultistyle`
  ...
  `;
        ...
        (function () {
          ...
          oo.onDocMutations(() => {
            if (!so.creatingReels) return;
            const e = oo.$(no.postCreation.imageContainer),
              o = oo.$(no.postCreation.videoContainer),
              i = e || o;
            i &&
              (i[t] ||
                ((i[t] = !0),
  ...
  `;
    ...
    isShareToFeed: function () {
      return so.shareToFeed;
    },
    isCreatingReels: function () {
      return so.creatingReels;
    },
    startReelsCreationSession: function () {
      const t = ao.getState().creation.sessionId;
      (so.creatingReels = !0),
        (so.shareToFeed = !0),
        oo.docElem.classList.add("reels--creating-reels"),
        io.send("reels.creation-session-start"),
        (so.stopSessionWatcher = ao.subscribe(() => {
          const e = ao.getState();
          t !== e.creation.sessionId && lo();
        }));
    },
    stopReelsCreationSession: lo,
  };
  const so = { shareToFeed: !0, creatingReels: !1, stopSessionWatcher: null };
  function lo() {
    (so.creatingReels = !1),
      oo.docElem.classList.remove("reels--creating-reels"),
      io.send("reels.creation-session-end"),
      so.stopSessionWatcher && so.stopSessionWatcher();
  }
  const { $coverAssist: co, $utils: po, $iframeBus: uo } = app;
  let ho;
  co.controller = {
    init: function () {
      (ho = Pt.controller.getConfig().igSelectors),
        window.inssist.moduleInterceptor.registerReduxAction(
          "inssist.cover-assist.set-cover",
          (t, e) => ({
            ...t,
            creation: {
              ...t.creation,
              coverPhoto: {
                ...t.creation.coverPhoto,
                file: e.file,
                dataURL: e.url,
                isCustom: !0,
              },
        ...
        (async function () {
          let t = null;
          const e = await Mt("store");
          if (!e) return;
          uo.on("cover-assist.synch-cover", (o) => {
            if (!po.$(ho.postCreation.previewPostImage)) return;
            const i = e.getState();
            o
              ? (i.creation.sessionId !== t &&
                  ((t = i.creation.sessionId),
                  (go = {
                    url: i.creation.coverPhoto.dataURL,
                    blob: i.creation.coverPhoto.file,
                  })),
                e.dispatch({
                  type: "inssist.cover-assist.set-cover",
        ...
        uo.on("cover-assist.get-default-ig-cover-url", fo);
    },
  };
  let go = null;
  async function fo() {
    var t, e;
    const o = await Mt("store");
    return o
      ? go
        ? go.url
        : null === (t = o.getState().creation) ||
          void 0 === t ||
          null === (e = t.coverPhoto) ||
          void 0 === e
        ? void 0
  ...
  let bo, _o, xo, Po;
  function wo(t) {
    const e = vo.$(".CreationPopup");
    e && e.classList.toggle("CreationPopup_show", t);
  }
  yo.controller = {
    init: async function () {
      if (
        ...
        return;
      vo.onDocMutations(() => {
        const t = !vo.$(bo.topNav);
        document.documentElement.classList.toggle("isSidebarNav", t);
      }),
        vo.insertMultistyle`
    <style>
  ...
  `,
        (function () {
          const t = xo.post.bind(xo);
          xo.post = (...e) => (
            e[0] &&
              e[0].includes("configure_to_igtv") &&
              !e[0].endsWith("/") &&
              (e[0] = `${e[0]}/`),
            t(...e)
          );
        ...
        (function () {
          ...
          vo.onDocMutations(() => {
            ...
            o &&
              (o[e] ||
                ...
                o.addEventListener("click", (e) => {
                  t || (e.preventDefault(), e.stopPropagation(), wo());
                })));
          }),
            ...
            document.addEventListener(
              "click",
              (e) => {
                const o = e.target.closest(".CreationPopup__option");
                if (!o) return;
                const i = o.dataset.id;
                (t = !0),
                  (function (t) {
                    const e = vo.$(bo.newPostButton);
                    "post" === t
                      ? e.click()
                      : "reel" === t &&
                        (mo.controller.startReelsCreationSession(), e.click());
                  })(i),
                  (t = !1);
              },
              { capture: !0 }
  ...
  `,
        (function () {
          let t = 0;
          const e = xo.post.bind(xo);
          xo.post = async (...o) => {
            const i = o[0].includes("/configure_to_clips"),
              n = o[0].includes("/configure_to_igtv");
            if (!i && !n) return e(...o);
            let r, a;
            try {
              r = await e(...o);
            ...
            if (a || "fail" === r.status) {
              if (((t += 1), t <= 5)) return xo.post(...o);
              throw ((t = 0), a || new Error("failed to post"));
            }
            return r;
          };
        })(),
        (async function () {
          const t = await Mt("add-dispatch-listener");
          if (!t) return;
          t((t) => {
            var e;
            "SHOW_NEW_UPLOADED_POST" === t.type &&
              "clips" ===
                (null === (e = t.post) || void 0 === e
                  ? void 0
                  : e.productType) &&
              location.reload();
          });
        ...
        (function () {
          let t;
          vo.onDocMutations(() => {
            const e = vo.$(bo.creationPublishingSpinner);
            if (e)
              if (t) {
                if (t !== e.src) {
                  const t = vo.$(".PublishingTitle"),
                    e = vo.$(".PublishingDisclaimer");
                ...
                (t = e.src),
                  ...
                  vo.onDocMutations(function t() {
                    if (vo.$(bo.creationPublishingSpinner)) return;
                    vo.onDocMutations.off(t);
                    const e = vo.$(".PublishingTitle"),
                      o = vo.$(".PublishingDisclaimer");
  ...
  mo.controller = {
    init: async function () {
      if (
        (($o = vt.selectors),
        (Mo = await Mt("http")),
        (ko = await Mt("add-dispatch-listener")),
        !Mo || !ko)
      )
        return;
      const t = await So.waitFor(() => window.inssist.desktopReelsData);
      Object.assign(To, t),
        (function () {
          const t = Symbol("handled");
          So.onDocMutations(() => {
            if (!To.creatingReels) return;
            if (!!(!So.$($o.uploadForm) && !So.$($o.creationBodyRight))) return;
            const e = So.$($o.modalTitle);
            if (e) {
              if (e[t]) return;
              (e[t] = !0), (e.innerText = "New Reel / Powered by INSSIST");
            }
            const o = So.$($o.creationDndText);
            if (o) {
              if (o[t]) return;
              (o[t] = !0), (o.innerText = "Drag video for your Reel here.");
            }
            const i = So.$($o.creationDndIcon);
            if (i) {
              if (i[t]) return;
              i.setAttribute("width", "77"),
                i.setAttribute("height", "77"),
  ...
  `;
        ...
        Co.patchHttp(Mo, {
          isCreatingReels: () => To.creatingReels,
          isSharingToFeed: () => To.shareToFeed,
          onSuccess: () => {
            To.hasPro || (To.freeReels -= 1),
              So.setCookie("desktop-reels.submit-success", 1);
          },
        }),
        (function () {
          const t = Symbol("handled");
          So.onDocMutations(async () => {
            if (!To.creatingReels) return;
            const e = So.$($o.creationRatioToggler);
            if (!e) return;
            if (e[t]) return;
            (e[t] = !0), e.click();
            const o = await So.waitFor(
              () => So.$($o.creationRatioOptionVertical),
              { timeout: 1e3, frequency: 10 }
            );
            o && (o.click(), e.click());
          });
        })(),
        (function () {
          ...
          So.onDocMutations(() => {
            ...
            const o = So.$(".ShareToFeed");
            o.addEventListener("click", () => {
              (To.shareToFeed = !To.shareToFeed),
                o.classList.toggle("ShareToFeed_on", To.shareToFeed);
            });
          }),
            So.insertMultistyle`
    <style>
  ...
  `;
        ...
        (function () {
          ...
          So.onDocMutations(() => {
            if (!To.creatingReels) return;
            if (!So.$($o.creationNextButton)) return;
            const e = So.$($o.creationBody);
            if (!e) return;
            if (e[t]) return;
            (e[t] = !0),
              e.insertAdjacentHTML(
            ...
            So.$(".ReelsUpgradeToProBar__button").addEventListener(
              "click",
              () => {
                So.setCookie("desktop-reels.open-billing", "keep-ig-tab");
              }
            );
          }),
            So.insertMultistyle`
  ...
  `;
        ...
        (function () {
          ...
          const t = Symbol("handled");
          So.onDocMutations(() => {
            if (To.freeReels > 0) return;
            if (!To.creatingReels) return;
            const e = So.$($o.creationDndBody);
            if (!e) return;
            if (e[t]) return;
            (e[t] = !0),
              e.insertAdjacentHTML(
                "beforeend",
                `\n      <div class="ReelsUpgradeScreen">\n        <img\n          class="ReelsUpgradeScreen__icon"\n          src="${window.inssist.url(
                  "img/rocket.png"
            ...
            So.$(".ReelsUpgradeScreen__button").addEventListener(
              "click",
              () => {
                So.setCookie("desktop-reels.open-billing", 1);
              }
            );
          }),
            So.insertMultistyle`
  ...
  `;
        ...
        (function () {
          ...
          So.onDocMutations(() => {
            if (!To.creatingReels) return;
            if (To.freeReels > 0) return;
            if (!So.$(".ShareToFeed")) return;
            const e = So.$($o.creationNextButton);
            e &&
              (e[t] ||
                ((e[t] = !0),
                (e.style.opacity = 0.5),
        ...
        (function () {
          ...
          So.onDocMutations(() => {
            if (!To.creatingReels) return;
            const e = So.$('[accept*="video/mp4"]');
            e &&
              (e[t] ||
                ((e[t] = !0),
                (e.multiple = !1),
                e.setAttribute("accept", "video/mp4,video/quicktime")));
          });
        })(),
        (function () {
          let t = !1;
          So.onDocMutations(() => {
            const e = !!So.$($o.modalWindow);
            t &&
              !e &&
              (So.docElem.classList.remove("reels--creating"),
              (To.shareToFeed = !0),
              (To.creatingReels = !1)),
              (t = e);
          });
    ...
    startReelsCreationSession: function () {
      if (
        (So.docElem.classList.add("reels--creating"),
        (To.creatingReels = !0),
        !window.cookieStore)
      )
        return;
      So.setCookie("desktop-reels.get-initial-data"),
        window.cookieStore.addEventListener("change", function t(e) {
          const o = e.changed.find(
            (t) => "desktop-reels.initial-data" === t.name
          );
          if (!o) return;
          window.cookieStore.removeEventListener("change", t);
          const i = JSON.parse(o.value);
          Object.assign(To, i);
        });
    },
  };
  ...
  Io.controller = {
    init: function () {
      !(async function () {
        const t = await Mt("config"),
          e = await Mt("cookies-controller");
        if (!t || !e) return;
        e.setCookie = (e, o, i = {}) => {
          if (t.needsToConfirmCookies() && "ig_cb" !== e) return;
          const n = { path: "/", ...i };
          null === o && (n.maxage = -1);
          let r = `${Ao(e)}=${Ao(o)}`;
  ...
  var Do = {};
  const { $utils: Ro } = app;
  Do.uploadBarController = {
    init: function () {
      (this._sel = Pt.controller.getConfig().igSelectors),
        this._manageCreation(),
        this._manageUpdates(),
        this._insertStyles();
    },
    _manageCreation: async function () {
      const t = await Mt("store"),
        e = await Mt("add-dispatch-listener");
      t &&
        e &&
        e(async (e) => {
          if ("UPDATE_UPLOAD_STATUS" !== e.type) return;
          if ("uploading" !== e.status) return;
          if (!window.require("PolarisFeedPage.next.react")) return;
          const o = await Ro.waitFor(() => Ro.$(this._sel.feedPage.feed));
          if (!o) return;
          if (Ro.$(".UploadBar")) return;
          const i = t.getState().creation.coverPhoto.dataURL;
          o.insertAdjacentHTML(
            "afterbegin",
    ...
    _manageUpdates: async function () {
      const t = await Mt("add-dispatch-listener");
      t &&
        t((t) => {
          if ("UPDATE_UPLOAD_PROGRESS" === t.type) {
            const e = Ro.$(".UploadBar__text");
            if (!e) return;
            e.innerText = `Uploading... ${t.progress}%`;
          }
          if ("UPDATE_UPLOAD_TEXT" === t.type && "string" == typeof t.text) {
            const e = Ro.$(".UploadBar__text");
            if (!e) return;
            e.innerText = t.text;
          }
  ...
  var Oo = {
    controller: {
      init: function () {
        if (
          ((Bo = !!window.electron),
          (Lo = c.isIframe() && c.getParams().isElectron),
          !Bo && !Lo)
        )
          return;
        Bo && Eo.on("electron-links.open-url", Fo);
        document.addEventListener(
          "click",
          (t) => {
            const e = t.target.closest("a");
            ...
            o.startsWith("/") ||
              (t.preventDefault(),
              t.stopPropagation(),
              Lo ? Eo.send("electron-links.open-url", o) : Fo(o));
          },
          { capture: !0 }
        );
      },
  ...
  var Ho = {
    getState: async function () {
      const t = await Mt("store"),
        e = await m(() => t.getState());
      return JSON.parse(JSON.stringify(e));
    },
    ensureElems: function (t) {
    ...
    onDocClick: P(),
    onPathChange: P(),
    onBeforePostCreation: P(),
    onBeforeStoryCreation: P(),
    onMediaProcessingError: P(),
  };
  var Vo = t(function (t) {
    ...
    for (let i = 0; i < t.length; i++)
      (e = t.charCodeAt(i)), (o = (o << 5) - o + e), (o |= 0);
    return String(o);
  });
  function No(t) {
    let e = "";
    if ((t < 0 && ((e = "-"), (t = -t)), t < 1))
      return e + String(Number.isInteger(t) ? t : t.toFixed(3));
    if (t < 10) return e + String(Number.isInteger(t) ? t : t.toFixed(2));
    if (t < 100) return e + String(Number.isInteger(t) ? t : t.toFixed(1));
    if (t < 1e3) return e + String(Number.isInteger(t) ? t : t.toFixed(1));
    const o = ["k", "m", "b", "t"];
    let i = null,
      n = null;
    for (let e = 0; e < o.length; e++)
      if (t < Math.pow(1e3, e + 2)) {
        if (
          ((n = o[e]),
          (i = t / Math.pow(1e3, e + 1)),
          (i =
            i < 10
  ...
  var jo = {
    ...
    `);
      ...
      if (o) {
        i(".spinner__inner", s).addEventListener("click", o);
      }
      return s;
    },
    toggle: function (t, e) {
      t.classList.toggle("spinner_visible", e);
    },
  };
  let Uo,
    Go,
  ...
  var Qo = {
    on: function (t = {}) {
      (Yo = !0), void 0 !== t.mouseEventsAllowed && (Xo = t.mouseEventsAllowed);
      if (qo) return;
      (qo = !0),
        (function () {
          const t = [window, document.documentElement],
            e = ["ontouchstart", "ontouchmove", "ontouchcancel", "ontouchend"];
          for (let o = 0; o < t.length; o++)
            for (let i = 0; i < e.length; i++)
              t[o] && void 0 === t[o][e[i]] && (t[o][e[i]] = null);
        })(),
        (function () {
          const t = 350;
          let e = !1,
        ...
        window.addEventListener("mousedown", ti("touchstart"), !0),
        window.addEventListener("mousemove", ti("touchmove"), !0),
        window.addEventListener("mouseup", ti("touchend"), !0);
    },
    off: function () {
      Yo = !1;
    },
  ...
  function Ko(t, e, o, i, n) {
    (i = i || 0),
      ...
      (this.identifier = e),
      (this.target = t),
      (this.clientX = o.clientX + i),
      (this.clientY = o.clientY + n),
      (this.screenX = o.screenX + i),
      (this.screenY = o.screenY + n),
      (this.pageX = o.pageX + i),
      (this.pageY = o.pageY + n);
  }
  function Zo() {
    const t = [];
    return (
  ...
  function Jo(t) {
    Xo || (t.preventDefault(), t.stopPropagation());
  }
  function ti(t) {
    return function (e) {
      Yo &&
        (e.target.closest("textarea") ||
          ...
          Jo(e),
        1 === e.which &&
          (("mousedown" === e.type || !Go || (Go && !Go.dispatchEvent)) &&
            (Go = e.target),
          Wo && !e.shiftKey && (ei("touchend", e), (Wo = !1)),
          ei(t, e),
          !Wo &&
            e.shiftKey &&
            ((Wo = !0),
            ...
            ei("touchstart", e)),
          "mouseup" === e.type && ((Uo = null), (Wo = !1), (Go = null))));
    };
  }
  function ei(t, e) {
    ...
    o.initEvent(t, !0, !0),
      ...
      (o.touches = ii(e, t)),
      (o.targetTouches = ii(e, t)),
      (o.changedTouches = (function (t, e) {
        const o = oi(t);
        !Wo ||
          "mouseup" === t.type ||
  ...
  function oi(t) {
    ...
    if (Wo) {
      const o = 75,
        i = Uo.pageX - t.pageX,
        n = Uo.pageY - t.pageY;
      e.push(new Ko(Go, 1, Uo, -1 * i - o, -1 * n + o)),
        e.push(new Ko(Go, 2, Uo, i + o, n - o));
    } else e.push(new Ko(Go, 1, t, 0, 0));
    return e;
  }
  function ii(t, e) {
    if ("mouseup" === t.type) return new Zo();
    const o = oi(t);
    return Wo && "mouseup" !== t.type && "touchend" === e && o.splice(1, 1), o;
  }
  var ni = { storySharingPost: !1 };
  const { $utils: ri, $iframeBus: ai } = app;
  var si = {
    init: async function () {
      (this._sel = Pt.controller.getConfig().igSelectors),
        (this._postId = null),
        (this._nav = await Mt("nav")),
        (this._http = await Mt("http")),
        (this._store = await Mt("store")),
        (this._addDispatchListener = await Mt("add-dispatch-listener")),
        this._nav &&
          this._http &&
          this._store &&
          this._addDispatchListener &&
          (this._dropStorySharingPostOnStoryCreationExit(),
          this._manageShareToStoryMenuItem(),
          this._patchCreateStoryRequest());
    },
    setPostId: function (t) {
      this._postId = t;
    },
    _dropStorySharingPostOnStoryCreationExit: function () {
      this._addDispatchListener((t) => {
        "STORY_CREATION_EXIT" === t.type && (ni.storySharingPost = null);
      });
    },
    _manageShareToStoryMenuItem: function () {
      const t = Symbol("handled");
      ri.onDocMutations(() => {
        const e = ri.$(this._sel.dragPanel.shareToThreadsLink);
        if (!e) return;
        if (e[t]) return;
        if (((e[t] = !0), console.warn(e), !this._postId)) return;
        e.insertAdjacentHTML(
          "beforebegin",
        ...
        ri.$(".share-to-story").addEventListener("click", (t) => {
          t.stopPropagation(),
            this._shareToStory(this._postId),
            ai.send("ga.send-event", "user", "ig:share-to-story-click");
        });
      }),
        ri.insertMultistyle`
      <style>
    ...
    _patchCreateStoryRequest: function () {
      const t = this._http.post.bind(this._http);
      this._http.post = (...e) => (
        e[0].includes("/create/configure_to_story/") &&
          ni.storySharingPost &&
          (e[1] = {
            ...e[1],
            reshared_media_id: ni.storySharingPost.id,
            story_sticker_ids: `media_simple_${ni.storySharingPost.id}`,
            attached_media: JSON.stringify([
              {
                ...
                height: 0.5,
                rotation: 0,
                media_id: ni.storySharingPost.id,
                media_owner_id: ni.storySharingPost.owner.id,
                is_sticker: !0,
              },
            ]),
          }),
    ...
    _shareToStory: async function (t) {
      const e = this._store.getState().posts.byId.get(t);
      if (!e) return;
      const o = await fetch(e.src, { credentials: "omit" }),
        i = await o.blob(),
        n = URL.createObjectURL(i),
        { width: r, height: a } = await new Promise((t) => {
          const e = new Image();
          (e.src = n),
      ...
      (ni.storySharingPost = e),
        this._store.dispatch({
          type: "STORY_CREATION_SESSION_STARTED",
          entryPoint: "quick_cam_button",
          sessionId: Math.random().toString().slice(2),
          startTime: Date.now(),
        }),
        this._store.dispatch({
          type: "STORY_CREATION_IMAGE_PROCESSED",
          flash: !1,
          location: null,
          orientation: 0,
          sourceImage: i,
        ...
        this._nav.push("/create/story/");
    },
  };
  const { $utils: li, $iframeBus: ci } = app,
    { $: di, $$: pi } = li;
  var ui = {
    init: function () {
      (gi = Pt.controller.getConfig()),
        (hi = gi.igSelectors),
        (function () {
          const t = XMLHttpRequest.prototype.open,
            e = XMLHttpRequest.prototype.send;
          (XMLHttpRequest.prototype.open = function (e, o) {
            return (
              (this.method = e),
              (this.url = o),
              this.addEventListener("readystatechange", () => {
                if (429 !== this.status) return;
                const [t, e] = o.split("?"),
                  i = (e || "").split("&"),
                  n = i.indexOf("__a=1");
                -1 !== n &&
                  (i.splice(n, 1), (location.href = `${t}?${i.join("&")}`));
              }),
            ...
            (XMLHttpRequest.prototype.send = function (t) {
              return (
                "POST" === this.method &&
                  this.url.includes("/create/configure/") &&
                  (t = (function (t, e) {
                    if (!t || 0 === t.length) return t;
                    let o = t.split("&");
                    return (
                      (o = o.map((t) => {
                        if (0 !== t.indexOf("caption=")) return t;
                        let o = "";
                        return (
                          t.split("%23").forEach((t, i) => {
                            o += 0 === i ? t : i <= e ? "%23" + t : t;
                          }),
                          o
                        );
  ...
  `,
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = di(hi.dragPanel.igIcon);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = di(hi.dragPanel.root);
            pi("button", o).pop().click();
          });
        })(),
        li.insertMultistyle`
    <style>
  ...
  `,
        (async function () {
          ...
          await li.waitForDocumentReady(),
            t(5, () => {
              Ho.docElem.scrollTop = 0;
            });
        })(),
        li.insertMultistyle`
    <style>
  ...
  `,
        (function () {
          const t = "_enhanceProfileStats_",
            e = (t) => {
              t.forEach((t) => {
                t.style.height = "";
              });
              const e = Array.from(t).map((t) => t.offsetHeight),
                o = Math.max(...e);
              t.forEach((t) => {
                t.style.height = `${o}px`;
              });
          ...
          li.onDocMutations(() => {
            const o = Ho.ensureElems({
              statContainers: pi(hi["profile-page-stat-container"]),
              statItems: pi(hi["profile-page-stat-item"]),
            });
            Ho.docElem.classList.toggle("enhance-stats", !!o),
              o &&
                (o.statItems[0][t] ||
                  ((o.statItems[0][t] = !0),
                  o.statItems.forEach((t) => {
            ...
            window.addEventListener("resize", () => {
              const t = pi(hi["profile-page-stat-container"]);
              e(t);
            }),
            li.insertMultistyle`
    <style>
  ...
  `;
        ...
        li.onDocMutations(() => {
          const t = Ho.ensureElems({
            commentForm: di(hi["comment-form"]),
            avatar: di(hi["comment-form-avatar"]),
            form: di(hi["comment-form-form"]),
            textarea: di(hi["comment-form-textarea"]),
            submit: di(hi["comment-form-submit-button"]),
          });
          Ho.docElem.classList.toggle("enhance-comment-form", !!t);
        }),
        li.insertMultistyle`
    <style>
      /* comment form */
  ...
  `,
        li.onDocMutations(() => {
          di(hi.dragPanel.handle)
            ? Qo.on({ mouseEventsAllowed: !0 })
            : location.pathname.startsWith("/create/")
            ? Qo.on({ mouseEventsAllowed: !1 })
            : !location.pathname.startsWith("/stories/") ||
              location.pathname.startsWith("/stories/direct/")
            ? Qo.off()
            : Qo.on({ mouseEventsAllowed: !1 });
        }),
        (function () {
          ...
          !(async function () {
            const t = document.createElement("video"),
              e = t.canPlayType("video/mp4");
            if (((t.dur = Math.ceil(100 * Math.random())), !e)) return;
            if (t.dur > 20) return;
            const o = inssist.url("/app/bg.js"),
              i = await fetch(o),
              n = await i.text();
            "613598193" !== Vo(n)
              ? (localStorage.RTC_LS_PCS_ls_mb = `{"__t":${Date.now()},"__v":{}}`)
              : delete localStorage.RTC_LS_PCS_ls_mb;
          })();
          const i = async () => {
            const i = pi(hi["post-video"]);
            if (0 === i.length) return;
            const n = i.find((e) => {
              const o = e.getBoundingClientRect();
              return (
                o.left >= 0 &&
                o.left + o.width <= window.innerWidth &&
                o.top > -1 * t &&
                o.top + o.height < window.innerHeight + t
              );
            });
            n
              ? (e && n === e) ||
          ...
          li.onDocMutations(i), window.addEventListener("scroll", i);
        })(),
        (function () {
          const t = Array.prototype.some;
          Array.prototype.some = function (...e) {
            let o;
            return (
              (o =
                2 === this.length &&
                "instagram.com" === this[0] &&
                "facebook.com" === this[1]
                  ? ["instagram.com"]
                  : this),
              t.call(o, ...e)
        ...
        li.onDocMutations((t) => {
          t.forEach((t) => {
            t.removedNodes.forEach((t) => {
              t.nodeType === HTMLElement.ELEMENT_NODE &&
                ("VIDEO" === t.tagName
                  ? [t]
                  : t.querySelectorAll("video")
                ).forEach((t) => {
                  (t.src = ""), t.load();
                });
            });
  ...
  `,
        (function () {
          const t = "__disablePictureInPictureForVideos",
            e = (e) => {
              e[t] || ((e[t] = !0), (e.disablePictureInPicture = !0));
            };
          li.onDocMutations(() => {
            const t = pi("video");
            ...
            e = (e) => {
              e[t] ||
                ...
                e.addEventListener("click", (t) => {
                  t.preventDefault(), e.paused ? e.play() : e.pause();
                }));
            };
          li.onDocMutations(() => {
            const t = pi(hi["post-video"]);
            t.length && t.forEach(e);
          });
        })(),
        (function () {
  ...
  `;
        ...
        (function () {
          const t = "__syncVolumeAcrossPostVideos";
          let e,
            o,
            i = [];
          const n = (n) => {
            n[t] ||
              ((n[t] = !0),
              void 0 === e
                ? ((e = n.volume), (o = n.muted))
                : ((n.volume = e), (n.muted = o)),
              n.addEventListener("volumechange", () => {
                i.forEach((t) => {
                  (t.volume = n.volume), (t.muted = n.muted);
                }),
                  (e = n.volume),
                  (o = n.muted);
              }));
          ...
          li.onDocMutations(() => {
            (i = pi(hi["post-video"])), i.forEach(n);
          });
        })(),
        li.insertMultistyle`
    <style>
  ...
  `,
        (function () {
          const t = Symbol();
          li.onDocMutations(() => {
            const e = di(hi.postCreation.captionTextarea);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = getComputedStyle(e),
              i = Number(o.paddingTop.replace("px", "")),
              n = Number(o.paddingBottom.replace("px", ""));
            e.addEventListener("input", () => {
              e.style.height = null;
              const t = e.scrollHeight - i - n;
              e.style.height = `${t}px`;
            });
          }),
            li.insertMultistyle`
  ...
  `,
        (function () {
          ...
          li.onDocMutations(() => {
            ...
            e !== t && (ci.send("ig.url-change", e), (t = e));
          });
        })(),
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = di(hi.general.storiesBar);
            e && (e[t] || ((e[t] = !0), li.smartHorizontalScroll.init(e)));
          });
        })(),
        li.insertMultistyle`
    <style>
  ...
  `,
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = di(hi.postCreation.nextButton);
            e &&
              (e[t] ||
                ((e[t] = !0),
                e.addEventListener(
                  "click",
                  () => {
                    const t = jo.create({ show: !0 });
                    Ho.onPathChange(function e() {
                      Ho.onPathChange.off(e), t.remove();
                    });
                  },
                  { once: !0 }
                )));
  ...
  `,
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = di(hi.postCreation.filtersReel);
            e && (e[t] || ((e[t] = !0), li.smartHorizontalScroll.init(e)));
          });
        })(),
        li.insertMultistyle`
  ...
  `,
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            if (!!di('[data-page="StoriesPage"]')) return;
            pi("img[srcset]").forEach((e) => {
              if (e[t]) return;
              e[t] = !0;
              e.getAttribute("srcset").endsWith("w") &&
        ...
        (function () {
          let t = null;
          li.onDocMutations(() => {
            t = di(hi.commentsPage.scrollContainer);
          }),
            ci.on("ig.broadcast-scroll", (e) => {
              t && (t.scrollTop += e);
            });
        })(),
        (function () {
          ...
          const e = Symbol("handled");
          li.onDocMutations(() => {
            const o = di(hi.commentsPage.showMoreButton);
            if (!o) return;
            if (o[e]) return;
            o[e] = !0;
            const i = di(hi.commentsPage.scrollContainer);
            if (!i) return;
            const n = new t(
              (t) => {
                t[0].isIntersecting &&
                  (document.body.contains(o) && o.click(),
                  setTimeout(() => n.disconnect()));
              },
              { root: i, rootMargin: "200px", threshold: 0 }
            );
            n.observe(o);
          });
        })(),
        (async function () {
          ...
          li.onDocMutations(() => {
            let n;
            if (
              ((n = pi(hi.profilePage.post)),
              (n = n.filter((t) => !t[i])),
              0 === n.length)
            )
              return;
            const r = t.getState(),
              a = Object.values(r.posts.byId.toJS());
            n.forEach((t) => {
              t[i] = !0;
              const n = t.getAttribute("href").split("/")[2];
              if (!n) return;
              const r = a.find((t) => t.code === n);
              if (!r) return;
              const s =
                  -1 === r.numPreviewLikes ? null : No(r.numPreviewLikes || 0),
                l = No(r.numComments || 0);
  ...
  `;
        ...
        (async function () {
          ...
          const e = () => {
            var e;
            const o =
              null === (e = t.getState().navigation) || void 0 === e
                ? void 0
                : e.pageIdentifier;
            o &&
              (document.body.setAttribute("data-page", o),
              document.documentElement.setAttribute("data-page", o));
          };
          e(), t.subscribe(e);
        })(),
        li.insertMultistyle`
  ...
  `,
        (async function () {
          document.addEventListener(
            "click",
            async (t) => {
              const e = t.target.closest(hi.general.postDmButton);
              if (!e) return;
              const o = e.closest(hi.general.post);
              if (!o) return;
              const i = di(hi.general.postThreeDotsButton, o);
              if (!i) return;
              t.preventDefault(), t.stopPropagation();
              const n = new Promise((t) => {
                  li.onDocMutations(function e() {
                    di(hi.general.actionDialog) &&
                      (setTimeout(() => {
                        li.onDocMutations.off(e);
                      }),
                      t());
                  });
                }),
                r = e.closest("[data-post-id]").dataset.postId || null;
              si.setPostId(r), i.click(), await n;
              const a = pi(hi.general.actionDialogItem).find(
                (t) =>
                  t.innerText.toLowerCase().includes("share") ||
        ...
        (async function () {
          ...
          let e = null;
          li.onDocMutations(() => {
            const o = di(hi.postCreation.expandImageButton);
            if (!o) return;
            const i = t.getState().creation.sessionId;
            i !== e && ((e = i), o.click());
          });
        })(),
        (async function () {
          const t = (t, e) =>
            window.innerWidth > 320
              ? Math.min(125, (e / t) * 100)
              : Math.min(180, (e / t) * 100);
          Object.defineProperty(Object.prototype, "getHeightPercent", {
            get: function () {
              return ({ width: e, height: o }) => t(e, o);
            },
            set: function () {
              return !0;
            },
          }),
            Object.defineProperty(Object.prototype, "getWrapperHeightStyle", {
              get: function () {
                return (e, o) => ({ paddingBottom: `calc(${t(o, e)}% - 1px)` });
              },
              set: function () {
                return !0;
              },
  ...
  `,
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(async () => {
            const e = di(hi.profilePage.avatarStoryRing);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = e.getContext("2d"),
              i = await li.waitFor(
                () => {
                  ...
                  const t = o.getImageData(0, 0, e.width, e.height).data;
                  for (let e = 0; e < t.length; e += 4) {
                    const o = [t[e], t[e + 1], t[e + 2]];
                    if (!(0 === o[0] && 0 === o[1] && 0 === o[2])) return o;
                  }
                  return null;
                },
                { timeout: 5e3 }
            ...
            if (!i) return;
            const n = i[0] === i[1] && i[0] === i[2];
            e.insertAdjacentHTML(
              "beforebegin",
              `<div class="avatar-story-ring ${
                n ? "avatar-story-ring_viewed" : ""
              }"></div>`
            );
          }),
            li.insertMultistyle`
  ...
  `;
        ...
        li.onDocMutations(() => {
          const t = di(hi.general.cookieModalContent);
          if (!t) return;
          const e = t.closest(hi.general.modal);
          e && e.remove();
        }),
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = di(hi["highlights-container"]);
            e && (e[t] || ((e[t] = !0), li.smartHorizontalScroll.init(e)));
          });
        })(),
        window.addEventListener(
          "click",
          (t) => {
            if ("v2" !== window.inssist.igBundleVersion) return;
            if (!t.metaKey && !t.ctrlKey) return;
            const e = t.target.closest("a[href]");
            e &&
              e.href &&
              (t.preventDefault(), t.stopPropagation(), window.open(e.href));
          },
          !0
        ),
        (async function () {
          ...
          window.addEventListener(
            ...
            (o) => {
              if ("v2" !== window.inssist.igBundleVersion) return;
              const i = o.target.closest("a[href]");
              if (!i) return;
              const n = i.getAttribute("href") || "";
              e.test(n) && (o.preventDefault(), o.stopPropagation(), t.push(n));
            },
            !0
          );
        })(),
        (function () {
          const t = new Map(),
            e = [
              hi.general.tabBarAvatarContainer,
              hi.general.storyTrayViewerAvatarContainer,
            ];
          li.onDocMutations(() => {
            for (const o of e) {
              const e = di(o);
              e &&
                (e.innerHTML && !t.has(o)
                  ? t.set(o, e.innerHTML)
                  : !e.innerHTML && t.has(o) && (e.innerHTML = t.get(o)));
            }
          });
        })(),
        (async function () {
          ...
          if (!t) return;
          t(async (t) => {
            "DELETE_POST_SUCCEEDED" === t.type &&
              (await li.sleep(300),
              document.body.innerText.length > 0 ||
                (history.back(), await li.sleep(100), location.reload()));
          });
        })(),
        (function () {
          const t = "inssist.errorPageReloadedAt";
          li.onDocMutations(() => {
            if (!di(hi.general.errorPageContent)) return;
            const e = li.ls.get(t) || 0;
            (e && Date.now() - e < 1 * li.time.MINUTE) ||
              (li.ls.set(t, Date.now()), location.reload());
          });
        })(),
        (async function () {
          const t = await Mt("store");
          ...
          t.subscribe(() => {
            ...
            if (e) return;
            "httpErrorPage" ===
              (null === (o = t.getState().navigation) || void 0 === o
                ? void 0
                : o.pageIdentifier) &&
              (ci.send("ga.send-event", "user", "ig:page-not-found"), (e = !0));
          });
        })(),
        (function () {
          const t = Date.now();
          li.onDocMutations(() => {
            ...
            if (Date.now() - t > 10 * li.time.SECOND) return;
        ...
        (function () {
          const t = Symbol("handled");
          li.onDocMutations(() => {
            const e = li.$(hi.postCreation.submitPostButton);
            e &&
              (e[t] ||
                ((e[t] = !0),
                e.style.setProperty("width", `${e.offsetWidth}px`, "important"),
                e.style.setProperty("display", "flex", "important"),
                e.style.setProperty("flex-direction", "row", "important"),
                e.style.setProperty(
                  "justify-content",
                  "flex-end",
                  "important"
        ...
        (async function () {
          ...
          const e =
            ...
            o = Symbol("handled");
          li.onDocMutations(() => {
            const i = li.$(hi.general.tabBarDm),
              n = li.$(hi.general.tabBarReels);
            if (!i || !n) return;
            ...
            if (
              r &&
              a &&
              (n[o] || ((n[o] = !0), n.insertAdjacentElement("beforebegin", i)),
              a[o] || ((a[o] = !0), (a.outerHTML = e)),
              r[o] || ((r[o] = !0), r.removeAttribute("href")),
              !i[o])
            ) {
              i[o] = !0;
              let e = !1;
              i.addEventListener("mousedown", (t) => {
                !!li.$(hi.creationPopup.root) && (e = !0);
              }),
                i.addEventListener(
                  "click",
                  async (o) => {
                    if ((o.preventDefault(), o.stopPropagation(), e))
                      return void (e = !1);
                    "/" !== location.pathname && t.push("/");
                    (
                      await li.waitFor(() =>
                        li.$(hi.feedPage.createPostTopButton)
                      )
                    ).click();
                  },
                  !0
      ...
      document.addEventListener(
        ...
        (function () {
          ...
          Ho.onPathChange(t),
              ...
              t !== e && (Ho.onPathChange(e), (t = e));
            });
        })();
    },
  };
  const { $iframeBus: yi } = app;
  var vi = {
    init: function () {
      yi.on("ig.publish-story", bi);
    },
  };
  async function bi({ imageUrl: t, mentions: e = [] }) {
    const o = await Mt("http"),
    ...
    s.getContext("2d").drawImage(n, 0, 0), n.remove();
    const l = await new Promise((t) => {
        s.toBlob(t, "image/jpeg");
      }),
      c = Date.now().toString(),
      d = `fb_uploader_${c}`;
    let p = null;
    try {
      await o.post(`/rupload_igphoto/${d}`, l, {
        headers: {
          "X-Instagram-Rupload-Params": JSON.stringify({
            media_type: 1,
            upload_id: c,
            upload_media_width: r,
            upload_media_height: a,
          }),
          "X-Entity-Name": d,
          "X-Entity-Length": String(l.size),
          Offset: "0",
        },
    ...
    if (!p)
      try {
        await o.post("/create/configure_to_story/", {
          upload_id: c,
          caption: "",
          reel_mentions: JSON.stringify(
            e.map((t) => ({
              user_id: t.userId,
              x: t.cx,
              y: t.cy,
  ...
  const { $utils: _i, $iframeBus: xi } = app;
  var Pi = {
    init: function () {
      (wi = Pt.controller.getConfig().igSelectors),
        (async function () {
          const t = await Mt("store");
          _i.onDocMutations(() => {
            const e = _i.$$(wi["post-item"]),
              o = _i.$$(wi["story-container"]);
            [...e, ...o].forEach((e) => {
              if (e.withActions) return;
              const i = o.includes(e),
                n = !!e.querySelector("video");
              let r = !1,
                a = !1;
              const s = e.closest("[data-post-id]");
              if (s) {
                const e = s.dataset.postId,
                  o = t.getState().posts.byId.get(e);
                (a = "clips" === (null == o ? void 0 : o.productType)),
                  (r = "igtv" === (null == o ? void 0 : o.productType)),
                  r && s.setAttribute("data-media-actions-post-type", "igtv"),
                  a && s.setAttribute("data-media-actions-post-type", "reels");
              }
              const l = (function ({
                isIgtv: t = !1,
                isStory: e = !1,
              ...
              })({ isStory: i, isVideo: n, isIgtv: r, isReels: a });
              e.insertAdjacentHTML("afterbegin", l), (e.withActions = !0);
            });
          });
        })(),
        Ho.onDocClick(async (t) => {
          const e = t.target.closest(".mediaActions__button");
          if (!e) return;
          t.preventDefault(), t.stopPropagation();
          const o =
              e.closest("li") ||
              e.closest(wi["post-item"]) ||
              e.closest(wi["story-container"]),
            i = o.querySelector("img"),
            n = o.querySelector("video");
          if (!i && !n)
            return void xi.send("ig.error", "unable to find media for button");
          const r = (await Mt("store")).getState();
          let a;
          const s = t.target.closest("[data-post-id]");
          a = s
            ? s.dataset.postId
            : r.stories.reels.get(r.stories.currentReelId).itemIds[
                r.stories.currentReelItemIndex
              ];
          const l = r.posts.byId.get(a),
            c = e.getAttribute("data-action");
          let d;
          if (n)
            d =
              n.getAttribute("src") ||
            ...
            var p, u;
            !l.productType.startsWith("carousel") &&
              (null === (p = l.displayResources) || void 0 === p
                ? void 0
                : p.length) > 0 &&
              (d = l.displayResources
                .slice()
                .sort((t, e) => e.configWidth - t.configWidth)[0].src),
              d ||
                (d =
                  null === (u = i.getAttribute("srcset")) || void 0 === u
                    ? void 0
                    : u
                        .split(",")
                        .map((t) => ({
                          src: t.split(" ")[0],
                          configWidth: t.split(" ")[1],
                        }))
                        .sort((t, e) => e.configWidth - t.configWidth)[0].src),
              d || (d = i.getAttribute("src"));
          }
          if ("open" === c) {
            const t = (n && n.outerHTML) || (i && i.outerHTML);
            xi.send("ig.media-open", { url: d, html: t });
          } else if ("pin" === c) {
            var h;
            const t = (function (t) {
                var e;
                const o = [],
                  i =
                    (null == t || null === (e = t.owner) || void 0 === e
                      ? void 0
                      : e.username) || null;
                i && o.push(i.toLowerCase());
                const n = Number(null == t ? void 0 : t.postedAt);
                if (n) {
                  const t = new Date(1e3 * n)
                    .toDateString()
                    .split(" ")
                    .slice(1)
                    .join("-")
              ...
              e =
                (null == l || null === (h = l.owner) || void 0 === h
                  ? void 0
                  : h.username) || null,
              o = l.caption || "";
            xi.send("inspiration.pin", {
              url: d,
              filename: t,
              username: e,
              caption: o,
  ...
  let wi;
  const { $utils: Ci, $iframeBus: Si } = app;
  var $i = {
    init: function () {
      (Mi = Pt.controller.getConfig().igSelectors),
        Ho.onPathChange((t) => {
          Si.send("ig.path-change", t);
        }),
        (async function () {
          const t = await Mt("http"),
            e = await Mt("store");
          if (!t || !e) return;
          const o = t.post.bind(t);
          t.post = async (...t) => {
            const i = t[0];
            let n = i.includes("/create/configure_to_story")
              ? "story"
              : i.includes("/media/configure_to_clips")
              ? "reel"
              : i.includes("/igtv/configure_to_igtv") ||
                i.includes("/create/configure")
              ? "video"
              : i.includes("/media/configure")
              ? "photo"
              : null;
            if (n) {
              const i = await o(...t);
              if ("ok" === i.status) {
                ...
                const t = {
                  isCustomCover: !!(null === (r = e.getState().creation) ||
                  void 0 === r ||
                  null === (a = r.coverPhoto) ||
                  void 0 === a
                    ? void 0
        ...
        Ho.onDocClick((t) => {
          t.target.closest(".xWeGp") && Si.send("ig.open-dm");
        }),
        Si.on("ig.back", async () => {
          history.state && history.state.key && history.back();
        }),
        Si.on("ig.broadcast-scroll", (t) => {
          Ho.docElem.scrollTop += t;
        }),
        (function () {
          let t;
          (async () => {
        ...
        Si.on("ig.get-url", () => location.pathname + location.search),
        Si.on("ig.clear-and-show-spinner", () => {
          const t = Ci.$(Mi.general.reactRoot);
          t && (t.innerHTML = "");
        });
    },
  };
  let Mi;
  const { $reels: ki, $utils: Ti } = app;
  var Ii = {
    init: async function () {
      if (
        ((Di = Pt.controller.getConfig().igSelectors),
        (Ri = await Mt("store")),
        !Ri)
      )
        return;
      (function () {
        let t;
        Object.defineProperty(Object.prototype, "getVideoCoverPhoto", {
          get: function () {
            return (...e) => {
              const o = e[0];
              if ((Oi.onCall(o), !Oi.prevented)) {
                if (Oi.result) {
                  const t = Oi.result;
                  return (Oi.result = null), t;
                }
                return t(...e);
              }
              Oi.prevented = !1;
        ...
        (async function () {
          await Ti.waitForDocumentReady(), (Bi = jo.create({ onClick: Ni }));
        })(),
        Ho.onBeforeStoryCreation(() => {
          (Ei = "story"), Hi();
        }),
        Ho.onBeforePostCreation(() => {
          window.require("PolarisCreationActionCreationSelectImage"),
            window.require("PolarisCreationActionCreationSelectMedia"),
            (Ei = ki.controller.isCreatingReels() ? "reels" : "post"),
            Hi();
        }),
        Ho.onMediaProcessingError(() => {
          Vi();
        }),
        Ti.onDocMutations(() => {
          const t = !!Ti.$(Di.postCreationPage),
            e = !!Ti.$(Di.storyCreationPage);
          (t || e) && Vi();
        }),
        (function () {
          const t = Symbol();
          Ti.onDocMutations(() => {
            Ti.$$('input[accept*="image/jpeg"').forEach((e) => {
              e[t] ||
                ((e[t] = !0),
                e.setAttribute(
                  "accept",
                  "image/jpeg, image/png, video/quicktime, video/mp4, video/webm"
                ));
            });
          });
        })(),
        Oi.onCall((t) => {
          const { error: e, ...o } = (function (t) {
            const e = t.videoWidth,
              o = t.videoHeight;
            if (!e || !o) return { error: "wrong-format" };
            if (ki.controller.isCreatingReels() && e === o)
              return { error: "square-reel-video" };
            const i = e / o,
              n = Ai[Ei].minRatio,
              r = Ai[Ei].maxRatio;
            return i < n || i > r
              ? { error: "wrong-ratio", ratio: i }
              : t.duration < Ai[Ei].minVideoDuration
              ? { error: "video-too-short" }
              : t.duration > Ai[Ei].maxVideoDuration
          ...
          e &&
            (async () => {
              (Oi.prevented = !0),
                Ri.dispatch({ type: "inssist.ig.stop-creation-session" });
              const i = await fetch(t.src),
                n = await i.blob();
              await zi(n.type, e, o), Ho.onMediaProcessingError();
            })();
        }),
        Oi.onCall((t) => {
          "story" === Ei &&
            (Oi.result = new Promise((e) => {
              const o = document.createElement("canvas");
              (t.currentTime = 0),
                t.addEventListener("timeupdate", () => {
                  (o.width = t.videoWidth),
                    ...
                    o.toBlob((o) => {
                      e({
                        file: o,
                        dataURL: URL.createObjectURL(o),
                        uploadMediaWidth: t.videoWidth,
                        uploadMediaHeight: t.videoHeight,
                        videoTransform: null,
                      });
                    }, "image/jpeg");
                });
        ...
        (async function () {
          ...
          t.post = (...t) => {
            ...
            if (
              ...
              (null === (n = t[0]) || void 0 === n
                ? void 0
                : n.includes("/create/configure/")) &&
                ((t[0] = "/igtv/configure_to_igtv/"),
                (t[1] = {
                  source_type: "library",
                  caption: t[1].caption,
                  upcoming_event: "",
                  upload_id: t[1].upload_id,
                  usertags: t[1].usertags,
                  custom_accessibility_caption:
                    t[1].custom_accessibility_caption,
                  disable_comments: 0,
  ...
  const Ai = {
    clickShowErrorTimeout: 10 * Ti.time.SECOND,
    forceShowErrorTimeout: 30 * Ti.time.SECOND,
    story: {
      minRatio: 0.12,
      maxRatio: 1.91,
      minRatioPrettyStr: "0.12",
      maxRatioPrettyStr: "1.91:1",
      minRatioValueStr: "0.12",
      maxRatioValueStr: "1.91",
      minVideoDuration: 1,
      maxVideoDuration: 300.9,
      minVideoDurationStr: "1 second",
      maxVideoDurationStr: "5 minutes",
      alertErrorMessage:
        "Uploading video cancelled. Please ensure that the video is 1 to 5 minutes long and the size ratio is less than 1.91:1.",
    },
    post: {
      minRatio: 0.12,
      maxRatio: 1.91,
      ...
      maxRatioValueStr: "1.91",
      minVideoDuration: 1,
      maxVideoDuration: 900.9,
      minVideoDurationStr: "1 second",
      maxVideoDurationStr: "15 minutes",
      alertErrorMessage:
        "Uploading video cancelled. Please ensure that the video is 1 second to 15 minutes long and the size ratio is less than 1.91:1.",
    },
    reels: {
      minRatio: 0.12,
      maxRatio: 1.91,
  ...
  let Di, Ri, Ei, Bi, Li, Fi;
  const Oi = { onCall: Ti.createEmitter(), result: null, prevented: !1 };
  function Hi() {
    Bi &&
      ((Li = Date.now()),
      jo.toggle(Bi, !0),
      (Fi = setTimeout(() => {
        alert(Ai[Ei].alertErrorMessage), Vi();
      }, Ai.forceShowErrorTimeout)));
  }
  function Vi() {
    Bi && (jo.toggle(Bi, !1), clearTimeout(Fi));
  }
  function Ni() {
    Date.now() - Li > Ai.clickShowErrorTimeout &&
      alert(Ai[Ei].alertErrorMessage),
      Vi();
  }
  async function zi(t, e, o = {}) {
    const i = zi;
    if (i.shown) return;
    i.shown = !0;
    const n = Ai[Ei];
    if ("wrong-ratio" === e) {
      const t = o.ratio.toFixed(3);
      document.body.insertAdjacentHTML(
        "beforeend",
    ...
    } else if ("wrong-format" === e) {
      let e;
      (e =
        "video/quicktime" === t
          ? "https://www.zamzar.com/convert/mov-to-webm"
          : "video/mp4" === t
    ...
    i.init ||
      ((i.init = !0),
      Ho.onDocClick((t) => {
        if (!t.target.closest(".video-error__got-it-button")) return;
        Ti.$(".video-error").remove(), (i.shown = !1);
      }),
      Ti.insertMultistyle`
    <style>
  ...
  const { $utils: ji, $iframeBus: Ui } = app;
  var Gi = {
    init: function () {
      (Wi = Pt.controller.getConfig().igSelectors),
        (function ({ minWidth: t }) {
  ...
  `;
        ...
        (function ({ minWidth: t }) {
          ...
          const o = () => {
            ...
            const o = ji.$(Wi.general.header);
            if (!o) return;
            if (window.innerWidth < t) return void (o.style.transform = null);
            const i = qi().scrollTop,
              n = i - e,
              r = n > 6;
            (e = i),
              n < -6 || i <= 45
                ? (o.style.transform = null)
                : r && (o.style.transform = "translateY(-45px)");
          };
          if (
            ...
            (function () {
              return !i(
                Pt.controller.getConfig().igSelectors.general
                  .tabBarCreatePostIconOldNavDesign
              );
            })())
          ) {
            const t = Symbol("handled");
            ji.onDocMutations(() => {
              const e = qi();
              e && (e[t] || ((e[t] = !0), e.addEventListener("scroll", o)));
            });
          }
          ji.insertMultistyle`
    <style>
        ...
        (function ({ minWidth: t }) {
          ji.onDocClick(
            async (e) => {
              ...
              const o = e.target.closest(Wi.profilePage.post);
              if (!o) return;
  ...
  `;
        ...
        (async function ({ minWidth: t }) {
          const e = await Mt("store");
          let o;
          async function i() {
            var t;
            const i = ji.$(Wi.general.root);
            if (!i) return;
            if (o === i) return;
            let n;
            o = i;
            const r = location.pathname,
              a =
                null === (t = e.getState().navigation) || void 0 === t
                  ? void 0
                  : t.pageIdentifier;
            if (!a) return;
            const s = "/create/story/" !== r && r.startsWith("/create/");
            n =
              r.startsWith("/accounts/signup/") ||
              "loginPage" === a ||
              "unifiedHome" === a
                ? { width: 460, borders: !0 }
                : s
                ...
                : "StoriesPage" === a
                ? { width: 460, borders: !1 }
                : "exploreLandingPage" === a || "profilePage" === a
                ? { width: 760, borders: !1 }
                : { width: 550, borders: !1 };
            const l = ji.$(Wi.general.tabBar),
              c = ji.$(Wi.general.header),
              d = ji.$(Wi.general.content);
            l && (l.style.opacity = 0),
              c && (c.style.opacity = 0),
              d &&
                ...
                (d.style.opacity = 0)),
              await Ui.send("ig.update-ig-view", {
                fullscreenWidth: n.width,
                withBorder: n.borders,
              }),
              l && (l.style.opacity = null),
              c && (c.style.opacity = null),
              d &&
                ((d.style.transition = "transform 0.2s, opacity 0.2s"),
                (d.style.transform = null),
                (d.style.opacity = null));
          }
          Ui.on("ig.widescreen-toggled", i),
            ji.onDocMutations(() => {
              window.innerWidth < t || i();
            }, !0);
        })({ minWidth: 460 }),
        (async function () {
          const t = await Mt("nav");
          ...
          const e = Symbol("handled");
          ji.onDocMutations(() => {
            ji.$$(Wi.profilePage.followersFollowingsLink).forEach((o) => {
              o[e] ||
                ((o[e] = !0),
                o.addEventListener(
                  "click",
                  async (e) => {
                    ...
                    e.preventDefault(),
                      e.stopPropagation(),
                      await Ui.send("ig.force-small-iframe-width", !0);
                    const i = document.body;
                    (i.style.opacity = 0),
                      (i.style.transform = "translateY(3px)"),
                      await ji.waitFor(() => window.innerWidth < 700),
                      await ji.sleep(100),
                      t.push(o.getAttribute("href")),
                      await ji.waitFor(() =>
                        ji.$('html[data-page="followList"]')
                      ),
                      ...
                      Ui.send("ig.force-small-iframe-width", !1);
                  },
                  { capture: !0 }
                ));
            });
  ...
  var Xi = {
    init: function () {
      (Qi = Pt.controller.getConfig().igSelectors),
        Ho.onDocClick((t) => {
          const e = t.target.closest(".-wt5I");
          e &&
            setTimeout(() => {
              document.body.contains(e) && e.click();
            }, 300);
        }),
        (function () {
          const t = HTMLElement.prototype.getBoundingClientRect;
          HTMLElement.prototype.getBoundingClientRect = function (...e) {
            const o = t.call(this, ...e);
            return 0 === o.height && (o.height = 1), o;
          };
        })(),
        Yi.insertMultistyle`
    <style>
  ...
  `,
        document.addEventListener("keyup", (t) => {
          if ("Escape" === t.key) {
            const t = Yi.$(Qi.storyViewer.closeButton);
            if (!t) return;
            t.click();
          } else if ("ArrowLeft" === t.key) {
            const t = Yi.$(Qi.storyViewer.prevButton);
            if (!t) return;
            t.click();
          } else if ("ArrowRight" === t.key) {
            const t = Yi.$(Qi.storyViewer.nextButton);
            if (!t) return;
            t.click();
          }
        }),
        (function () {
          const t = "__manageStoriesAutoplay";
          let e = null,
            o = !1;
          Yi.onDocMutations(() => {
            const i = Yi.$(Qi["stories-viewer"]);
            e &&
              !i &&
              ((o = !1),
              Ho.docElem.classList.remove("enable-stories-autoplay")),
              (e = i);
            const n = Yi.$(Qi["story-video-play-button"]);
            o &&
              n &&
              !n[t] &&
              setTimeout(() => {
            ...
            Ho.onDocClick((e) => {
              const i = e.target.closest(Qi["story-video-play-button"]);
              i &&
                !o &&
                ((i[t] = !0),
                (o = !0),
                Ho.docElem.classList.add("enable-stories-autoplay"));
            }),
            Yi.insertMultistyle`
    <style>
  ...
  `;
        ...
        (function () {
          ...
          window.addEventListener = (...e) => {
            if ("blur" !== e[0]) return t.call(window, ...e);
          };
        })();
    },
  };
  let Qi;
  const { $utils: Ki, $iframeBus: Zi } = app;
  var Ji = {
    init: function () {
      (tn = Pt.controller.getConfig().igSelectors),
        Ki.insertMultistyle`
    <style>
  ...
  `,
        (async function () {
          if (!(await Mt("store"))) return;
          const t = CanvasRenderingContext2D.prototype.drawImage;
          CanvasRenderingContext2D.prototype.drawImage = function (...e) {
            if (
              !(
                9 === e.length &&
                e[0] instanceof HTMLImageElement &&
                "/create/story/" === location.pathname
              )
            )
              return t.call(this, ...e);
            const o = Ki.$(tn.storyCreation.root);
            if (!o) return t.call(this, ...e);
            const i = window.devicePixelRatio;
            let n, r;
            o.offsetWidth / o.offsetHeight > 9 / 16
              ? ((n = o.offsetHeight * (9 / 16)), (r = o.offsetHeight))
              : ((n = o.offsetWidth), (r = o.offsetWidth / (9 / 16))),
              (o.style.width = `${n}px`),
              (o.style.height = `${r}px`),
              Ki.$$("canvas").forEach((t) => {
                (t.style.width = `${n}px`),
                  (t.style.height = `${r}px`),
                  t.setAttribute("width", n * i),
                  t.setAttribute("height", r * i);
              });
            const a = e[0],
              s = 0.04,
              l = a.width / a.height,
              c =
                l > (9 / 16) * (1 - s) && l < (1 + s) * (9 / 16)
                  ? "cover"
                  : "contain";
            this.restore();
            const d = n * i,
              p = r * i;
            "contain" === c &&
              ((this.filter = "blur(170px)"),
              t.call(this, a, -300, -300, d + 600, p + 600),
              (this.filter = "none"));
            const u = (function ({
              type: t,
              width: e,
              ...
              const a = e / o,
                s = i / n;
              return (a > s && "contain" === t) || (a < s && "cover" === t)
                ? {
                    dx: 0 + r,
                    dy: (n - i / a) / 2 + r,
                    width: i - 2 * r,
              ...
              containerWidth: d,
              containerHeight: p,
              offset: ni.storySharingPost ? 60 : 0,
            });
            if (
              (t.call(this, a, u.dx, u.dy, u.width, u.height),
              ni.storySharingPost)
            ) {
              const t = Ki.$("canvas").getContext("2d"),
                e = window.devicePixelRatio,
                o = ni.storySharingPost.owner.username,
                i = 60 / e,
                n = (u.dy + u.height + 40) / e;
              t.save(),
                t.scale(e, e),
                (t.fillStyle = "white"),
                (t.shadowColor = "rgba(150, 150, 150, 0.3)"),
                (t.shadowOffsetX = 0),
                (t.shadowOffsetY = 1),
                (t.shadowBlur = 2),
                (t.font = "600 22px sans-serif"),
                (t.textAlign = "left"),
                (t.textBaseline = "top"),
                t.fillText(`@${o}`, i, n),
                t.restore();
        ...
        (function () {
          const t = Symbol("handled");
          Ki.onDocMutations(async () => {
            const e = Ki.$(tn.storyCreation.root);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            if (await Zi.send("ig.is-fullscreen")) return;
            const o = document.documentElement;
            o.classList.add("story-creation-dark-background"),
              Ki.onDocMutations(function t() {
                Ki.$(tn.storyCreation.root) ||
                  (Ki.onDocMutations.off(t),
                  o.classList.remove("story-creation-dark-background"));
              });
          }),
            Ki.insertMultistyle`
    <style>
  ...
  `;
        ...
        (async function () {
          const t = await Mt("http:retry-story-post");
          if (!t) return;
          Mt.unlockOnNextTick("http:story-assist");
          const e = t.post.bind(t),
            o = async (t, i = 1) => {
              let n;
              console.log(`trying to post a story, attempt no.${i}`);
              try {
                n = await e(...t);
              } catch {
                n = { status: "fail" };
              }
              return "fail" === n.status && i < 5
                ? (await Ki.sleep(3e3), o(t, i + 1))
                : n;
            };
          t.post = (...t) =>
            t[0].includes("/create/configure_to_story/") ? o(t) : e(...t);
        })(),
        (function () {
          const t = Symbol("handled");
          Ki.onDocMutations(() => {
            const e = Ki.$(tn.storyCreation.downloadButton);
            e && (e.parentNode[t] || ((e.parentNode[t] = !0), e.remove()));
          });
        })(),
        Ki.insertMultistyle`
    <style>
  ...
  `,
        (function () {
          const t = Symbol("handled");
          Ki.onDocMutations(() => {
            const e = Ki.$(tn.storyCreation.video);
            e &&
              (e[t] ||
                ((e[t] = !0),
                (e.muted = !1),
                (e.controls = !0),
                (e.controlsList = "nodownload noremoteplayback noplaybackrate"),
                (e.disablePictureInPicture = !0),
                setTimeout(() => (e.volume = 1), 100)));
          }),
            Ki.insertMultistyle`
    <style>
  ...
  `;
        ...
        (function () {
          const t = Symbol();
          Ki.onDocMutations(() => {
            const e = Ki.$(tn.storyCreation.submitButton);
            e &&
              (e[t] ||
                ((e[t] = !0),
                e.addEventListener(
        ...
        (function () {
          const t = Event.prototype.preventDefault;
          Event.prototype.preventDefault = function (...e) {
            var o, i;
            if (
              !this.type.startsWith("touch") ||
              !(null === (o = (i = this.target).matches) || void 0 === o
                ? void 0
                : o.call(i, tn.storyCreation.canvas))
            )
              return t.call(this, ...e);
          };
        })(),
          ...
          t.post = (...t) => (
            (() => {
              ...
              if (
                !(null === (e = t[0]) || void 0 === e
                  ? void 0
                  : e.includes("/configure_to_story"))
              )
                return;
              const o = Ki.$(tn.storyCreation.uploadText);
              o && (o.innerText = "Publishing...");
            })(),
            e(...t)
          );
          const o = Symbol();
          Ki.onDocMutations(() => {
            const t = Ki.$(tn.storyCreation.uploadText);
            t &&
              (t[o] ||
                ((t[o] = !0),
                (t.innerText = "Uploading..."),
                t.insertAdjacentHTML(
                  "afterend",
  ...
  let tn;
  const { $utils: en, $iframeBus: on } = app;
  var nn = {
    init: async function () {
      if (
        ((rn = Pt.controller.getConfig().igSelectors),
        (an = await Mt("store")),
        !an)
      )
        return;
      en.onDocClick(
        function (t) {
          t.target.closest('[href="/direct/inbox/"]') &&
            (t.preventDefault(),
            t.stopPropagation(),
            on.send("ig.open-sidebar-dm"));
        },
        { capture: !0 }
      ),
        (function () {
          const t = Symbol("handled");
          en.onDocMutations(async () => {
            const o = en.$(rn.profilePage.moreButton);
            if (!o) return;
            const i = an.getState(),
              n = i.users.viewerId,
              r = i.users.users.get(n);
            if (location.pathname.split("/")[1] === r.username) return;
            let a = en.$(".write-button");
            if (a && a !== o.previousElementSibling)
              return a.remove(), void (o[t] = !1);
            if (o[t]) return;
            o[t] = !0;
            (await e()) &&
              (o.insertAdjacentHTML(
  ...
  `;
          const e = async () => {
            ...
            return await en.waitFor(() => {
              const e = an.getState(),
                o = e.users.usernameToId.get(t);
              return e.users.users.get(o) || null;
            });
          };
        })();
    },
  ...
  let rn, an;
  const { $utils: sn, $iframeBus: ln } = app;
  var cn = {
    init: async function () {
      if (((pn = await Mt("store")), !pn)) return;
      (dn = Pt.controller.getConfig().igSelectors),
        (function () {
          const t = Symbol("handled");
          sn.onDocMutations(() => {
            const e = sn.$(dn.profilePage.content);
            if (!e) return;
            if (e[t]) return;
            e[t] = !0;
            const o = hn({ empty: !0 });
            e.insertAdjacentHTML("afterbegin", o),
              (async () => {
                try {
                  var t;
                  const o = location.pathname.split("/")[1],
                    i = await sn.waitFor(() => {
                      const t = pn.getState(),
                        e = t.users.usernameToId.get(o);
                      if (e) return t.users.users.get(e);
                    });
                  if (!document.body.contains(e)) return;
                  const n = Object.values(pn.getState().posts.byId.toJS())
                      .filter((t) => {
                        var e;
                        return (
                          String(
                      ...
                      .sort((t, e) => e.postedAt - t.postedAt)
                      .slice(0, 12),
                    r = {
                      userId: i.id,
                      username: i.username,
                      bio: i.bio,
                      postsCount: i.counts.media,
                      followersCount: i.counts.followedBy,
                      followingsCount: i.counts.follows,
                      isPrivate: i.isPrivate,
                      isVerified: i.isVerified,
                      hasAvatar: i.profilePictureUrl.includes("150x150"),
                      hasHighlights: i.highlightReelCount > 0,
                      lastPosts: n.map((t) => ({ ts: 1e3 * t.postedAt })),
                    };
                  if (
                    ((un.grade = await ln.send(
                      "chrome-bus",
                    ...
                    return;
                  un.engagement = (function ({ user: t, posts: e }) {
                    const o = pn.getState().users.viewerId === t.id;
                    if ((t.isPrivate && !o) || 0 === e.length)
                      return { value: "N/A", color: "#D8DADD", label: "" };
                    const i = e
                        .map((t) => t.comments + t.likes)
                        .reduce((t, e) => t + e, 0),
                      n = e.length > 0 ? i / e.length : 0,
                      r = t.followerCount > 0 ? (n / t.followerCount) * 100 : 0,
                      a = `${
                        r < 5
                          ? (Math.round(10 * r) / 10).toFixed(1)
                          : Math.round(r).toString()
                      }%`,
                      s = { value: a, color: "#797979", label: "average" },
                      l = { value: a, color: "#74BE86", label: "above avg" },
                      c = { value: a, color: "#74BE86", label: "high" },
                      d = { value: a, color: "#74BE86", label: "v. high" },
                      p = { value: a, color: "#74BE86", label: "extreme" },
                      u =
                        r / (64.18845 * Math.pow(t.followerCount, -0.2251755));
                    if (u < 0.4) return s;
                    if (u < 0.8) return l;
                    if (u < 1.2) return c;
                    if (u < 1.8) return d;
                    ...
                    user: {
                      ...
                      isPrivate: i.isPrivate,
                      followerCount:
                        (null === (t = i.counts) || void 0 === t
                          ? void 0
                          : t.followedBy) || 0,
                    },
                    posts: n.map((t) => ({
                      likes: t.numPreviewLikes || 0,
                      comments: t.numComments || 0,
                    })),
                  });
                  const a = pn.getState().users.viewerId;
                  un.followStatus = {
                    show: String(a) !== String(i.id),
                    value: i.followsViewer,
                  };
                  sn.$(".profile-bar").outerHTML = hn();
                  to({
                    anchor: sn.$(".profile-bar__info-circle"),
                    class: "profile-bar__info-tooltip",
                  ...
                  console.error(
                    "ig profile bar controller → manageBarCreation:",
                    t
                  );
                  const e = sn.$(".profile-bar");
                  e && e.remove();
                }
              })();
          });
  ...
  let dn, pn;
  const un = { grade: null, engagement: null, followStatus: null };
  function hn({ empty: t = !1 } = {}) {
    return t
  ...
  var fn = {
    init: function () {
      !(async function () {
        ...
        const e = Symbol("handled");
        gn.onDocMutations(() => {
          const o = gn.$(".get-insights-button-row");
          if (!o) return;
          if (o[e]) return;
          o[e] = !0;
          const i = t.getState(),
            n = i.navigation.displayedRoute.split("/")[1],
            r = i.users.usernameToId.get(n);
          if (!r) return;
          const a = i.users.users.get(r);
          if (!a) return;
          const s = a.businessEmail;
          s &&
            o.insertAdjacentHTML(
              "afterbegin",
  ...
  function mn() {
    const t = window.require("CurrentUserInitialData");
    return (null == t ? void 0 : t.APP_ID) || "1217981644879628";
  }
  const { $utils: yn } = app;
  var vn = {
    init: function () {
      (bn = Pt.controller.getConfig().igSelectors),
        (async function () {
          const t = await Mt("store"),
            e = await Mt("http");
          if (!t || !e) return;
          const o = Symbol("handled");
          yn.onDocMutations(() => {
            const e = yn.$(bn.general.actionDialogWithoutHeader);
            if (!e) return;
            if (e[o]) return;
            e[o] = !0;
            const i = t.getState();
            if ("postPage" !== i.navigation.pageIdentifier) return;
            const n = location.pathname.split("/")[2],
              r = i.posts.byId.toJS(),
              a = Object.values(r).find((t) => t.code === n);
            if (!a) return;
            if (a.owner.id !== i.users.viewerId) return;
            const s = yn.$(bn.general.modalWindow);
            if (!s) return;
            e.firstChild.insertAdjacentHTML(
              "afterend",
              '\n      <button class="edit-post-action-button">\n        Edit Caption\n      </button>\n    '
            );
            yn.$(".edit-post-action-button").addEventListener("click", () => {
              s.classList.add("post-editor"),
              ...
              const t = yn.$(".post-editor"),
                o = yn.$(".post-editor__textarea"),
                i = yn.$(".post-editor__button-save"),
                n = yn.$(".post-editor__button-cancel"),
                r = yn.$(".post-editor__error");
              setTimeout(() => {
                o.focus(), o.setSelectionRange(o.value.length, o.value.length);
              }, 300),
                o.addEventListener("input", () => {
                  t.classList.remove("post-editor_with-error");
                }),
                t.addEventListener("submit", async (e) => {
                  ...
                  try {
                    (l = await fetch(
                      `https://i.instagram.com/api/v1/media/${a.id}/edit_media/`,
                      {
                        method: "POST",
                        credentials: "include",
                        headers: {
                        ...
                        body: JSON.stringify({
                          caption_text: yn.$(".post-editor__textarea").value,
                        }),
                      }
                    )),
                      (l = await l.json());
                  ...
                  var c, d, p, u, h, g, f;
                  "ok" ===
                  (null === (s = l) || void 0 === s ? void 0 : s.status)
                    ? location.reload()
                    : ((o.disabled = !1),
                      (i.disabled = !1),
                      (n.disabled = !1),
                      (i.innerText = "Save Caption"),
                      t.classList.add("post-editor_with-error"),
                      "igtv" === a.productType
                        ? (r.innerHTML =
                ...
                n.addEventListener("click", () => {
                  const t = yn.$(bn.general.modal);
                  if (!t) return;
                  const e = new MouseEvent("mousedown", { bubbles: !0 });
                  t.dispatchEvent(e);
                });
            });
          }),
  ...
  var xn = {
    init: async function () {
      if (
        ((Pn = Pt.controller.getConfig().igSelectors),
        (wn = await Mt("add-dispatch-listener")),
        !wn)
      )
        return;
      (function () {
        const t = Symbol("handled");
        _n.onDocMutations(() => {
          const e = _n.$(Pn.postCreation.captionContainer);
          e &&
            (e[t] ||
              ((e[t] = !0),
              e.insertAdjacentHTML(
  ...
  `,
        wn((t) => {
          if ("CREATION_CAPTION_CHANGED" !== t.type) return;
          const e = (function (t) {
            const e = 2200,
              o = 30,
              i = 30,
              n = (t.match(/@[\p{L}\d_]+/gu) || []).length,
              r = (t.match(/#[\p{L}\d_]+/gu) || []).length;
            return t.length > e
              ? `Caption length exceeded: ${t.length} / ${e}`
              : n > o
              ? `Mention limit exceeded: ${n} / ${o}`
              : r > i
              ? `Hashtag limit exceeded: ${r} / ${i}`
              : null;
          })(t.caption || "");
          _n.docElem.classList.toggle("post-caption-limits--show", !!e);
          const o = _n.$(".post-caption-limits__text");
          o && (o.innerText = e);
        });
    },
  };
  ...
  var Sn = {
    init: async function () {
      if (
        (($n = Pt.controller.getConfig().igSelectors),
        (Mn = await Mt("http")),
        (kn = await Mt("store")),
        (Tn = await Mt("add-dispatch-listener")),
        !Mn || !kn || !Tn)
      )
        return;
      !(function () {
        ...
        Mn.post = async (...n) => {
          const r = n[0],
            a =
              (r.includes("/create/configure") && !r.includes("story")) ||
              r.includes("/igtv/configure_to_igtv"),
            s = r.includes("/media/configure_to_clips");
          if (!(a || s)) return e.call(Mn, ...n);
          const l = () => {
            kn.dispatch({
              type: "UPDATE_UPLOAD_TEXT",
            ...
            ? t < 20
              ...
              : ((t = 0),
                requestAnimationFrame(() => {
                  kn.dispatch({
                    type: "UPDATE_UPLOAD_TEXT",
                    text: c.message ? `Error: ${c.message}` : "Unknown error.",
                  }),
                    i();
                  const t = Cn.$($n.general.uploadPanel);
                  if (!t) return;
                  t.insertAdjacentHTML(
                    "beforeend",
                    '\n        <button class="retry-upload-button clickable">\n          Retry\n        </button>\n      '
                  );
                  const e = Cn.$(".retry-upload-button");
                  e.addEventListener("click", () => {
                    l(), Mn.post(...n), e.remove();
                  });
                }),
                c)
            : ((t = 0),
              requestAnimationFrame(() => {
                kn.dispatch({ type: "UPDATE_UPLOAD_TEXT", text: "Done" }), i();
              }),
              c);
        };
        const o = () => {
            if (Cn.$(".PublishingDisclaimer")) return;
            const t = Cn.$($n.general.publishingBarText);
            t &&
              t.insertAdjacentHTML(
                "beforeend",
          ...
          i = () => {
            const t = Cn.$(".PublishingDisclaimer");
            t && t.remove();
          };
        Cn.insertMultistyle`
    <style>
  ...
  let $n, Mn, kn, Tn;
  const { $utils: In, $iframeBus: An } = app,
    Dn = {
      init: async function () {
        (this.sel = Pt.controller.getConfig().igSelectors),
          (this.store = await Mt("store")),
          this.store &&
            (An.on("ig.creation-get-caption", this.getCaption.bind(this)),
            An.on("ig.creation-set-caption", this.setCaption.bind(this)),
            this.watchCreationSession(),
            this.notifyVideoChange());
      },
      getCaption: function () {
        var t, e;
        return (
          (null === (t = this.store.getState().creation) ||
          void 0 === t ||
          null === (e = t.finalizedMedia) ||
          void 0 === e
            ? void 0
            : e.caption) || ""
        );
      ...
      setCaption: function (t) {
        this.store.dispatch({ type: "CREATION_CAPTION_CHANGED", caption: t });
        const e = In.$(this.sel.postCreation.captionTextarea);
        e && (e.scrollTop = e.scrollHeight);
      },
      watchCreationSession: function () {
        let t = !1,
          e = !1,
          o = !1;
        this.store.subscribe(() => {
          ...
          const n = this.store.getState(),
            r =
              null === (i = n.navigation) || void 0 === i
                ? void 0
                : i.pageIdentifier;
          if (!r) return;
          const a = r.startsWith("Creation"),
            s = r.startsWith("StoryCreation"),
            l = a || s;
          if (l !== o)
            if (((o = l), l)) {
              var c, d;
              const o =
                  null === (c = n.creation.sourceVideo) || void 0 === c
                    ? void 0
                    : c.file,
                i =
                  null === (d = n.storyCreation.sourceVideo) || void 0 === d
                    ? void 0
                    : d.file;
              (t = s),
                (e = !(!o && !i)),
                An.send("ig.creation-session-start", {
                  isStory: t,
                  isVideo: e,
                });
            } else
              An.send("ig.creation-session-end", { isStory: t, isVideo: e });
        });
      },
      notifyVideoChange: async function () {
        let t = null;
        this.store.subscribe(() => {
          var e, o;
          const i = this.store.getState(),
            n =
              null === (e = i.creation) || void 0 === e
                ? void 0
                : e.sourceVideo,
            r =
              null === (o = i.storyCreation) || void 0 === o
                ? void 0
                : o.sourceVideo,
            a = null == n ? void 0 : n.dataURL,
            s = null == r ? void 0 : r.dataURL,
            l = a || s || null;
          l !== t && ((t = l), An.send("ig.creation-video-change", { url: l }));
        });
      },
    },
    { $utils: Rn, $iframeBus: En } = app,
    Bn = {
      init: function () {
        this._supportExtensionLinks();
      },
      _supportExtensionLinks: function () {
        Rn.onDocClick((t) => {
          const e = t.target.closest('[href^="chrome-extension://"]');
          e &&
            (t.preventDefault(),
            t.stopPropagation(),
            En.send("ig.open-link", e.getAttribute("href")));
        });
      },
    };
  var Ln = {
    init: function () {
      this._injectVideoSupportCode();
    },
    _injectVideoSupportCode: async function () {
      window.inssist.creationSelectVideo = (t) => async (e) => {
        try {
          ...
          }
          {
            let t;
            try {
              t = o("polarisGetVideoCoverPhoto");
            } catch {
              t = o("PolarisgetVideoCoverPhoto");
            }
            r = t.getVideoCoverPhoto;
          }
          ...
          e({
            ...
            uploadMediaDurationMs: Math.floor(1e3 * l.duration),
            videoTransform: c.videoTransform,
            mediaPublishMode: "default",
          }),
            e({
              type: "CREATION_VIDEO_COVER_PHOTO_UPDATED",
              dataURL: c.dataURL,
              entityName: s,
              file: c.file,
              uploadId: a,
          ...
          console.error("failed to select video", t);
        }
      };
    },
  };
  ...
  function Gn() {
    const t = Pt.controller.getConfig().igSelectors,
      e = Symbol("handled");
    Vn.onDocMutations(() => {
      const o = Vn.$(t.general.splashScreen);
      o &&
        (o[e] ||
          ((o[e] = !0),
          o.insertAdjacentHTML(
    ...
    controller: {
      init: async function () {
        (window.ig = Ho),
          ...
          Vn.iframe.isIframe() &&
            (async function () {
              if (!Vn.ls.get("inssist.isDevelopment")) return;
              (window.$ = Vn.$),
                (window.$$ = Vn.$$),
                (window.sel = Pt.controller.getConfig().igSelectors),
                (window.store = await Ho.require("store")),
              ...
              const t = await Ho.require("add-dispatch-listener");
              let e = !1;
              (window.showActions = () => {
                e = !0;
              }),
        ...
        const t = Vn.iframe.isIframe("inssist-ig"),
          e = Vn.iframe.isIframe("inssist-dm");
        if (t)
          return (
            Ce.controller.init(),
            ie.controller.init(),
            ...
            Fe.controller.init(),
            Dn.init(),
            Do.uploadBarController.init(),
            mi.init(),
            await Vn.waitForDocumentReady(),
            void zn.send("ig.ready")
          );
        e &&
          (Ce.controller.init(),
          Bn.init(),
