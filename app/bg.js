!(function () {
  ...
  function W() {
    return (
      ...
      (q = (function () {
        V || $(z);
        for (var e, t = V.split(""), n = [], r = j.nextValue(); t.length > 0; )
          (r = j.nextValue()),
  ...
  var K,
    ...
    Z = function (e) {
      for (var t, n = 0, r = ""; !t; )
        (r += Q(J, B.get(), 1)), (t = e < Math.pow(16, n + 1)), n++;
      return r;
    };
  var ee = function (e) {
    var t = "",
  ...
  U.worker = le;
  var ue = function (e) {
    return void 0 !== e && B.characters(e), B.shuffled();
  };
  U.characters = ue;
  var ce = ne;
  (U.isValid = ce), (N = U);
  ...
  function It(e, t, n) {
    ...
    if (null != t)
      ...
      t))
        Ge.call(t, r) && !$e.hasOwnProperty(r) && (o[r] = t[r]);
  ...
  function Bt(e, t, n, r, o) {
    var i = "";
    null != n && (i = ("" + n).replace(We, "$&/") + "/"),
      Mt(e, Ut, (t = Ft(t, i, r, o))),
      At(t);
  }
  function jt() {
    var e = Je.current;
    if (null === e) throw Error(kt(321));
    return e;
  }
  function Lt() {
    return (
      Pt ||
        ...
        (Be = Te ? Symbol.for("react.memo") : 60115),
        ...
        ((qe = Tt.prototype = new Et()).constructor = Tt),
        Ee(qe, Dt.prototype),
        ...
        (Ye = []),
        (Qe = {
          ReactCurrentDispatcher: (Je = { current: null }),
        ...
        (De.Suspense = rt),
        (ot = Qe),
        (De.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ot),
        (it = function (e, t, n) {
          if (null == e) throw Error(kt(267, e));
          var r = Ee({}, e.props),
            o = e.key,
            i = e.ref,
            a = e._owner;
        ...
        (De.forwardRef = ct),
        (dt = Ct),
        (De.isValidElement = dt),
        (ft = function (e) {
          return { $$typeof: je, _ctor: e, _status: -1, _result: null };
        }),
        (De.lazy = ft),
        (pt = function (e, t) {
          return { $$typeof: Be, type: e, compare: void 0 === t ? null : t };
        }),
        (De.memo = pt),
        (ht = function (e, t) {
        ...
        (De.useImperativeHandle = bt),
        (yt = function (e, t) {
          return jt().useLayoutEffect(e, t);
        }),
        (De.useLayoutEffect = yt),
        (wt = function (e, t) {
  ...
  var Vt,
    ...
    qt = !1;
  function zt() {
    return qt || ((qt = !0), (Vt = {}), (Vt = Lt()), (Ht = t(Vt))), Vt;
  }
  zt();
  var Gt,
    $t = !1;
  ...
  nr ||
    ...
    (kn = un ? Symbol.for("react.fundamental") : 60117),
    (Dn = un ? Symbol.for("react.responder") : 60118),
  ...
  function Dr(e, t) {
    ...
    return function (t) {
      ...
      function d(n) {
        ...
        Sr(xr, [P, x, D, s, E, k, v]),
          Sr(Pr, [c, p, m, h, P, x, D, k, v, S], [p, m, h]);
        var T = zt().useMemo(
          function () {
  ...
  function Lo(e) {
    for (var t = Uo(mo); null !== t; ) {
      if (null === t.callback) Bo(mo);
      else {
        if (!(t.startTime <= e)) break;
        Bo(mo), (t.sortIndex = t.expirationTime), No(go, t);
      }
      t = Uo(mo);
    }
  }
  function Vo(e) {
    if (((So = !1), Lo(e), !_o))
      if (null !== Uo(go)) (_o = !0), $r(Ho);
      else {
        var t = Uo(mo);
        null !== t && Wr(Vo, t.startTime - e);
      }
  }
  function Ho(e, t) {
    ...
    try {
      for (
        Lo(t), bo = Uo(go);
        null !== bo && (!(bo.expirationTime > t) || (e && !Jr()));
      ...
      if (null !== bo) var i = !0;
        ...
        var a = Uo(mo);
        null !== a && Wr(Vo, a.startTime - t), (i = !1);
      }
      return i;
    } finally {
      (bo = null), (yo = n), (wo = !1);
      ...
      Ro ||
        ...
        "undefined" == typeof window || "function" != typeof MessageChannel
          ? ((Kr = null),
            ...
            (zr = function () {}),
            (Qr = Gr.unstable_forceFrameRate = zr))
        ...
        (Gr.unstable_continueExecution = ko),
        (Do = function () {
          return yo;
        }),
        (Gr.unstable_getCurrentPriorityLevel = Do),
        (Eo = function () {
          return Uo(go);
        }),
        ...
        (Ao = function (e, t, n) {
          ...
          if ("object" == typeof n && null !== n) {
            ...
            (o = "number" == typeof o && 0 < o ? r + o : r),
              (n = "number" == typeof n.timeout ? n.timeout : qo(e));
          } else (n = qo(e)), (o = r);
          return (
            (e = {
              id: vo++,
            ...
            o > r
              ? ((e.sortIndex = o),
                ...
                null === Uo(go) &&
                  e === Uo(mo) &&
                  (So ? Yr() : (So = !0), Wr(Vo, o - r)))
              : ((e.sortIndex = n), No(go, e), _o || wo || ((_o = !0), $r(Ho))),
            e
          );
        }),
  ...
  function Wu(e, t, n, r, o, i, a, s, l) {
    (Ko = !1), (Xo = null), $u.apply(ti, arguments);
  }
  function Yu(e, t, n) {
    var r = e.type || "unknown-event";
    (e.currentTarget = oi(n)),
      (function (e, t, n, r, o, i, a, s, l) {
        if ((Wu.apply(this, arguments), Ko)) {
      ...
      for (var e in ai) {
        ...
        if (!si[n]) {
          ...
          for (var r in ((si[n] = t), (n = t.eventTypes))) {
            ...
            if (l) {
              for (o in l) l.hasOwnProperty(o) && Qu(l[o], a, s);
              o = !0;
            } else
              i.registrationName
                ? (Qu(i.registrationName, a, s), (o = !0))
                : (o = !1);
  ...
  function uc(e) {
    return null === e || "object" != typeof e
      ? null
      : "function" == typeof (e = (Vi && e[Vi]) || e["@@iterator"])
      ? e
      : null;
  }
  function cc(e) {
  ...
  function Sc(e, t) {
    return (
      ...
      (t = (function (e) {
        var t = "";
        return (
          Jo.Children.forEach(e, function (e) {
            null != e && (t += e);
          }),
          t
        );
  ...
  function Ac(e) {
    ...
    var t,
      n = Gi[e];
    for (t in n) if (n.hasOwnProperty(t) && t in Wi) return ($i[e] = n[t]);
    return e;
  }
  function Oc(e) {
    var t = Zi.get(e);
  ...
  function Vc(e) {
    if ((null !== e && (ea = Bc(ea, e)), (e = ea), (ea = null), e)) {
  ...
  function $c(e) {
    ...
    do {
      ...
      if (!r) break;
      (5 !== (t = n.tag) && 6 !== t) || e.ancestors.push(n), (n = Dd(r));
    } while (n);
      ...
      if (null !== n)
        if (13 === (t = n.tag)) {
          if (null !== (t = Rc(n)))
            return (
              (e.blockedOn = t),
              void Wo().unstable_runWithPriority(e.priority, function () {
                oa(n);
              })
            );
  ...
  function td(e, t) {
    e.blockedOn === t &&
      ...
      ia ||
        ((ia = !0),
        Wo().unstable_scheduleCallback(Wo().unstable_NormalPriority, ed)));
  }
  function nd(e) {
    function t(t) {
      return td(t, e);
      ...
      if (0 < aa.length && -1 < pa.indexOf(e))
        ...
        if (null === o) Jc(e, r);
          ...
          !(function (e, t, n, r, o) {
            switch (t) {
              case "focus":
                return (sa = Qc(sa, e, t, n, r, o)), !0;
              case "dragenter":
                return (la = Qc(la, e, t, n, r, o)), !0;
              case "mouseover":
                return (ua = Qc(ua, e, t, n, r, o)), !0;
              case "pointerover":
                var i = o.pointerId;
                return ca.set(i, Qc(ca.get(i) || null, e, t, n, r, o)), !0;
              case "gotpointercapture":
                return (
                  (i = o.pointerId),
                  da.set(i, Qc(da.get(i) || null, e, t, n, r, o)),
                  !0
                );
            }
            return !1;
  ...
  function fd(e, t) {
    if (t) {
      if (Da[e] && (null != t.children || null != t.dangerouslySetInnerHTML))
  ...
  function hd(e, t) {
    ...
    t = ci[t];
    for (var r = 0; r < t.length; r++) Wc(t[r], e, n);
  }
  function gd() {}
  function md(e) {
    if (
  ...
  function qd(e) {
    (e.eventPool = []), (e.getPooled = Vd), (e.release = Hd);
  }
  function zd(e, t) {
    switch (e) {
      case "keyup":
  ...
  function Xd(e) {
    if ("value" === e.propertyName && Jd(os))
      if (((e = Wd(os, e, Hc(e))), mi)) Vc(e);
      else {
        mi = !0;
        try {
          tc(Yd, e);
  ...
  function tf(e, t) {
    if ("click" === e) return Jd(t);
  }
  function nf(e, t) {
    if ("input" === e || "change" === e) return Jd(t);
  }
  function rf(e) {
  ...
  function cf(e) {
    0 > Bs || ((e.current = Us[Bs]), (Us[Bs] = null), Bs--);
  }
  function df(e, t) {
    Bs++, (Us[Bs] = e.current), (e.current = t);
  }
  function ff(e, t) {
  ...
  function _f(e, t) {
    return (e = wf(e)), qs(e, t);
  }
  function Sf(e, t, n) {
    return (e = wf(e)), zs(e, t, n);
  }
  function xf(e) {
    return null === rl ? ((rl = [e]), (ol = zs(Js, kf))) : rl.push(e), el;
  }
  function Pf() {
    if (null !== ol) {
      var e = ol;
  ...
  function kf() {
    if (!il && null !== rl) {
      ...
      try {
        ...
        throw (null !== rl && (rl = rl.slice(e + 1)), zs(Js, Pf), t);
      } finally {
        il = !1;
      }
    }
  ...
  function Ef(e, t) {
    if (e && e.defaultProps)
      for (var n in ((t = Qo({}, t)), (e = e.defaultProps)))
        void 0 === t[n] && (t[n] = e[n]);
    return t;
  }
  function Tf() {
  ...
  function Lf(e, t, n, r) {
    (n = null == (n = n(r, (t = e.memoizedState))) ? t : Qo({}, t, n)),
      (e.memoizedState = n),
      0 === e.expirationTime && (e.updateQueue.baseState = n);
  }
  function Vf(e, t, n, r, o, i, a) {
  ...
  function Wf(e) {
    ...
    function d(e, t, n) {
      ...
      if ("object" == typeof t && null !== t) {
        ...
        if (ml(t) || uc(t)) return ((t = $h(t, e.mode, n, null)).return = e), t;
        $f(e, t);
      }
      return null;
    }
        ...
        switch (i.$$typeof) {
          case Ei:
            e: {
              ...
              i.type === Ii
                ? (((r = $h(i.props.children, e.mode, s, i.key)).return = e),
                  (e = r))
      ...
      if ("string" == typeof i || "number" == typeof i)
        return (
          ...
          null !== r && 6 === r.tag
            ...
            : (n(e, r), ((r = Wh(i, e.mode, s)).return = e), (e = r)),
          a(e)
        );
      if (ml(i)) return h(e, r, i, s);
      if (uc(i)) return g(e, r, i, s);
      if ((u && $f(e, i), void 0 === i && !l))
        switch (e.tag) {
          case 1:
          case 0:
            throw (
      ...
      do {
        ...
        if (u < Dl) {
          ...
          null === s ? ((a = s = c), (i = r)) : (s = s.next = c),
            u > El.expirationTime && ((El.expirationTime = u), Dh(u));
        } else
          null !== s &&
            (s = s.next =
              {
  ...
  function Pp(e, t, n) {
    ...
    if (
      ...
      (Cl = !0), (o.expirationTime = Dl), (El.expirationTime = Dl);
    else {
      if (
        0 === e.expirationTime &&
  ...
  function Ip(e) {
    if (e !== Rl) return !1;
    if (!Ul) return Tp(e), (Ul = !0), !1;
    var t = e.type;
    if (
      5 !== e.tag ||
      ("head" !== t && "body" !== t && !xd(t, e.memoizedProps))
    )
      for (t = Nl; t; ) kp(e, t), (t = Pd(t.nextSibling));
    if ((Tp(e), 13 === e.tag)) {
    ...
    if ((Fp(e, t, r.children, n), 0 != (2 & (r = xl.current))))
      ...
      if (null !== e && 0 != (64 & e.effectTag))
        e: for (e = t.child; null !== e; ) {
          if (13 === e.tag) null !== e.memoizedState && Vp(e, n);
          else if (19 === e.tag) Vp(e, n);
  ...
  function zp(e, t, n) {
    ...
    if ((0 !== r && Dh(r), t.childExpirationTime < n)) return null;
    ...
    switch (t.tag) {
      ...
      case 5:
        ...
        if (null !== e && null != t.stateNode)
          ql(e, t, o, r, n), e.ref !== t.ref && (t.effectTag |= 128);
        else {
          if (!r) {
          ...
          if (((e = Yf(wl.current)), Ip(t))) {
            ...
            switch (((r[Ua] = t), (r[Ba] = i), o)) {
              ...
              case "select":
                ...
                break;
              case "textarea":
                kc(r, i), od("invalid", r), hd(n, "onChange");
            }
            ...
            switch (
              ...
              case "select":
                ...
                break;
              case "textarea":
                kc(e, r), (s = Pc(e, r)), od("invalid", e), hd(n, "onChange");
                break;
              default:
                s = r;
            }
  ...
  function Wp(e) {
    switch (e.tag) {
      ...
      case 3:
        if ((Qf(), cf(Vs), cf(Ls), 0 != (64 & (t = e.effectTag))))
          throw Error(Gu(285));
  ...
  function dh(e, t, n) {
    ...
    return (
      null !== i &&
        ...
        (n.callback = function () {
          "function" != typeof r &&
            (null === Su ? (Su = new Set([this])) : Su.add(this), Jp(e, t));
          var n = t.stack;
  ...
  function ph(e, t, n) {
    ...
    if ((au & Xl) !== Ql) return uu;
    if (null !== n) e = Df(e, 0 | n.timeoutMs || 5e3, 250);
    else
      switch (r) {
        case 99:
          e = 1073741823;
  ...
  function gh(e, t) {
    ...
    return (
      null !== o && (su === o && (Dh(t), cu === ou && Kh(o, uu)), Xh(o, t)), o
    );
  }
  function mh(e) {
    var t = e.lastExpiredTime;
    if (0 !== t) return t;
    if (!Qh(e, (t = e.firstPendingTime))) return t;
  ...
  function bh(e, t) {
    ...
    var n = mh(e);
    if (0 !== n) {
      if (((t = e.callbackNode), (au & (Xl | Zl)) !== Ql)) throw Error(Gu(327));
  ...
  function yh(e) {
    var t = e.lastExpiredTime;
    if (((t = 0 !== t ? t : 1073741823), (au & (Xl | Zl)) !== Ql))
      throw Error(Gu(327));
  ...
  function Ch(e) {
    ...
    do {
      ...
      if (((e = lu.return), 0 == (2048 & lu.effectTag))) {
        if (((t = $p(t, lu, uu)), 1 === uu || 1 !== lu.childExpirationTime)) {
        ...
        if (null !== (t = Wp(lu))) return (t.effectTag &= 2047), t;
        null !== e &&
  ...
  function Oh(e, t) {
    ...
    if ((au & (Xl | Zl)) !== Ql) throw Error(Gu(327));
  ...
  function Rh() {
    if (90 !== ku) {
      var e = 97 < ku ? 97 : ku;
      return (ku = 90), _f(e, Nh);
    }
  }
  function Nh() {
    if (null === Pu) return !1;
    var e = Pu;
    if (((Pu = null), (au & (Xl | Zl)) !== Ql)) throw Error(Gu(331));
    var t = au;
  ...
  function Gh(e, t, n, r, o, i) {
    var a = 2;
    if (((r = e), "function" == typeof e)) qh(e) && (a = 1);
    else if ("string" == typeof e) a = 5;
    else
      e: switch (e) {
        case Ii:
          return $h(n.children, o, i, t);
        case Mi:
          (a = 8), (o |= 7);
          break;
        case Ci:
        ...
        case Ui:
          return (
            ((e = Hh(19, n, t, o)).elementType = Ui), (e.expirationTime = i), e
          );
        default:
          if ("object" == typeof e && null !== e)
            switch (e.$$typeof) {
  ...
  function og(e, t, n) {
    var r = new Jh(e, t, (n = null != n && !0 === n.hydrate)),
  ...
  function ug() {
    if (((Yo = {}), (Jo = zt()), (Qo = ke()), Wo(), !Jo)) throw Error(Gu(227));
    var e;
    (Ko = !1),
      (Xo = null),
      (Zo = !1),
      ...
      (Pi =
        Jo.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED).hasOwnProperty(
      ...
      (Ei = Di ? Symbol.for("react.element") : 60103),
      (Ti = Di ? Symbol.for("react.portal") : 60106),
      (Ii = Di ? Symbol.for("react.fragment") : 60107),
      (Ci = Di ? Symbol.for("react.strict_mode") : 60108),
      (Fi = Di ? Symbol.for("react.profiler") : 60114),
      (Ai = Di ? Symbol.for("react.provider") : 60109),
      (Oi = Di ? Symbol.for("react.context") : 60110),
      (Mi = Di ? Symbol.for("react.concurrent_mode") : 60111),
      (Ri = Di ? Symbol.for("react.forward_ref") : 60112),
      (Ni = Di ? Symbol.for("react.suspense") : 60113),
      (Ui = Di ? Symbol.for("react.suspense_list") : 60120),
      (Bi = Di ? Symbol.for("react.memo") : 60115),
      (ji = Di ? Symbol.for("react.lazy") : 60116),
      (Li = Di ? Symbol.for("react.block") : 60121),
      (Vi = "function" == typeof Symbol && Symbol.iterator),
      (Hi = {
      ...
      (e = function (e, t) {
        if (e.namespaceURI !== Hi.svg || "innerHTML" in e) e.innerHTML = t;
          ...
          for (
            (qi = qi || document.createElement("div")).innerHTML =
      ...
      (Yi = Ac("animationend")),
      (Ji = Ac("animationiteration")),
      (Qi = Ac("animationstart")),
      (Ki = Ac("transitionend")),
      (Xi =
    ...
    for (
      ...
      va.set(ya[wa], 0);
    if (
      ((_a = Wo().unstable_UserBlockingPriority),
      (Sa = Wo().unstable_runWithPriority),
      (xa = !0),
      (Pa = {
      ...
      (Ua = "__reactInternalInstance$" + Na),
      (Ba = "__reactEventHandlers$" + Na),
      ...
      qd(Ld),
      (qa = Ld.extend({ data: null })),
      (za = Ld.extend({ data: null })),
      (Ga = [9, 13, 27, 32]),
      ($a = di && "CompositionEvent" in window),
      (Wa = null),
      di && "documentMode" in document && (Wa = document.documentMode),
      (Ya = di && "TextEvent" in window && !Wa),
      (Ja = di && (!$a || (Wa && 8 < Wa && 11 >= Wa))),
        ...
        extractEvents: function (e, t, n, r) {
          ...
          return (
            i
              ? (Ja &&
                  ...
                  (Za || i !== Ka.compositionStart
                    ? i === Ka.compositionEnd && Za && (o = Ud())
                    : ((Va = "value" in (La = r) ? La.value : La.textContent),
                      (Za = !0))),
                (i = qa.getPooled(i, t, n, r)),
            ...
            (e = Ya
              ? (function (e, t) {
                  switch (e) {
                    case "compositionend":
                      return Gd(t);
                    case "keypress":
                      return 32 !== t.which ? null : ((Xa = !0), Qa);
                    case "textInput":
                      return (e = t.data) === Qa && Xa ? null : e;
                    default:
                      return null;
                  }
                })(e, n)
              : (function (e, t) {
                  if (Za)
                    return "compositionend" === e || (!$a && zd(e, t))
                      ? ((e = Ud()), (Ha = Va = La = null), (Za = !1), e)
                      : null;
                  switch (e) {
                    case "paste":
                      return null;
                    case "keypress":
                      ...
                      return null;
                    case "compositionend":
                      return Ja && "ko" !== t.locale ? null : t.data;
                    default:
                      return null;
                  }
                })(e, n))
      ...
      di &&
        (is =
          qc("input") && (!document.documentMode || 9 < document.documentMode)),
      (as = {
        eventTypes: ns,
      ...
      (ms = {
        ...
        extractEvents: function (e, t, n, r, o) {
          ...
          a)
            ? ((a = t),
              null !==
                (t = (t = n.relatedTarget || n.toElement) ? Dd(t) : null) &&
    ...
    (ii = Array.prototype.slice.call(
      ...
      (Vs = { current: !1 }),
      (Hs = js),
      (qs = Wo().unstable_runWithPriority),
      (zs = Wo().unstable_scheduleCallback),
      (Gs = Wo().unstable_cancelCallback),
      ($s = Wo().unstable_requestPaint),
      (Ws = Wo().unstable_now),
      (Ys = Wo().unstable_getCurrentPriorityLevel),
      (Js = Wo().unstable_ImmediatePriority),
      (Qs = Wo().unstable_UserBlockingPriority),
      (Ks = Wo().unstable_NormalPriority),
      (Xs = Wo().unstable_LowPriority),
      (Zs = Wo().unstable_IdlePriority),
      (el = {}),
      (tl = Wo().unstable_shouldYield),
      (nl = void 0 !== $s ? $s : function () {}),
      (rl = null),
      (ol = null),
      (il = !1),
      (al = Ws()),
      ...
      (Cu = function (e, t, n) {
        ...
        if (null !== e) {
          ...
          if (e.memoizedProps !== o || Vs.current) jl = !0;
          else {
            if (r < n) {
              switch (((jl = !1), t.tag)) {
                case 3:
        ...
        switch (((t.expirationTime = 0), t.tag)) {
          ...
          case 16:
            e: {
              ...
              switch (
                ...
                (i = t.tag =
                  (function (e) {
                    if ("function" == typeof e) return qh(e) ? 1 : 0;
                    if (null != e) {
          ...
          case 1:
            return (
              (r = t.type),
              (o = t.pendingProps),
              Up(e, t, r, (o = t.elementType === r ? o : Ef(r, o)), n)
            );
          case 3:
            ...
            e: {
              ...
              if ((df(ll, s._currentValue), (s._currentValue = i), null !== a))
                if (
                  ...
                  if (a.children === o.children && !Vs.current) {
                    t = zp(e, t, n);
                    break e;
                  }
                } else
      ...
      (Yo.findDOMNode = Nu),
      (Uu = function (e, t) {
        if ((au & (Xl | Zl)) !== Ql) throw Error(Gu(187));
        var n = au;
        au |= 1;
        try {
      ...
      (Yo.unstable_renderSubtreeIntoContainer = qu),
      "16.13.1",
      (Yo.version = "16.13.1");
  }
  var cg,
    ...
    Ng = {
      ...
      send: function (e, ...t) {
        ...
        return new Promise((r) => {
          chrome.runtime.sendMessage({ [Bg]: e, [jg]: t }, (e) => {
  ...
  const { model: qg } = _g,
    zg = {
      isLoggedIn: function () {
        return !!qg.state.billing.account.token;
      },
      hasPro: function ({ feature: e } = {}) {
        ...
        return (
          !(
            !u.is.development ||
            !(null === (t = qg.state.experiments) || void 0 === t
              ? void 0
              : t.enabled)
          ) ||
          true ||
          true ||
          !(!e || !zg.hasTrialFeature(e))
        );
      },
      hasTrialFeature: function (e = "*") {
        if (!u.features.trial) return !1;
        const t = qg.state.billing.trial;
        if (!t) return !1;
        if ("*" === e) {
          for (e in t)
            if (
      ...
      hasProPaid: function (e = null) {
        if (!zg.isLoggedIn()) return !1;
        const t = qg.state.billing,
          n = Date.now(),
        ...
        for (const r in u.options.billingPlans) {
          ...
          if (a.isActive) {
            if (a.isActive(qg.state)) return !0;
      ...
      hasProPromocode: function () {
        const e = qg.state.billing.promocode;
        if (!e) return !1;
        const t = Date.now(),
          [n, r, o] = e.split("."),
          i = new Date(`${r}-${n}-${o}`);
  ...
  !(function () {
    try {
      $g = "function" == typeof setTimeout ? setTimeout : Qg;
    } catch (e) {
      $g = Qg;
    }
    try {
      Wg = "function" == typeof clearTimeout ? clearTimeout : Kg;
    } catch (e) {
      Wg = Kg;
    }
  })();
  ...
  function rm() {
    tm &&
      Zg &&
      ((tm = !1),
      Zg.length ? (em = Zg.concat(em)) : (nm = -1),
      em.length && om());
  }
  function om() {
    if (!tm) {
      ...
      for (var t = em.length; t; ) {
        for (Zg = em, em = []; ++nm < t; ) Zg && Zg[nm].run();
        (nm = -1), (t = em.length);
      }
      (Zg = null),
        (tm = !1),
  ...
  function am() {}
  (Jg.nextTick = function (e) {
    var t = new Array(arguments.length - 1);
    if (arguments.length > 1)
      for (var n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
    em.push(new im(e, t)), 1 !== em.length || tm || Xg(om);
  }),
    ...
    (Jg.once = am),
    (Jg.off = am),
    (Jg.removeListener = am),
    (Jg.removeAllListeners = am),
    (Jg.emit = am),
    (Jg.prependListener = am),
    (Jg.prependOnceListener = am),
    (Jg.listeners = function (e) {
      return [];
    }),
    (Jg.binding = function (e) {
  ...
  !(function () {
    ...
    var o = !n && "object" == typeof self,
      i =
        ...
        sm.versions.node;
    i ? (r = e) : o && (r = self);
    var a = !r.JS_SHA256_NO_COMMON_JS && Yg,
    ...
    (_.sha256 = _),
      ...
      (_.sha256.hmac = b()),
      (_.sha224.hmac = b(!0)),
      a ? (Yg = _) : ((r.sha256 = _.sha256), (r.sha224 = _.sha224));
  })();
  var lm = t(Yg);
  class um {
    constructor(e = {}) {
    ...
    send(
      ...
      if (this.options.by && this.options.secret) {
        const e = this.options.by,
          t = N.generate(),
          r = um._hash(this.options.secret, t);
      ...
      return (
        ...
        fetch(e, { body: r, method: o, headers: i }).then(um._toJson)
      );
    }
    _inject(e, t) {
      if (!t) return e;
  ...
  ******************************************************************************/ function fm(
  ...
  function km(e) {
    return "undefined" != typeof Event && Cm(e, Event);
  }
  function Dm(e) {
    return "undefined" != typeof Element && Cm(e, Element);
  }
  function Em(e) {
  ...
  r(vm, "isError", function () {
    return bm;
  }),
    r(vm, "isErrorEvent", function () {
      return ym;
    }),
    r(vm, "isDOMError", function () {
      return wm;
    }),
    r(vm, "isDOMException", function () {
      return _m;
    }),
    r(vm, "isString", function () {
      return Sm;
    }),
    r(vm, "isPrimitive", function () {
      return xm;
    }),
    r(vm, "isPlainObject", function () {
      return Pm;
    }),
    r(vm, "isEvent", function () {
      return km;
    }),
    r(vm, "isElement", function () {
      return Dm;
    }),
    r(vm, "isRegExp", function () {
      return Em;
    }),
    r(vm, "isThenable", function () {
      return Tm;
    }),
    r(vm, "isSyntheticEvent", function () {
      return Im;
    }),
    r(vm, "isInstanceOf", function () {
      return Cm;
    }),
    ...
    Um = (function () {
      ...
      return (
        ...
        (e.prototype._fromString = function (e) {
          var t = Rm.exec(e);
          if (!t) throw new Mm(Nm);
          var n = gm(t.slice(1), 6),
            r = n[0],
            o = n[1],
            i = n[2],
            a = void 0 === i ? "" : i,
        ...
        (e.prototype._validate = function () {
          ...
          if (
            (["protocol", "user", "host", "projectId"].forEach(function (t) {
              if (!e[t]) throw new Mm("Invalid Dsn: " + t + " missing");
            }),
            !this.projectId.match(/^\d+$/))
          )
            throw new Mm("Invalid Dsn: Invalid projectId " + this.projectId);
          if ("http" !== this.protocol && "https" !== this.protocol)
            throw new Mm("Invalid Dsn: Invalid protocol " + this.protocol);
          if (this.port && isNaN(parseInt(this.port, 10)))
            throw new Mm("Invalid Dsn: Invalid port " + this.port);
        }),
        e
      );
    })();
  ...
  function Hm(e) {
    try {
      return (e && "function" == typeof e && e.name) || Vm;
    } catch (e) {
      return Vm;
    }
  }
  ...
  function Wm(e, t) {
    return (
      !!Sm(e) &&
      (Em(t) ? t.test(e) : "string" == typeof t && -1 !== e.indexOf(t))
    );
  }
  function Ym(e, t, n) {
    if (t in e) {
  ...
  function ev(e, t, n, r) {
    if ((void 0 === n && (n = 1 / 0), void 0 === r && (r = new Lm()), 0 === n))
      return (function (e) {
  ...
  function nv(e, t) {
    ...
    if (n[0].length >= t) return zm(n[0], t);
    for (var r = n.length; r > 0; r--) {
      var o = n.slice(0, r).join(", ");
      if (!(o.length > t)) return r === n.length ? o : zm(o, t);
    }
    return "";
  }
  r(qm, "truncate", function () {
    return zm;
  }),
    r(qm, "snipLine", function () {
      return Gm;
    }),
    r(qm, "safeJoin", function () {
      return $m;
    }),
    r(qm, "isMatchingPattern", function () {
      return Wm;
    }),
    r(jm, "fill", function () {
      return Ym;
          ...
          n.forEach(function (n) {
            switch (n) {
              ...
              case "data":
                ...
                void 0 !== e.body &&
                  (r.data = Sm(e.body) ? e.body : JSON.stringify(tv(e.body)));
                break;
              default:
    ...
    gv = (function () {
      ...
      return (
        ...
        (e.prototype.log = function () {
          ...
          this._enabled &&
            uv(function () {
              hv.console.log("Sentry Logger [Log]: " + e.join(" "));
            });
        }),
        (e.prototype.warn = function () {
          ...
          this._enabled &&
            uv(function () {
              hv.console.warn("Sentry Logger [Warn]: " + e.join(" "));
            });
        }),
        (e.prototype.error = function () {
          ...
          this._enabled &&
            uv(function () {
              hv.console.error("Sentry Logger [Error]: " + e.join(" "));
            });
        }),
        e
      );
    })();
  hv.__SENTRY__ = hv.__SENTRY__ || {};
  var mv = hv.__SENTRY__.logger || (hv.__SENTRY__.logger = new gv());
  r({}, "logger", function () {
    return mv;
  });
  var vv = {};
  function bv() {
    if (!("fetch" in iv())) return !1;
    try {
  ...
  r(vv, "supportsFetch", function () {
    return bv;
  }),
    r(vv, "supportsNativeFetch", function () {
      return wv;
    }),
    r(vv, "supportsReferrerPolicy", function () {
      return _v;
    }),
    r(vv, "supportsHistory", function () {
      return Sv;
    });
  var xv,
    Pv = iv(),
    ...
    if (!Dv[e])
      switch (((Dv[e] = !0), e)) {
        case "console":
          !(function () {
            ...
            ["debug", "info", "warn", "error", "log", "assert"].forEach(
              function (e) {
                e in Pv.console &&
                  Ym(Pv.console, e, function (t) {
                    return function () {
                      for (var n = [], r = 0; r < arguments.length; r++)
                        n[r] = arguments[r];
                      Iv("console", { args: n, level: e }),
            ...
            Pv.document.addEventListener(
              ...
              ["EventTarget", "Node"].forEach(function (e) {
                ...
                t &&
                  ...
                  (Ym(t, "addEventListener", function (e) {
                    return function (t, n, r) {
                      return (
                        n && n.handleEvent
                          ? ("click" === t &&
                              Ym(n, "handleEvent", function (e) {
                                return function (t) {
                                  return (
                                    Rv("click", Iv.bind(null, "dom"))(t),
                                    e.call(this, t)
                                  );
                                };
                              }),
                            "keypress" === t &&
                              Ym(n, "handleEvent", function (e) {
                                return function (t) {
                                  return (
                                    Nv(Iv.bind(null, "dom"))(t), e.call(this, t)
                                  );
                                };
                              }))
                          : ("click" === t &&
                              Rv("click", Iv.bind(null, "dom"), !0)(this),
                            "keypress" === t && Nv(Iv.bind(null, "dom"))(this)),
                        e.call(this, t, n, r)
                      );
                    };
                  }),
                  Ym(t, "removeEventListener", function (e) {
                    return function (t, n, r) {
                      try {
            ...
            Ym(n, "open", function (n) {
              return function () {
                ...
                var i = this,
                  a = r[1];
                (i.__sentry_xhr__ = {
                  method: Sm(r[0]) ? r[0].toUpperCase() : r[0],
                  url: r[1],
                }),
                  Sm(a) &&
                ...
                return (
                  ...
                  "function" == typeof i.onreadystatechange
                    ? Ym(i, "onreadystatechange", function (e) {
                        return function () {
        ...
        case "fetch":
          !(function () {
            if (!wv()) return;
            Ym(Pv, "fetch", function (e) {
              return function () {
                for (var t = [], n = 0; n < arguments.length; n++)
                  t[n] = arguments[n];
                var r = {
                  args: t,
                  fetchData: { method: Cv(t), url: Fv(t) },
                  startTimestamp: Date.now(),
                };
                return (
                  Iv("fetch", pm({}, r)),
                  e.apply(Pv, t).then(
                    ...
                    function (e) {
                      throw (
                        (Iv(
                          "fetch",
                          pm(pm({}, r), { endTimestamp: Date.now(), error: e })
                        ),
                        e)
                      );
                    }
          ...
          !(function () {
            ...
            (Pv.onpopstate = function () {
              ...
              var r = Pv.location.href,
                o = xv;
              if (((xv = r), Iv("history", { from: o, to: r }), e))
                return e.apply(this, t);
            }),
              Ym(Pv.history, "pushState", t),
              Ym(Pv.history, "replaceState", t);
          })();
          break;
        case "error":
          (Uv = Pv.onerror),
            (Pv.onerror = function (e, t, n, r, o) {
              return (
                Iv("error", { column: r, error: o, line: n, msg: e, url: t }),
                !!Uv && Uv.apply(this, arguments)
              );
            });
          break;
        case "unhandledrejection":
          (Bv = Pv.onunhandledrejection),
            (Pv.onunhandledrejection = function (e) {
              return (
                Iv("unhandledrejection", e), !Bv || Bv.apply(this, arguments)
              );
            });
          break;
        default:
          mv.warn("unknown instrumentation type:", e);
      }
  }
  function Tv(e) {
    e &&
  ...
  function Iv(e, t) {
    ...
    if (e && kv[e])
      try {
        for (var o = hm(kv[e] || []), i = o.next(); !i.done; i = o.next()) {
          var a = i.value;
          try {
            a(t);
          } catch (t) {
  ...
  function Cv(e) {
    return (
      void 0 === e && (e = []),
      "Request" in Pv && Cm(e[0], Request) && e[0].method
      ...
      (e.prototype.add = function (e) {
        ...
        return this.isReady()
          ? (-1 === this._buffer.indexOf(e) && this._buffer.push(e),
            ...
            e)
          : Vv.reject(
              new Mm("Not adding Promise due to buffer limit reached.")
            );
      }),
  ...
  var qv = function () {
      ...
      var o = rv.isNodeEnv()
          ? (function () {
              try {
                return rv.dynamicRequire(t, "perf_hooks").performance;
              } catch (e) {
                return;
              }
            })()
          : (function () {
              var e = iv().performance;
              if (e && e.now)
                return {
                  now: function () {
                    return e.now();
    ...
    zv = (function () {
      ...
      return (
        (e.clone = function (t) {
          ...
          return (
            t &&
              ((n._breadcrumbs = mm(t._breadcrumbs)),
              (n._tags = pm({}, t._tags)),
              (n._extra = pm({}, t._extra)),
              (n._contexts = pm({}, t._contexts)),
              (n._user = t._user),
              (n._level = t._level),
              (n._span = t._span),
              (n._transactionName = t._transactionName),
              (n._fingerprint = t._fingerprint),
              (n._eventProcessors = mm(t._eventProcessors))),
            n
          );
        }),
        ...
        (e.prototype.setTag = function (e, t) {
          var n;
          return (
            (this._tags = pm(pm({}, this._tags), (((n = {})[e] = t), n))),
            this._notifyScopeListeners(),
            this
          );
        }),
        (e.prototype.setExtras = function (e) {
          return (
            (this._extra = pm(pm({}, this._extra), e)),
            this._notifyScopeListeners(),
            this
          );
        }),
        (e.prototype.setExtra = function (e, t) {
          var n;
          return (
            (this._extra = pm(pm({}, this._extra), (((n = {})[e] = t), n))),
            this._notifyScopeListeners(),
            this
          );
        }),
        ...
        (e.prototype.update = function (t) {
          ...
          return (
            t instanceof e
              ? ((this._tags = pm(pm({}, this._tags), t._tags)),
                (this._extra = pm(pm({}, this._extra), t._extra)),
                (this._contexts = pm(pm({}, this._contexts), t._contexts)),
                t._user && (this._user = t._user),
                t._level && (this._level = t._level),
                t._fingerprint && (this._fingerprint = t._fingerprint))
              : Pm(t) &&
                ((t = t),
                (this._tags = pm(pm({}, this._tags), t.tags)),
                (this._extra = pm(pm({}, this._extra), t.extra)),
                (this._contexts = pm(pm({}, this._contexts), t.contexts)),
        ...
        (e.prototype.addBreadcrumb = function (e, t) {
          var n = pm({ timestamp: qv.dateTimestampInSeconds() }, e);
          return (
            (this._breadcrumbs =
              void 0 !== t && t >= 0
                ? mm(this._breadcrumbs, [n]).slice(-t)
                : mm(this._breadcrumbs, [n])),
            this._notifyScopeListeners(),
            this
          );
        }),
        ...
        (e.prototype.applyToEvent = function (e, t) {
          return (
            this._extra &&
              ...
              (e.extra = pm(pm({}, this._extra), e.extra)),
            this._tags &&
              Object.keys(this._tags).length &&
              (e.tags = pm(pm({}, this._tags), e.tags)),
            this._user &&
              Object.keys(this._user).length &&
              (e.user = pm(pm({}, this._user), e.user)),
            this._contexts &&
              Object.keys(this._contexts).length &&
              (e.contexts = pm(pm({}, this._contexts), e.contexts)),
            ...
            (e.breadcrumbs = mm(e.breadcrumbs || [], this._breadcrumbs)),
            (e.breadcrumbs = e.breadcrumbs.length > 0 ? e.breadcrumbs : void 0),
            this._notifyEventProcessors(mm(Gv(), this._eventProcessors), e, t)
          );
        }),
  ...
  var Wv = (function () {
    ...
    return (
      ...
      (e.prototype.captureEvent = function (e, t) {
        var n = (this._lastEventId = av());
        return (
          this._invokeClient("captureEvent", e, pm(pm({}, t), { event_id: n })),
          n
        );
      }),
      ...
      (e.prototype.addBreadcrumb = function (e, t) {
        ...
        if (n.scope && n.client) {
          var r = (n.client.getOptions && n.client.getOptions()) || {},
            ...
            s = void 0 === a ? 100 : a;
          if (!(s <= 0)) {
            var l = qv.dateTimestampInSeconds(),
              u = pm({ timestamp: l }, e),
              c = i
                ? uv(function () {
                    return i(u, t);
      ...
      (e.prototype._invokeClient = function (e) {
        ...
        o &&
          o.client &&
          o.client[e] &&
          (t = o.client)[e].apply(t, mm(n, [o.scope]));
      }),
      (e.prototype._callExtensionMethod = function (e) {
        ...
        mv.warn("Extension method " + e + " couldn't be found, doing nothing.");
      }),
      e
    );
  })();
  ...
  function Qv() {
    var e = Yv();
    return (
      (Kv(e) && !Xv(e).isOlderThan(3)) || Zv(e, new Wv()),
      rv.isNodeEnv()
        ? (function (e) {
            try {
              var t =
              ...
              if (!t) return Xv(e);
              if (!Kv(t) || Xv(t).isOlderThan(3)) {
                var n = Xv(e).getStackTop();
                Zv(t, new Wv(n.client, zv.clone(n.scope)));
              }
              return Xv(t);
            } catch (t) {
              return Xv(e);
  ...
  function eb(e) {
    ...
    var r = Qv();
    if (r && r[e]) return r[e].apply(r, mm(t));
    throw new Error(
      "No hub defined or " +
        e +
  ...
  var rb = (function () {
      function e(e) {
        (this.dsn = e), (this._dsnObject = new Um(e));
      }
      return (
        ...
        (e.prototype._encodedAuth = function () {
          return Jm({ sentry_key: this._dsnObject.user, sentry_version: "7" });
        }),
        e
      );
    })(),
  ...
  function ib(e) {
    ...
    return (
      (function (e) {
        var t = (e.defaultIntegrations && mm(e.defaultIntegrations)) || [],
          n = e.integrations,
          r = [];
        if (Array.isArray(n)) {
        ...
        var a = r.map(function (e) {
          ...
          s = "Debug";
        return (
          -1 !== a.indexOf(s) && r.push.apply(r, mm(r.splice(a.indexOf(s), 1))),
          r
        );
      })(e).forEach(function (e) {
        (t[e.name] = e),
          (function (e) {
            -1 === ob.indexOf(e.name) &&
              (e.setupOnce($v, Qv),
              ob.push(e.name),
              mv.log("Integration installed: " + e.name));
          })(e);
      }),
      t
    );
    ...
    cb = (function () {
      ...
      return (
        ...
        (e.prototype.setupIntegrations = function () {
          this._isEnabled() && (this._integrations = ib(this._options));
        }),
        (e.prototype.getIntegration = function (e) {
          try {
        ...
        (e.prototype._prepareEvent = function (e, t, n) {
          var r = this,
            ...
            i = void 0 === o ? 3 : o,
            a = pm(pm({}, e), {
              event_id: e.event_id || (n && n.event_id ? n.event_id : av()),
              timestamp: e.timestamp || qv.dateTimestampInSeconds(),
            });
          this._applyClientOptions(a), this._applyIntegrationsMetadata(a);
          var s = t;
          n && n.captureContext && (s = zv.clone(s).update(n.captureContext));
          var l = Vv.resolve(a);
          return (
                ...
                pm(
                  ...
                  e.breadcrumbs && {
                    breadcrumbs: e.breadcrumbs.map(function (e) {
                      return pm(pm({}, e), e.data && { data: tv(e.data, t) });
                    }),
                  }
                ),
                e.user && { user: tv(e.user, t) }
              ),
              e.contexts && { contexts: tv(e.contexts, t) }
            ),
            e.extra && { extra: tv(e.extra, t) }
          );
          return (
            e.contexts &&
              e.contexts.trace &&
        ...
        (e.prototype._applyClientOptions = function (e) {
          ...
          void 0 === e.environment && void 0 !== n && (e.environment = n),
            ...
            e.message && (e.message = zm(e.message, a));
          var s = e.exception && e.exception.values && e.exception.values[0];
          s && s.value && (s.value = zm(s.value, a));
          var l = e.request;
          l && l.url && (l.url = zm(l.url, a));
        }),
        ...
        (e.prototype._processEvent = function (e, t, n) {
          var r = this,
            ...
            a = o.sampleRate;
          if (!this._isEnabled())
            return Vv.reject("SDK not enabled, will not send event.");
          var s = "transaction" === e.type;
          return !s && "number" == typeof a && Math.random() > a
            ? Vv.reject("This event has been sampled, will not send event.")
            : new Vv(function (o, a) {
                r._prepareEvent(e, n, t)
                  .then(function (e) {
                    if (null !== e) {
                      ...
                      else if (Tm(l)) r._handleAsyncBeforeSend(l, o, a);
                      else {
                        if (null === (n = l))
                          return (
                            mv.log(
  ...
  var db = (function () {
    ...
    fb = (function () {
      function e(e) {
        (this._options = e),
          this._options.dsn ||
            mv.warn("No DSN provided, backend will not do anything."),
          (this._transport = this._setupTransport());
      }
      return (
        (e.prototype.eventFromException = function (e, t) {
          throw new Mm("Backend has to implement `eventFromException` method");
        }),
        (e.prototype.eventFromMessage = function (e, t, n) {
          throw new Mm("Backend has to implement `eventFromMessage` method");
        }),
        (e.prototype.sendEvent = function (e) {
          this._transport.sendEvent(e).then(null, function (e) {
            mv.error("Error while sending event: " + e);
          });
        }),
  ...
  var hb,
    ...
    vb = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/],
    bb = (function () {
      function e(t) {
      ...
      return (
        ...
        (e.prototype._getPossibleEventMessages = function (e) {
          ...
          if (e.exception)
            try {
              ...
              return mv.error("Cannot extract message for event " + lv(e)), [];
            }
          return [];
        }),
        (e.prototype._getEventFilterUrl = function (e) {
          try {
            ...
            return mv.error("Cannot extract url for event " + lv(e)), null;
          }
        }),
        (e.id = "InboundFilters"),
        e
  ...
  r(gb, "FunctionToString", function () {
    return mb;
  }),
    r(gb, "InboundFilters", function () {
      return bb;
    });
  var yb = "?",
    wb =
    ...
    xb = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
    Pb = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    kb = /Minified React error #\d+;/i;
  function Db(e) {
    var t = null,
      n = 0;
    e &&
        ...
        (t = (function (e) {
          ...
          for (
            ...
            (t = r.exec(i[s]))
              ...
              l && (!l.func && l.line && (l.func = yb), a.push(l));
          }
          if (!a.length) return null;
          return { message: Tb(e), name: e.name, stack: a };
        })(e))
      )
        return Eb(t, n);
    } catch (e) {}
        ...
        (t = (function (e) {
          ...
          for (
            ...
            if ((n = wb.exec(i[a]))) {
              ...
              if (!(n = _b.exec(i[a]))) continue;
              n[3] && n[3].indexOf(" > eval") > -1 && (t = xb.exec(n[3]))
                ? ((n[1] = n[1] || "eval"),
                  (n[3] = t[1]),
                  (n[4] = t[2]),
                  (n[5] = ""))
            ...
            !r.func && r.line && (r.func = yb), o.push(r);
          }
          if (!o.length) return null;
          return { message: Tb(e), name: e.name, stack: o };
        })(e))
      )
        return Eb(t, n);
    } catch (e) {}
    return { message: Tb(e), name: e && e.name, stack: [], failed: !0 };
  }
  function Eb(e, t) {
    try {
      return pm(pm({}, e), { stack: e.stack.slice(t) });
    } catch (t) {
      return e;
    }
  }
  ...
  function Ab(e, t, n) {
    var r;
    if ((void 0 === n && (n = {}), ym(e) && e.error))
      return (r = Cb(Db((e = e.error))));
    if (wm(e) || _m(e)) {
      var o = e,
        i = o.name || (wm(o) ? "DOMError" : "DOMException"),
        a = o.message ? i + ": " + o.message : i;
      return cv((r = Ob(a, t, n)), a), r;
    }
    return bm(e)
      ? (r = Cb(Db(e)))
      : Pm(e) || km(e)
      ? (dv(
        ...
        r)
      : (cv((r = Ob(e, t, n)), "" + e, void 0), dv(r, { synthetic: !0 }), r);
  }
  function Ob(e, t, n) {
    void 0 === n && (n = {});
    var r = { message: e };
  ...
  var Mb = {},
    Rb = (function () {
      function e(e) {
        (this.options = e),
          (this._buffer = new Hv(30)),
          (this._api = new rb(this.options.dsn)),
          (this.url = this._api.getStoreEndpointWithUrlEncodedAuth());
      }
      return (
        (e.prototype.sendEvent = function (e) {
          throw new Mm("Transport Class has to implement `sendEvent` method");
        }),
        (e.prototype.close = function (e) {
    ...
    Ub = (function (e) {
      ...
      return (
        ...
        (t.prototype.sendEvent = function (e) {
          ...
          var n = pb(e, this._api),
            r = {
              body: n.body,
              method: "POST",
              referrerPolicy: _v() ? "origin" : "",
            };
          return (
            ...
            this._buffer.add(
              new Vv(function (e, o) {
                Nb.fetch(n.url, r)
                  .then(function (n) {
                    var r = lb.fromHttpCode(n.status);
                    if (r !== lb.Success) {
                      if (r === lb.RateLimit) {
                        var i = Date.now(),
                          a = n.headers.get("Retry-After");
                        (t._disabledUntil = new Date(i + pv(i, a))),
                          mv.warn(
          ...
          return this._buffer.add(
            new Vv(function (e, r) {
              ...
              for (var i in ((o.onreadystatechange = function () {
                if (4 === o.readyState) {
                  var n = lb.fromHttpCode(o.status);
                  if (n !== lb.Success) {
                    if (n === lb.RateLimit) {
                      var i = Date.now(),
  ...
  r(Mb, "BaseTransport", function () {
    return Rb;
  }),
    r(Mb, "FetchTransport", function () {
      return Ub;
    }),
    r(Mb, "XHRTransport", function () {
      return Bb;
    });
  var jb = (function (e) {
      function t() {
      ...
      return (
        ...
        (t.prototype.eventFromException = function (e, t) {
          return (function (e, t, n) {
            var r = Ab(t, (n && n.syntheticException) || void 0, {
              attachStacktrace: e.attachStacktrace,
            });
            return (
              dv(r, { handled: !0, type: "generic" }),
              (r.level = ab.Error),
        ...
        (t.prototype.eventFromMessage = function (e, t, n) {
          return (
            ...
            (function (e, t, n, r) {
              void 0 === n && (n = ab.Info);
              var o = Ob(t, (r && r.syntheticException) || void 0, {
                attachStacktrace: e.attachStacktrace,
              });
              return (
                (o.level = n),
        ...
        (t.prototype._setupTransport = function () {
          ...
          var t = pm(pm({}, this._options.transportOptions), {
        ...
        throw (
          ...
          nb(function (n) {
            n.addEventProcessor(function (e) {
              var n = pm({}, e);
              return (
                t.mechanism && (cv(n, void 0, void 0), dv(n, t.mechanism)),
                (n.extra = pm(pm({}, n.extra), { arguments: r })),
                n
              );
            }),
              tb(e);
  ...
  function zb(e) {
    if ((void 0 === e && (e = {}), e.eventId))
      if (e.dsn) {
        ...
        (t.async = !0),
          (t.src = new rb(e.dsn).getReportDialogEndpoint(e)),
          e.onLoad && (t.onload = e.onLoad),
          (document.head || document.body).appendChild(t);
      } else mv.error("Missing dsn option in showReportDialog call");
    else mv.error("Missing eventId option in showReportDialog call");
  }
  var Gb = {},
    $b = (function () {
      function e(t) {
        (this.name = e.id),
          ...
          (this._options = pm({ onerror: !0, onunhandledrejection: !0 }, t));
      }
      return (
        (e.prototype.setupOnce = function () {
          (Error.stackTraceLimit = 50),
            this._options.onerror &&
              (mv.log("Global Handler attached: onerror"),
              this._installGlobalOnErrorHandler()),
            this._options.onunhandledrejection &&
              (mv.log("Global Handler attached: onunhandledrejection"),
          ...
          this._onUnhandledRejectionHandlerInstalled ||
            (Tv({
              callback: function (n) {
                ...
                (l.level = ab.Error),
                  dv(l, { handled: !1, type: "onunhandledrejection" }),
                  o.captureEvent(l, { originalException: r });
              },
      ...
      return (
        (e.prototype.setupOnce = function () {
          ...
          (this._options.setTimeout &&
            Ym(e, "setTimeout", this._wrapTimeFunction.bind(this)),
          this._options.setInterval &&
            Ym(e, "setInterval", this._wrapTimeFunction.bind(this)),
          this._options.requestAnimationFrame &&
            Ym(e, "requestAnimationFrame", this._wrapRAF.bind(this)),
          this._options.XMLHttpRequest &&
            "XMLHttpRequest" in e &&
            Ym(XMLHttpRequest.prototype, "send", this._wrapXHR.bind(this)),
        ...
        (e.prototype._wrapRAF = function (e) {
          return function (t) {
            return e.call(
              ...
              qb(t, {
                mechanism: {
                  data: { function: "requestAnimationFrame", handler: Hm(e) },
                  handled: !0,
                  type: "instrument",
                },
              })
        ...
        (e.prototype._wrapEventTarget = function (e) {
          ...
          n &&
            ...
            (Ym(n, "addEventListener", function (t) {
              return function (n, r, o) {
                try {
                  "function" == typeof r.handleEvent &&
                    (r.handleEvent = qb(r.handleEvent.bind(r), {
                      mechanism: {
                        data: {
            ...
            Ym(n, "removeEventListener", function (e) {
              return function (t, n, r) {
                try {
                  e.call(this, t, n.__sentry_wrapped__, r);
                } catch (e) {}
                  ...
                  Ym(r, e, function (t) {
                    ...
                    return (
                      t.__sentry_original__ &&
                        (n.mechanism.data.handler = Hm(t.__sentry_original__)),
                      qb(t, n)
                    );
                  });
              }),
      ...
      return (
          ...
          this._options.console &&
            Tv({
              callback: function () {
                for (var t = [], n = 0; n < arguments.length; n++)
                  t[n] = arguments[n];
                e._consoleBreadcrumb.apply(e, mm(t));
              },
              type: "console",
            }),
            this._options.dom &&
            ...
            this._options.fetch &&
              Tv({
                callback: function () {
                  for (var t = [], n = 0; n < arguments.length; n++)
                    t[n] = arguments[n];
                  e._fetchBreadcrumb.apply(e, mm(t));
                },
                type: "fetch",
              }),
            this._options.history &&
              Tv({
                callback: function () {
                  for (var t = [], n = 0; n < arguments.length; n++)
                    t[n] = arguments[n];
                  e._historyBreadcrumb.apply(e, mm(t));
                },
                type: "history",
              });
        }),
        (e.prototype._consoleBreadcrumb = function (e) {
          ...
          if ("assert" === e.level) {
            ...
            (t.message =
              "Assertion failed: " +
              ($m(e.args.slice(1), " ") || "console.assert")),
        ...
        (e.prototype._handler = function (e, t) {
          if (
            !(
              ...
              e.exception.values &&
              t &&
              Cm(t.originalException, Error)
            )
          )
            return e;
          var n = this._walkErrorTree(t.originalException, this._key);
          return (e.exception.values = mm(n, e.exception.values)), e;
        }),
        (e.prototype._walkErrorTree = function (e, t, n) {
          if (
            (void 0 === n && (n = []),
            !Cm(e[t], Error) || n.length + 1 >= this._limit)
          )
            return n;
          var r = Ib(Db(e[t]));
          return this._walkErrorTree(e[t], t, mm([r], n));
        }),
        (e.id = "LinkedErrors"),
        e
      );
        ...
        (e.prototype.setupOnce = function () {
          $v(function (t) {
            ...
            if (Qv().getIntegration(e)) {
              if (!Kb.navigator && !Kb.location && !Kb.document) return t;
              var i =
                  (null === (n = t.request) || void 0 === n ? void 0 : n.url) ||
                  (null === (r = Kb.location) || void 0 === r
                    ? void 0
                    : r.href),
                a = (Kb.document || {}).referrer,
                s = (Kb.navigator || {}).userAgent,
                l = pm(
                  pm(
                    pm(
                      {},
                ...
                u = pm(pm({}, i && { url: i }), { headers: l });
              return pm(pm({}, t), { request: u });
            }
            return t;
          });
        }),
  ...
  r(Gb, "GlobalHandlers", function () {
    return $b;
  }),
    r(Gb, "TryCatch", function () {
      return Yb;
    }),
    r(Gb, "Breadcrumbs", function () {
      return Jb;
    }),
    r(Gb, "LinkedErrors", function () {
      return Qb;
    }),
    r(Gb, "UserAgent", function () {
      return Xb;
    });
  var Zb = "5.25.0",
    ey = (function (e) {
      ...
      return (
        ...
        (t.prototype.showReportDialog = function (e) {
          void 0 === e && (e = {}),
            iv().document &&
              (this._isEnabled()
                ? zb(pm(pm({}, e), { dsn: e.dsn || this.getDsn() }))
                : mv.error(
        ...
        (t.prototype._prepareEvent = function (t, n, r) {
          return (
            ...
            (t.sdk = pm(pm({}, t.sdk), {
              ...
              packages: mm((t.sdk && t.sdk.packages) || [], [
                { name: "npm:@sentry/browser", version: Zb },
              ]),
              version: Zb,
            })),
    ...
    ty = [
      new gb.InboundFilters(),
      new gb.FunctionToString(),
      new Yb(),
      new Jb(),
      new $b(),
      new Qb(),
  ...
  function ny(e) {
    if (
      (void 0 === e && (e = {}),
      void 0 === e.defaultIntegrations && (e.defaultIntegrations = ty),
      void 0 === e.release)
    ) {
      var t = iv();
      t.SENTRY_RELEASE &&
        ...
        u.is.development ||
          (ny({
            ...
            beforeSend: (e, t) => {
              ...
              if (ry.store && ry.state) {
                let t = { ...ry.state, authStatus: { ...ry.state.authStatus } };
                delete t.authStatus.cookies,
                  (t = JSON.stringify(t)),
                  (t =
                    t.length > 102400 ? t.substr(0, 102400) + "..." : ry.state),
                  (e.extra = { ...(e.extra || {}), state: t });
              }
              const n = t.originalException,
                r = (n && n.message) || String(n);
              return r && oy.some((e) => r.includes(e)) ? null : e;
            },
          }),
          ...
          eb("configureScope", (o) => {
            if (
              ...
              ry.store &&
                ry.state &&
                ry.state.authStatus &&
                o.setUser({ username: ry.state.authStatus.username }),
              n)
            )
              for (const e in n) {
                let t = n[e];
  ...
  new cm.Sender({ urlPrefix: u.options.apiUrl });
  var ay = zg;
  const { model: sy } = _g,
    ly = {
      ...ay,
      isAcknowledged: function (e) {
        return -1 !== sy.state.acknowledged[e];
      },
      userId: function () {
        return sy.state.authStatus.userId;
      },
      username: function () {
        return sy.state.authStatus.username;
      },
    ...
    { action: uy } = _g;
  var cy = uy("state.replace-state", (e, t) => t);
  const { action: dy } = _g;
  var fy = dy("state.acknowledge", (e, t) => {
    ...
    my = () => ({
      ...
      zen: { enabled: !1 },
      quickReplies: { shown: !1, content: gy(), total: 7 },
      tagAssist: {
        shown: !1,
        query: "",
  ...
  var vy = {
      ...
      replaceState: cy,
      getWhatsNewItems: py,
      getTemplateUserState: hy,
      getTemplateSharedState: my,
      actions: { acknowledge: fy },
    },
    by = {
  ...
  var _y = { controller: by };
  function Sy(e, t, { once: n = !1 } = {}) {
  ...
  var Py = {},
    ...
    Ey = {
      isError: function (e, t = null) {
        return e && e[Ty] && (!t || e.code === t);
      },
      checkAuth: Fy(async function e(t = !0) {
        let n;
        try {
          Cg.ignoreCache(),
            (n = await Cg.fetch(
      ...
      fcsDeletePost: Fy(async function (e) {
        await Cy({
          url: R.createUrl(
      ...
      fcsSaveAsDraft: Fy(async function (e, { caption: t = null } = {}) {
        await Cy({
          url: R.createUrl(
      ...
      fcsSaveAsScheduled: Fy(async function (e, t, { caption: n = null } = {}) {
        await Cy({
          url: R.createUrl(
            "https://business.facebook.com/media/manager/instagram_media/edit/save/",
            {
      ...
      fcsSaveAsPublished: Fy(async function (e, { caption: t = null } = {}) {
        await Cy({
          url: R.createUrl(
            "https://business.facebook.com/media/manager/instagram_media/edit/save/",
            {
  ...
  const Ty = Symbol("isFbApiError");
  function Iy(e = {}) {
    return { ...e, [Ty]: !0 };
  }
  async function Cy({ url: e, incognito: t = !1, body: n = {} }) {
    var r;
    Cg.ignoreCache();
    const o =
        (null ===
    ...
    const n = async (...n) => {
      try {
        ...
        throw (
          ...
          Iy({ code: Dy, method: t, details: e }))
        );
      }
    };
    return (
      Vg.on(`fb-api.${t}`, async (...e) => {
        let t, r;
        try {
          t = await n(...e);
        } catch (e) {
  ...
  var Ay = { api: Ey },
    Oy = {};
  const { model: My, transaction: Ry } = _g;
  var Ny = {
    init: function () {
      Vg.on("schedule.connect-to-fcs", Uy),
        Vg.on("schedule.drop-fb-xs-cookie", Vy);
    },
  };
  async function Uy({ skipFbLogin: e = !1 } = {}) {
    if (My.state.schedule.fcsSetup.connecting) return;
    Ry((e) => {
    ...
    if (!e) {
      let e;
      try {
        e = await Ay.api.checkAuth();
      } catch (e) {
        return (
          console.error("[fcs setup] failed to check fb auth", e),
          By({ fbLogin: "failed" }),
          void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
        );
      }
      if (!e)
        return (
    ...
    By({ fbLogin: e ? "skipped" : "ok", igProfessional: "loading" }),
      await R.sleep(1e3),
      Cg.ignoreCache();
    const t = (await Rg.api.fetchViewerInfo()).result;
    if (!t)
      return (
        By({ igProfessional: "failed" }),
        void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
      );
    if (!t.isProfessionalAccount)
      return (
        By({ igProfessional: "nok" }),
        void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
      );
    ...
    if (
      ((n = e
        ? await Vg.send("iframe-bus", "schedule.connect-via-ig")
        : await Vg.send("iframe-bus", "schedule.connect-via-fb")),
      n.error)
    )
      return (
        e && Vy(),
        "not-connected-to-fb-page" === n.error
          ...
          ? (By({ igConnectedToFbPage: "failed" }), Oy.controller.refreshUser())
          : (console.error("[fcs setup]", n.error),
            By({ igConnectedToFbPage: "failed" }, n.error)),
        void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
      );
    if (e) {
      ...
      if (!e)
        return (
          Vy(),
          By({ igConnectedToFbPage: "failed" }, "failed-to-skip-fb-login"),
          void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
        );
    }
    try {
      await Oy.controller.refreshUser();
    } catch (e) {
      return (
        console.error("[fcs setup] failed to refresh user", e),
        By({ igConnectedToFbPage: "failed" }, "failed-to-refresh-user"),
        void Ry((e) => (e.schedule.fcsSetup.connecting = !1))
      );
    }
    By({ igConnectedToFbPage: "ok" }),
      ...
      Vg.send("iframe-bus", "schedule.fcs-refresh-page"),
      Py.controller.sendEvent("user", "schedule:setup-connection-success");
  }
  function By(e = {}, t = null) {
    for (const n in e)
      if ("failed" === e[n]) {
        const e = t ? `${n}_${t}` : n;
        Py.controller.sendEvent("user", "schedule:setup-connection-error", e);
        break;
      }
    Ry((t) => {
      ...
      new Promise((e) => {
        Vg.on(
          ...
          function t({ fcsConnected: n }) {
            Vg.off("schedule.fcs-connection-status", t), e({ fcsConnected: n });
          }
        );
      })
    );
    ...
    init: function () {
      !(function () {
        ...
        Vg.on("schedule.upload-99", (t) => {
          ...
          Vg.on("schedule.upload-100", () => {
            clearTimeout(e);
          });
      })();
    },
  };
  const { model: qy, transaction: zy } = _g;
  async function Gy(e = !1) {
    const t = qy.state,
      ...
      controller: {
        init: function () {
          Ny.init(),
            Hy.init(),
            (async function () {
              Vg.on("popup.start", async () => {
                const e = [qy.state, ...Object.values(qy.state.userStates)],
                  t = e
                  ...
                  n = e
                    ...
                    .filter((e) => "local" === e.source)
                    .map((e) => e.id.toString()),
                  r = await _y.controller.getAllKeys();
                for (const e of r)
                  if (e.startsWith("schedule.fcs-post-preview:")) {
                    const n = e.split(":")[1];
                    if (t.includes(n)) continue;
                    await R.safe(() => _y.controller.delete(e));
            ...
            Vg.on("schedule.update-ig-posts", Gy),
            xy.on("schedule.update-ig-posts", Gy);
        },
        getReport: async function () {
          return await Vg.send("iframe-bus", "schedule.fcs-get-report");
        },
      },
  ...
  const { transaction: Yy } = _g;
  function Jy(e) {
    const t = vy.getTemplateUserState();
    Yy((n) => {
      var r;
      (n.cleanupId = e),
        (n.dm.badgeText = ""),
      ...
      i.length > 0 &&
        ...
        (n.later.date = null),
        (n.later.userId = null),
        (n.later.editPostId = null),
        (n.later.selectedPill = null),
        ...
        (n.schedule.dateDialog = $y.getDefaultDateDialogState(n)),
  ...
  var Qy = {
    ...
    Ky = {
      init: async function () {
        return void (await _y.controller.delete("image-proxy.cache"));
        (ew = (await _y.controller.get("image-proxy.cache")) || {}),
          Zy.resolve(),
          Vg.on("image-proxy.save", tw),
          Vg.on("image-proxy.cache-item-used", nw);
      },
      save: tw,
    };
  const Xy = 15 * R.time.SECOND,
    Zy = R.createResolvablePromise();
  let ew;
  async function tw(e) {}
  async function nw(e) {
    ew[e] && ((ew[e].lastUsedAt = Date.now()), rw());
  }
  function rw() {
    const e = rw;
    clearTimeout(e.timeout),
      (e.timeout = setTimeout(async () => {
        _y.controller.set("image-proxy.cache", ew);
      }, Xy));
  }
  var ow = { controller: Ky };
  function iw() {
    const e = [];
  ...
  var aw = {
    init: function () {
      (lw = -1),
        Vg.on("core-web-request.popup-tab-id", (e) => {
          sw = e;
        });
    },
    watch: function (e, t) {
  ...
  function cw(e) {
    return e.tabId === sw || e.tabId === lw;
  }
  var dw = { controller: aw };
  const fw = iw();
  let pw;
  function hw({
    details: e,
    ...
    if ((fw(arguments[0]), n && d("instagram.com") && s("x-inssist-cookies"))) {
      u("cookie");
    ...
    if (
      ...
      e && pw !== e.value && (pw = e.value);
    }
    if (n && d("instagram.com")) {
      !s("x-ig-www-claim") && pw && l("x-ig-www-claim", pw);
    }
    n &&
      o &&
      d("instagram.com") &&
  ...
  const { model: mw, transaction: vw } = _g;
  let bw = null,
    yw = !1;
  Oy.controller = {
    init: async function () {
      await this._setAuthStatusIfAbsent(),
        ...
        Vg.on("auth.set-ig-initial-url", this._setIgInitialUrl.bind(this)),
        Vg.on("auth.login", this._login.bind(this)),
        Vg.on("auth.logout", this._logout.bind(this));
    },
    updateUser: async function (e = !1) {
      log("auth-controller: updating user id...");
      const t = await this.refreshUser();
      t && (await Hg.actualizeCookies()),
    ...
    refreshUser: async function () {
      ...
      const r = n.result || null,
        o = r && mw.state.authStatus.userId === r.userId;
      return (
        r && ow.controller.save(r.avatarUrl),
        vw((e) => {
        ...
        o ||
          (Vg.send("iframe-bus", "ig.clear-and-show-spinner"),
          r
            ? bw
              ? Vg.send("iframe-bus", "ig.hard-go", bw)
              : (Qy.controller.cleanUpState(),
                Vg.send("iframe-bus", "ig.refresh"))
            : Vg.send("iframe-bus", "ig.hard-go", "/accounts/login/"),
          Vg.send("iframe-bus", "dm.refresh"),
          Vg.send("iframe-bus", "schedule.fcs-refresh-page")),
        (bw = null),
        Vg.send("auth.refreshed"),
        !!r
      );
    },
    ...
    _updateUserOnPopupStart: function () {
      ...
      Vg.on("popup.start", async () => {
        var t, n;
        const r = await R.callAsync(chrome.cookies.get, {
            url: "https://*.instagram.com",
            name: "sessionid",
          }),
          o =
            null === (t = mw.state.authStatus) ||
            void 0 === t ||
            null === (n = t.cookies) ||
            void 0 === n
              ? void 0
              : n.igSessionId,
          i = Date.now();
        (r && o === r.value && e && i - e <= 6 * R.time.HOUR) ||
    ...
    _setAuthStatusIfAbsent: async function () {
      if ("username" in mw.state.authStatus) return;
      Cg.ignoreCache();
    ...
    _watchAndSaveFbCookies: function () {
      let e;
      gw.controller.onRequest(({ details: n, isResponse: r, checkHost: o }) => {
        if (r && o("facebook.com")) {
    ...
    _login: async function (e) {
      var t;
      const n =
        null === (t = mw.state.userStates[e]) || void 0 === t
          ? void 0
          : t.authStatus;
      if (n) {
    ...
    _isSessionWatcherPaused: function () {
      return yw || mw.state.schedule.fcsSetup.connecting;
    },
    _actualizeCoookies: async function () {
      const e = await R.callAsync(chrome.cookies.get, {
        ...
        n = await R.callAsync(chrome.cookies.getAll, {
          domain: ".instagram.com",
        });
      vw((r) => {
  ...
  const Sw = Rg.ec,
    xw = {
      "Failed to fetch": Sw.noNetwork,
      "Timed out": Sw.timedOut,
      "Redirect to login": Sw.redirectToLogin,
      "Missing user": Sw.missingUser,
      400: Sw.suspended,
      "400x": Sw.missingPost,
      403: Sw.forbidden,
      404: Sw.notFound,
      429: Sw.tooManyRequests,
      500: Sw.serverIsDown,
      502: Sw.badGateway,
      503: Sw.serviceUnavailable,
      560: Sw.serviceDown,
    };
  Rg.Response = class e {
    constructor(e, t, n, r) {
    ...
    static ofNetworkError(t) {
      t &&
        ...
        (t.message = "400x");
      const n = (t && t.message && xw[t.message]) || Sw.other,
        r = (t && t.message) || null,
        o = (t && t.body) || null;
      return new e(null, n, r, o);
    }
  };
  const Pw = { headers: { "x-ig-app-id": "1217981644879628" } };
  function kw(e, t) {
    const n = Date.now();
  ...
  (Rg.api = {
    fetchViewerInfo: Tw(async function () {
      try {
        return await (async function () {
          Cg.ignoreCache();
          const e = (await Cg.fetchText("https://instagram.com"))
            .split("\n")
      ...
      try {
        return await (async function () {
          ...
          Cg.ignoreCache();
          const t = await Cg.fetchText(e, Pw),
            n = R.safeJsonParse(t);
          if (!n) return null;
    ...
    fetchLoginActivity: Tw(async function () {
      return Cg.fetchJson(Ag.loginActivity.url, Pw);
    ...
    fetchTag: Tw(async function (e, { incognito: t = !1 } = {}) {
      ...
      try {
        const n = Ag.hashtag.url(e, { json: !0 }),
          o = t ? "omit" : "include";
        Cg.ignoreCache(),
          (r = await Cg.fetchText(n, { credentials: o, ...Pw }));
      } catch (e) {
        if ("404" !== e.message) throw e;
        o = !0;
      }
      if ((Dw(r), Ew(r), o)) return (n.isBanned = !0), (n.isFlagged = !1), n;
          ...
          l = 0;
        {
          const e = r
            .map((e) => {
              ...
              return { likes: kw(r, n), comments: kw(o, n) };
            })
            .sort(
              (e, t) =>
          ...
          const e = r
            .map((e) => {
              const t = 1e3 * e.taken_at,
                n = e.like_count,
                r = e.comment_count;
              return { likes: kw(n, t), comments: kw(r, t) };
            })
            .sort(
              (e, t) =>
                R.calcEngagement(e.likes, t.comments) -
    ...
    (Rg.Publisher = class {
      ...
      async _fetch({
        ...
        const o = async () => {
          if ((n -= 1) <= 0) throw new Error("Failed to fetch");
          await R.sleep(3 * R.time.SECOND);
        ...
        try {
          ...
          return (
            console.error("Failed to fetch", { url: e, opts: t, e: n }), o()
          );
        }
        try {
          a = await i.text();
  ...
  (Iw.controller = {
    ...
    (Hg.cleanupController = {
      ...
      _cleanupState: function () {
        _g.transaction((e) => {
          const t = Hg.proxy.getAllPosts(e);
          for (const e of t) delete e.fresh;
        });
      },
      _cleanupIdb: async function () {
        const e = Date.now();
        if (e - this._lastIdbCleanupAt < 5 * R.time.MINUTE) return;
        this._lastIdbCleanupAt = e;
        const t = (await _y.controller.getAllKeys()).filter((e) =>
            e.startsWith("later.post-")
          ),
          n = Hg.proxy.getAllPosts();
        for (const e of t) {
          const t = e.split("-")[1];
          !!n.find((e) => e.id === t) || (await _y.controller.delete(e));
        }
        for (const e of n) {
          const t = await _y.controller.get(`later.post-${e.id}`);
          t &&
            "posted" === e.status &&
            (t.blob || t.coverBlob) &&
            (delete t.blob,
            delete t.coverBlob,
            await _y.controller.set(`later.post-${e.id}`, t));
        }
      },
    }),
    (Hg.controller = {
      init: function () {
        this._cleanupState(), Hg.scheduler.init(), Hg.cleanupController.init();
      },
      _cleanupState: function () {
        _g.transaction((e) => {
          e.later.posts
    ...
    (Hg.scheduler = {
      ...
      _setup: function () {
        chrome.alarms.onAlarm.addListener(({ name: e }) => {
          "later.reschedule" === e && this._reschedule();
        }),
          _g.model.observe(
            () =>
              Hg.proxy
      ...
      _reschedule: function () {
        ...
        const n = Hg.proxy.getPostOwnerState(t.id),
        ...
        if (i < -12 * R.time.HOUR)
          return (
            ...
            void Hg.proxy.updatePost(t.id, (e) => (e.status = "failed"))
          );
        if (i > 0) {
          const e = new Date(t.date).toLocaleString();
          return (
            this._log(`scheduled for ${e}`, o),
            void (this._timer = R.setTimer(() => this._reschedule(), i))
          );
        }
        (async () => {
          this._log("publish", o), (this._publishing = !0);
          const e = n.later.cookies || null,
            r = n.authStatus.userId;
          await this._publish(t, e, r),
            (this._publishing = !1),
            this._reschedule();
        })();
      },
      _publish: async function (e, t, n) {
        const r = _g.model.state,
          o = (t) => {
            Hg.proxy.updatePost(e.id, (e) => (e.status = t));
          },
          i = (t) => {
            Hg.proxy.updatePost(e.id, (e) => (e.errorMessage = t));
          };
        try {
          o("posting"),
            i(null),
            r.authStatus.userId === n && (await Hg.actualizeCookies());
          const a = Date.now() - this._lastPublishedAt,
            s = 10 * R.time.SECOND;
          a < s && (await R.sleep(s - a));
          const l = await _y.controller.get(`later.post-${e.id}`),
            u = new Rg.Publisher(t);
          "photo" === e.type
            ? await u.postPhoto(l.blob, {
                caption: e.caption,
                location: e.location,
                mentions: e.mentions,
              })
            : "video" === e.type
            ? await u.postVideo(l.blob, l.coverBlob, {
                caption: e.caption,
                location: e.location,
                mentions: e.mentions,
              })
            : "reel" === e.type
            ? await u.postReel(l.blob, l.coverBlob, {
                caption: e.caption,
                location: e.location,
                mentions: e.mentions,
            ...
            : "story-photo" === e.type
            ? await u.postStoryPhoto(l.blob, { mentions: e.mentions })
            : "story-video" === e.type &&
              (await u.postStoryVideo(l.blob, l.coverBlob, {
                mentions: e.mentions,
              })),
            o("posted"),
            Py.controller.sendEvent("user", "later:publish-success", e.type);
        } catch (t) {
          o("failed"),
            i("Error happened during posting"),
            console.error(t),
            Py.controller.sendEvent("user", "later:publish-error", e.type);
        }
    ...
    (Hg.proxy = {
      getPosts: function () {
        const e = this.getUserId(),
          t = _g.model.state,
          n = [t, ...Object.values(t.userStates)].find(
            (t) => t.authStatus.userId === e
          );
        if (!n) return [];
        const r = [...n.later.posts];
        return r.sort((e, t) => {
          if (e.date && t.date) return t.date - e.date;
          if (e.date) return 1;
          if (t.date) return -1;
          const n = r.indexOf(e);
      ...
      getAllPosts: function (e = _g.model.state) {
      ...
      getEditPost: function () {
        ...
        return this.getAllPosts().find(
          (t) =>
            t.id === e.later.editPostId &&
            "posted" !== t.status &&
            "posting" !== t.status
        );
      },
      getUsers: function () {
        const e = _g.model.state,
          t = Object.values(e.userStates),
          n = e.multiaccount.userIds;
        return [e, ...t]
          .filter((e) => n.includes(e.authStatus.userId))
          .map((e) => ({
            userId: e.authStatus.userId,
            username: e.authStatus.username,
            avatarUrl: e.authStatus.avatarUrl,
          }));
      },
      getUserId: function () {
        const e = _g.model.state;
        return e.later.userId || e.authStatus.userId;
      },
      ...
      addPost: function (e) {
        _g.transaction((t) => {
          t.later.posts.push(e);
        });
      },
      updatePost: function (e, t = () => {}) {
        _g.transaction((n) => {
          const r = this.getAllPosts(n).find((t) => t.id === e);
          r && t(r);
        });
      },
      deletePost: function (e) {
        _g.transaction((t) => {
          const n = [t, ...Object.values(t.userStates)];
          for (const t of n)
            t.later.posts = t.later.posts.filter((t) => t.id !== e);
        });
      },
      clearPosted: function () {
        _g.transaction((e) => {
          const t = [e, ...Object.values(e.userStates)].find(
            (t) => t.authStatus.userId === e.later.userId
          );
          t.later.posts = t.later.posts.filter((e) => "posted" !== e.status);
        });
      },
      toggleEditPostId: function (e) {
        _g.transaction((t) => {
          t.later.editPostId = t.later.editPostId === e ? null : e;
        });
      },
      getPostOwnerState: function (e) {
        const t = _g.model.state,
          n = [t, ...Object.values(t.userStates)].find((t) =>
            t.later.posts.some((t) => t.id === e)
          );
        return n || null;
      },
      setDate: function (e = null) {
        _g.transaction((t) => {
          t.later.date = e || null;
        });
      },
      getSelectedPill: function () {
        return _g.model.state.later.selectedPill;
      },
      setSelectedPill: function (e) {
        _g.transaction((t) => {
          t.later.selectedPill = e;
        });
      },
      isCurrentUser: function () {
        const e = _g.model.state;
        return !e.later.userId || e.later.userId === e.authStatus.userId;
      },
    });
  ...
  var jw = {
    init: function () {
      Vg.on("iframe-bus", (e, ...t) => Uw(e, ...t)),
        Mw("chrome-bus", (e, ...t) => Vg.send(e, ...t));
    },
    on: Mw,
    once: Rw,
    off: Nw,
  ...
  Py.controller = {
    ...
    _initChromeMessage: function () {
      Vg.on("ga.send-event", (...e) => {
        this.sendEvent(...e);
      });
    },
    _sendBgEvents: async function () {
      const e = (await _y.controller.get("ga.bgEvents")) || [];
      await _y.controller.set("ga.bgEvents", []);
    ...
    _ga: async function (...e) {
      if (u.is.background) {
        console.warn("GA", e);
        const t = (await _y.controller.get("ga.bgEvents")) || [];
        t.push(e), await _y.controller.set("ga.bgEvents", t);
      } else {
  ...
  var qw = {
    controller: {
      ...
      _watchForPopupTab: function () {
        Vg.on("wri.popup-tab-created", async (e) => {
  ...
  const Ww = {
      ...
      read: async function () {
        const e = Date.now(),
          t = await _y.controller.get("state");
        if (!t) return null;
      ...
      save: async function (e) {
        const t = Date.now(),
          n = this._uglify(e);
        await _y.controller.set("state", n);
        const r = Date.now() - t;
      ...
      _readStateFromDeprecatedStorage: async function () {
        ...
        if (
          ...
          return null;
        try {
          const e = $w.decompressFromUTF16(t);
          n = JSON.parse(e);
        } catch (e) {
          return console.error(e), null;
        }
    ...
    { action: Yw } = _g;
  var Jw = Yw("synch.synch-state", (e, t) => {
    if (u.is.popup) {
  ...
  const { model: Qw } = _g,
    Kw = { ...vy.getTemplateUserState(), ...vy.getTemplateSharedState() };
  var Xw = {
    controller: {
      isStorageMaster: !1,
      currentState: null,
      ...
      init: function (e, t) {
        ...
        return (
          chrome.runtime.onMessage.addListener((t, r, o) => {
            ...
            return (
              "fetch-state" === t.name && (n ? n.push(o) : o(Qw.state), !0)
            );
          }),
          Promise.resolve()
      ...
      _fetchState: function () {
        return this.isStorageMaster
          ? Ww.init()
              .then((e) => e || Kw)
              .then((e) => {
                (this.currentState = e), Qw.init(e);
              })
          : new Promise((e) => {
              chrome.runtime.sendMessage(
                { name: "fetch-state", sender: this.id },
                (t) => {
                  (this.currentState = t), Qw.init(t), e();
                }
              );
            });
      },
      _subscribeToInflux: function (e = !1) {
        this.unsubscribe = Qw.observe(
          (e) => e,
          (e) => {
      ...
      _onStateUpdatedByPeer: function (e) {
        this.unsubscribe && this.unsubscribe(),
          (this.currentState = { ...Qw.state, ...e }),
          Jw.dispatch(this.currentState),
          this._saveToStorage(this.currentState),
          this._subscribeToInflux(this.currentState !== Qw.state);
      },
      _saveToStorage: function (e) {
        this.isStorageMaster &&
          ...
          (this.storeBatchingId = setTimeout(
            () => {
              (this.storeBatchingId = null), Ww.save(e);
            },
  ...
  const { model: Zw, transaction: e_ } = _g,
          ...
          this.parent.apiSender
            ...
            .catch((t) => {
              log(`  retrieving promocode failed: ${JSON.stringify(t)}`),
                this.parent.reply(e, Zw.state.billing.promocode);
            });
        } else
    ...
    o_ = {
      ...
      updateCookie: async function (e) {
        ...
        this._isCookieEmpty(t) || (e = this._mergeTrialValues(t, e)),
          Lw.isEqual(t, e) || this._setCookie({ name: "tsd", value: e });
      },
    ...
    s_ = {
      ...
      onFSpringSubscriptionSuccess: function (e, t) {
        ...
        const n = JSON.stringify({
            subscriptions: i_.state.billing.subscriptions,
            products: i_.state.billing.products,
            orders: i_.state.billing.orders,
          }),
          r = Date.now();
        let o = 3e3;
        const i = () => {
  ...
  var l_ = {
    controller: {
      init: function () {
        (this.apiSender = new cm.Sender({ urlPrefix: u.options.apiUrl })),
          t_.init({ parent: this }),
          o_.init({ parent: this }),
          s_.init({ parent: this });
        return (
  ...
  const d_ = [
    ...
    f_ = new cm.Sender({ urlPrefix: u.options.apiUrl });
  async function p_({ key: e, filters: t, data: n } = {}) {
    if (
      ((e = e || "system"),
      (n = n || {}),
      (t = t || {}).username || (t.username = vy.proxy.username() || "unknown"),
    ...
    "string" == typeof n ||
      n.schedule ||
      (n.schedule = await $y.controller.getReport());
    try {
      n = JSON.stringify(n);
    } catch (e) {
      n = e.message;
    ...
    u.is.development &&
      Vg.send("popup.log", "%coverseer report [background]", "color: #c818dc", {
        key: e,
        filters: t,
        data: JSON.parse(n),
      }),
  ...
  var S_ = {
    controller: {
      init: async function () {
        Vg.on("insights.get-credibility-grade", __);
      },
    },
  };
  const { model: x_, transaction: P_ } = _g,
    k_ = (e) =>
      "string" != typeof e && "boolean" != typeof e && "number" != typeof e
        ...
        : e,
    D_ = function (e) {
      console.log(`%c[test] ${k_(e)}`, "color: #3d9d30");
    },
    E_ = function (e) {
      console.log(`%c[test] ${k_(e)}`, "color: #e94b35");
    },
    T_ = function (e) {
      console.log(k_(e));
    },
    I_ = {
      init: function () {
        (globalThis.$env = u),
          ...
          (globalThis.$igApi = Rg),
          (globalThis.$fbApi = Ay),
          (globalThis.$eventBus = xy),
          (globalThis.$chromeBus = Vg),
      ...
      defineCommit: function () {
        Object.defineProperty(globalThis, "commit", {
          get: () => (this.setState(x_.state), null),
        });
      },
    };
    ...
    F_ = {
      init: async function () {
        await (async function () {
          ...
          chrome.webRequest.onHeadersReceived.addListener(O_, { urls: A_ }, [
            "blocking",
            "responseHeaders",
            "extraHeaders",
          ]);
  ...
  var B_ = {},
    j_ = {
      update: function (e) {
        return e.userStates && _y.controller.delete("tag-assist.tag-data"), e;
      },
    };
  r(B_, "default", function () {
    return j_;
  }),
    n(B_);
  var L_ = {},
    ...
    _x = {
      update: function (e) {
        ...
        return (
          ...
          delete t.insights,
          (async function () {
            const e = await _y.controller.getAllKeys();
            for (const t of e)
              (t.startsWith("insights.") || t.startsWith("block:analytics:")) &&
                _y.controller.delete(t);
          })(),
          t
        );
      },
  ...
  var Ax = {},
    Ox = {
      update: function (e) {
        if (!e.userStates) return e;
        return { ...e, quickReplies: { shown: !1, content: gy(), total: 7 } };
      },
    };
  r(Ax, "default", function () {
    return Ox;
  ...
  var Yx = {},
    Jx = {
      update: function (e) {
        ...
        return (
          l_.trialController.setTrialCookie(t),
      ...
      update: async function (e) {
        ...
        try {
          const e = await new Promise((e, t) => {
            ...
            n = $w.decompressFromUTF16(t),
            r = btoa(encodeURIComponent(n));
          await _y.controller.set("state", r),
  ...
  const QP = {
      ...
      "version-206": R_(DP).default,
      "version-207": R_(TP).default,
      "version-208": R_(CP).default,
      "version-209": R_(AP).default,
      "version-210": R_(MP).default,
      "version-211": R_(NP).default,
      "version-212": R_(BP).default,
      "version-213": R_(LP).default,
      "version-214": R_(HP).default,
      "version-215": R_(zP).default,
      "version-216": R_($P).default,
      "version-217": R_(YP).default,
    },
    KP = {
      versioners: {},
      init: function () {
        ...
        Object.keys(QP)
          ...
          .forEach((e) => {
            this.versioners[e.version] = QP[e.key];
          });
      },
      update: async function (e) {
        let t = e,
  ...
  const XP = function (e) {
    ...
    { action: ZP } = _g;
  var ek = ZP("state.setup-default-state", (e) =>
    e.whatsNew
      ? e
      : {
          version: 217,
  ...
  var nk = {
    controller: {
      init: async function () {
        ek.dispatch(), await this._update();
      },
      _update: async function () {
        let e = tk.state;
        (e = await KP.update(e)), (e = XP(e)), e !== tk.state && cy.dispatch(e);
      },
    },
  };
  var rk = {
    ...
    controller: {
      ...
      _goOnline: function () {
        log("[$chromeStarter] going online"),
          null === ok.state.authStatus.userId && Oy.controller.updateUser();
      },
      _goOffline: function () {
      ...
      _recoverIfOffline: function () {
        null === ok.state.authStatus.userId &&
          (log("[$chromeStarter] trying to recover from offline"),
          Oy.controller.updateUser());
      },
  ...
  var fk = {
    ...
    pk = {
      reset: function () {
        hk(), Vg.send("reset.reset");
      },
      onReset: function (e) {
        hk(e), Vg.on("reset.reset", e);
      },
    };
  const hk = iw();
  var gk = { controller: pk },
    mk = {
      version: 128,
      dmSelectors: {
        general: {
      ...
      igSelectors: {
        general: {
          ...
          tabBarContainer: [
            ...
            ".createKeyCommandWrapper .PolarisNavigation > div",
          ],
  ...
  async function wk() {
    ...
    const n = (function () {
        ...
        return e && e.version >= mk.version ? e : mk;
      })(),
    ...
    chrome.extension.getViews({ type: "tab" }).length > 0
      ? Vg.send("fusion.new-version-available")
      : _k();
  }
  function _k() {
    bk && (R.ls.set("fusion.config", bk), location.reload());
  }
  function Sk(e, t) {
    for (const n in t)
      R.isObject(e[n]) && R.isObject(t[n]) ? Sk(e[n], t[n]) : (e[n] = t[n]);
    return e;
  }
  var xk = {
    controller: {
      init: function () {
        Vg.on("fusion.check-new-version", wk),
          Vg.on("fusion.popup-tab-id", (e) => {
            vk = e;
          }),
          gk.controller.onReset(yk),
          chrome.tabs.onRemoved.addListener((e) => {
            e === vk && bk && _k();
          }),
          Vg.on("fusion.update-now-click", () => {
            R.ls.set("fusion.reload-popup-on-background-start", !0), _k();
          }),
          R.ls.get("fusion.reload-popup-on-background-start") &&
            (R.ls.remove("fusion.reload-popup-on-background-start"),
            Vg.send("fusion.reload-popup")),
          chrome.alarms.onAlarm.addListener(async (e) => {
            "fusion.refresh-config" === e.name && wk();
          }),
  ...
  const { model: kk, transaction: Dk } = _g;
  var Ek = {
    init: function () {
      kk.observe(
  ...
  const { model: Ck, transaction: Fk } = _g;
  function Ak() {
    return {
      hasPro: true,
      freeReels: Math.max(0, 2 - Ck.state.billing.trial.reels),
      maxFreeReels: 2,
    };
  }
  async function Ok(e) {
  ...
  async function Mk() {
    Py.controller.sendEvent("user", "reels:submit", "desktop"),
      true
        ? Py.controller.sendEvent("user", "pro-paid-usage:reels", "desktop")
        : Fk((e) => {
  ...
  var Nk = {
    controller: {
      init: function () {
        Vg.on("desktop-reels.get-initial-data", Ak),
          R.watchForIgCookie("desktop-reels.open-billing", Ok),
          R.watchForIgCookie("desktop-reels.submit-success", Mk),
          R.watchForIgCookie("desktop-reels.get-initial-data", Rk);
      },
    },
  };
  !(async function () {
    let e = !1;
    Vg.on("bg.is-ready", () => e), (globalThis._ = Lw), Vw.controller.init();
    const t = fk.controller.getVersion();
    console.log(`chrome version is: ${t}`),
      ...
      Iw.controller.init(),
      Hg.controller.init(),
      Py.controller.init().sendPageview().sendInstall(),
      Oy.controller.init(),
      await Oy.controller.updateUser(),
      l_.controller.init(),
