!(function () {
  ...
  ******************************************************************************/ function dm(
  ...
  zy.controller = {
    ...
    refreshUser: async function () {
      ...
      const r = n.result || null,
        o = r && Ew.state.authStatus.userId === r.userId;
      return (
        ...
        o ||
          ...
          r
            ? Iw
              ? qg.send("iframe-bus", "ig.hard-go", Iw)
    ...
    _setAuthStatusIfAbsent: async function () {
      if ("username" in Ew.state.authStatus) return;
      Cg.ignoreCache();
    ...
    _watchAndSaveFbCookies: function () {
      let e;
      kw.controller.onRequest(({ details: n, isResponse: r, checkHost: o }) => {
        if (r && o("facebook.com")) {
    ...
    _login: async function (e) {
      var t;
      const n =
        null === (t = Ew.state.userStates[e]) || void 0 === t
          ? void 0
          : t.authStatus;
      if (n) {
    ...
    _isSessionWatcherPaused: function () {
      return Cw || Ew.state.schedule.fcsSetup.connecting;
    },
  ...
  const Ow = Rg.ec,
    Mw = {
      "Failed to fetch": Ow.noNetwork,
      "Timed out": Ow.timedOut,
      "Redirect to login": Ow.redirectToLogin,
      "Missing user": Ow.missingUser,
      400: Ow.suspended,
      "400x": Ow.missingPost,
      403: Ow.forbidden,
      404: Ow.notFound,
      429: Ow.tooManyRequests,
      500: Ow.serverIsDown,
      502: Ow.badGateway,
      503: Ow.serviceUnavailable,
      560: Ow.serviceDown,
    };
  Rg.Response = class e {
    constructor(e, t, n, r) {
    ...
    static ofNetworkError(t) {
      t &&
        ...
        (t.message = "400x");
      const n = (t && t.message && Mw[t.message]) || Ow.other,
        r = (t && t.message) || null,
        o = (t && t.body) || null;
      return new e(null, n, r, o);
    }
  };
  const Rw = { headers: { "x-ig-app-id": "1217981644879628" } };
  function Nw(e, t) {
    const n = Date.now();
  ...
  Rg.api = {
    fetchViewerInfo: Lw(async function () {
      ...
      try {
        e = await (async function () {
          ...
          Cg.ignoreCache();
          const t = await Cg.fetchText(e, Rw),
            n = R.safeJsonParse(t);
          if (!n) return null;
    ...
    fetchLoginActivity: Lw(async function () {
      return Cg.fetchJson(Ag.loginActivity.url, Rw);
    ...
    fetchTag: Lw(async function (e, { incognito: t = !1 } = {}) {
      ...
      try {
        const n = Ag.hashtag.url(e, { json: !0 }),
          o = t ? "omit" : "include";
        Cg.ignoreCache(),
          (r = await Cg.fetchText(n, { credentials: o, ...Rw }));
      } catch (e) {
    ...
    jP = {
      ...
      init: function () {
        ...
        Object.keys(UP)
          ...
          .forEach((e) => {
            this.versioners[e.version] = UP[e.key];
          });
      },
      update: async function (e) {
        let t = e,
  ...
  const LP = function (e) {
    ...
    { action: qP } = _g;
  var HP = qP("state.setup-default-state", (e) =>
    e.whatsNew
      ? e
      : {
          version: 210,
  ...
  var zP = {
    controller: {
      init: async function () {
        HP.dispatch(), await this._update();
      },
      _update: async function () {
        let e = VP.state;
        (e = await jP.update(e)), (e = LP(e)), e !== VP.state && uy.dispatch(e);
      },
    },
  };
  var GP = {
    ...
    controller: {
      ...
      _goOnline: function () {
        log("[$chromeStarter] going online"),
          null === WP.state.authStatus.userId && zy.controller.updateUser();
      },
      _goOffline: function () {
      ...
      _recoverIfOffline: function () {
        null === WP.state.authStatus.userId &&
  ...
  var eD = {
    ...
    tD = {
      reset: function () {
        nD(), qg.send("reset.reset");
      },
      onReset: function (e) {
        nD(e), qg.on("reset.reset", e);
      },
    };
  const nD = mw();
  var rD = { controller: tD },
    oD = {
      version: 128,
      dmSelectors: {
        general: {
  ...
  async function lD() {
    ...
    const n = (function () {
        ...
        return e && e.version >= oD.version ? e : oD;
      })(),
  ...
  function uD() {
    aD && (R.ls.set("fusion.config", aD), location.reload());
  }
  function cD(e, t) {
    for (const n in t)
      R.isObject(e[n]) && R.isObject(t[n]) ? cD(e[n], t[n]) : (e[n] = t[n]);
    return e;
  }
  var dD = {
    controller: {
      init: function () {
        qg.on("fusion.check-new-version", lD),
          qg.on("fusion.popup-tab-id", (e) => {
            iD = e;
          }),
          rD.controller.onReset(sD),
          chrome.tabs.onRemoved.addListener((e) => {
            e === iD && aD && uD();
          }),
          qg.on("fusion.update-now-click", () => {
            R.ls.set("fusion.reload-popup-on-background-start", !0), uD();
          }),
          ...
          chrome.alarms.onAlarm.addListener(async (e) => {
            "fusion.refresh-config" === e.name && lD();
          }),
  ...
  const { model: pD, transaction: hD } = _g;
  var gD = {
    init: function () {
      pD.observe(
  ...
  const { model: bD, transaction: yD } = _g;
  function wD() {
    return {
      hasPro: my.proxy.hasPro(),
      freeReels: Math.max(0, 2 - bD.state.billing.trial.reels),
      maxFreeReels: 2,
    };
  }
  async function _D(e) {
  ...
  var PD = {
    controller: {
      init: function () {
        qg.on("desktop-reels.get-initial-data", wD),
          R.watchForIgCookie("desktop-reels.open-billing", _D),
          R.watchForIgCookie("desktop-reels.submit-success", SD),
          R.watchForIgCookie("desktop-reels.get-initial-data", xD);
      },
    },
  };
  !(async function () {
