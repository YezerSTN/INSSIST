!function(){function t(t,e,n){Object.defineProperty(t,e,{get:n,enumerable:!0})}var e={createName:function(t,e){return`${t}|${JSON.stringify(e)}`},getName:n,getParams:function(){return function(t){try{return JSON.parse(t)}catch(t){return null}}(window.self.name.split("|")[1])||{}},isIframe:function(t=null){return window.self!==parent&&(!t||n()===t)}};function n(){return window.self.name.split("|")[0]||null}async function o(){i()||await new Promise((t=>{document.addEventListener("readystatechange",(function e(){i()&&(document.removeEventListener("readystatechange",e),t())}))}))}function i(){return"interactive"===document.readyState||"complete"===document.readyState}var a=document.documentElement,r={},s={},c={},l={},d=1;l={nextValue:function(){return(d=(9301*d+49297)%233280)/233280},seed:function(t){d=t}};var u,p,f,h="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-";function m(){f=!1}function g(t){if(t){if(t!==u){if(t.length!==h.length)throw new Error("Custom alphabet for shortid must be "+h.length+" unique characters. You submitted "+t.length+" characters: "+t);var e=t.split("").filter((function(t,e,n){return e!==n.lastIndexOf(t)}));if(e.length)throw new Error("Custom alphabet for shortid must be "+h.length+" unique characters. These characters were not unique: "+e.join(", "));u=t,m()}}else u!==h&&(u=h,m())}function _(){return f||(f=function(){u||g(h);for(var t,e=u.split(""),n=[],o=l.nextValue();e.length>0;)o=l.nextValue(),t=Math.floor(o*e.length),n.push(e.splice(t,1)[0]);return n.join("")}())}c={get:function(){return u||h},characters:function(t){return g(t),u},seed:function(t){l.seed(t),p!==t&&(m(),p=t)},lookup:function(t){return _()[t]},shuffled:_};var y="object"==typeof window&&(window.crypto||window.msCrypto),b=y&&y.getRandomValues?function(t){return y.getRandomValues(new Uint8Array(t))}:function(t){for(var e=[],n=0;n<t;n++)e.push(Math.floor(256*Math.random()));return e},w=function(t,e,n){for(var o=(2<<Math.log(e.length-1)/Math.LN2)-1,i=-~(1.6*o*n/e.length),a="";;)for(var r=t(i),s=i;s--;)if((a+=e[r[s]&o]||"").length===+n)return a};var v,S,T=function(t){for(var e,n=0,o="";!e;)o+=w(b,c.get(),1),e=t<Math.pow(16,n+1),n++;return o};var E=function(t){var e="",n=Math.floor(.001*(Date.now()-1567752802062));return n===S?v++:(v=0,S=n),e+=T(7),e+=T(t),v>0&&(e+=T(v)),e+=T(n)};var P,C=function(t){return!(!t||"string"!=typeof t||t.length<6)&&!new RegExp("[^"+c.get().replace(/[|\\{}()[\]^$+*?.-]/g,"\\$&")+"]").test(t)},O=!1;var M=(O||(O=!0,P={},P=0),P||0);function x(){return E(M)}var I=x;(s=x).generate=I;var A=function(t){return c.seed(t),s};s.seed=A;var L=function(t){return M=t,s};s.worker=L;var D=function(t){return void 0!==t&&c.characters(t),c.shuffled()};s.characters=D;var k=C;function R(t){return Array.isArray(t)?t:[t]}function F(t,e=document){t=R(t);for(const n of t){const t=e.querySelector(n);if(t)return t}return null}function N(t,e=document){t=R(t);const n=[];for(const o of t){const t=e.querySelectorAll(o);for(const e of t)n.includes(e)||n.push(e)}return n}s.isValid=k,r=s;var $={on:function(t,e){j();(q[t]||(q[t]=[])).push(e)},off:function(t,e){const n=q[t];if(!n)return;for(;;){const t=n.findIndex((t=>t===e));if(-1===t)break;n.splice(t,1)}},send:function(t,...e){let n;const o=e[e.length-1];"function"==typeof o?(n=o,e=e.slice(0,-1)):n=null;return new Promise((o=>{chrome.runtime.sendMessage({[H]:t,[U]:e},(t=>{chrome.runtime.lastError||t!==B&&(n&&n(t),o(t))}))}))}};const B="__chromeBus.EMPTY_RESPONSE",q={},H="__chromeBus.name",U="__chromeBus.args";function j(){const t=j;t.init||(t.init=!0,chrome.runtime.onMessage.addListener(((t,e,n)=>{const o=t["__chromeBus.name"];if(!o)return!1;const i=t["__chromeBus.args"]||[],a=q[o]||[];return 0===a.length?(n(B),!0):((async()=>{const t=await Promise.all(a.map((t=>t(...i)))),e=t[t.length-1];n(e)})(),!!n)})))}var G={init:function(){$.on("iframe-bus",((t,...e)=>Q(t,...e))),J("chrome-bus",((t,...e)=>$.send(t,...e)))},on:J,once:K,off:X,send:Q,wait:async function(t){return await new Promise((e=>{K(t,e)}))}};const z="__iframeBus.name",W="__iframeBus.args",V="__iframeBus.callbackId",Y=parent!==window;function J(t,e){const n=Z(t),o=e["__iframeBus.handlers"]||(e["__iframeBus.handlers"]={});o[t]=async o=>{if(o.data["__iframeBus.name"]===n){const n=o.data["__iframeBus.args"]||[],i=o.data["__iframeBus.callbackId"]||null,a=await e(...n);i&&Q(`${t}:response-${i}`,a)}},window.addEventListener("message",o[t])}function K(t,e){J(t,(function n(...o){return X(t,n),e(...o)}))}function X(t,e){const n=e["__iframeBus.handlers"]||(e["__iframeBus.handlers"]={});window.removeEventListener("message",n[t])}async function Q(t,...e){let n;const o=e[e.length-1];"function"==typeof o?(n=o,e=e.slice(0,-1)):n=null;const i=t.includes(":response-"),a=Z(t),s=i?null:r.generate();if(Y?parent.postMessage({[z]:a,[W]:e,[V]:s},"*"):N("iframe").forEach((t=>{t.contentWindow.postMessage({[z]:a,[W]:e,[V]:s},"*")})),!i)return new Promise((e=>{const o=i=>{n&&n(i),X(`${t}:response-${s}`,o),e(i)};J(`${t}:response-${s}`,o)}))}function Z(t){return`iframe-bus.${t}`}function tt(t,...e){let n=0;return t.join("###").split(",").join("\n,\n").split("{").join("\n{").split("\n").map((t=>{if(!t.includes("###"))return t;const o=R(e[n]).map((e=>t.split("###").join(e))).join(",\n");return n+=1,o})).join("\n").split(";").join(" !important;").replace(/!important\s*!important/g,"!important")}function et(...t){const e=tt(...t);document.head.insertAdjacentHTML("afterbegin",e)}var nt=Object.assign((function(t,e=!1){0===ot.length&&(it=new MutationObserver((t=>{for(const e of ot){it.disconnect();try{e(t)}catch(t){console.error("onDocMutations",t)}if(!it)return;it.observe(document.documentElement,{attributes:!0,childList:!0,subtree:!0})}})),it.observe(document.documentElement,{attributes:!0,childList:!0,subtree:!0}));ot.push(t),e&&t()}),{off:function(t){const e=ot.indexOf(t);if(-1===e)return;ot.splice(e,1),0===ot.length&&(it.disconnect(),it=null)}});const ot=[];let it;var at={getConfig:function t(){const n=t;if(!n.config){const t=e.getParams();n.config=t.fusionConfig}return n.config}};var rt=function(){et`
  ...
  `}(),async function(){const t=window.inssist.schedule.requireModule,e=await t(pe.ImageExifRotation);if(!e)return;e.getRotation=(t,e)=>(e&&"function"==typeof e&&e(0),0)}()}};let ue,pe;function fe(t){t||yt.throwError({message:"startUpload: failed to find upload button"}),t.click();const e=F(ue.upload.input);e||yt.throwError({message:"startUpload: failed to find upload input"});const n=e.closest(ue.tooltip.root);n||yt.throwError({message:"startUpload: failed to find upload tooltip"}),n.style.opacity=0,n.style.pointerEvents="none",e.click()}var he={init:async function(){G.on("schedule.connect-via-fb",me),G.on("schedule.connect-via-ig",ge)}};async function me(){if(await Ft.waitForInit(),!Ft.dispatch)return{error:"failed-to-init-dispatcher"};const t=await gt((()=>F(".MediaManagerInstagramContentPostsTabContainer")||F('[role="tab"][aria-selected="true"]')?"content":F(".MediaManagerInstagramOnboardingScreen")?"welcome":null));if(!t)return{error:"failed-to-detect-page-type"};"content"===t&&(Ft.dispatch({type:"SELECT_TAB",tab:"instagram_accounts",source:"left_nav"}),await gt((()=>location.href.includes("instagram_accounts"))),await gt((()=>F(".MediaManagerInstagramTabHeaderContainer")))),Ft.dispatch({type:"SET_SHOW_INSTAGRAM_ONBOARDING_DIALOG",shown:!0}),await gt((()=>F(".MediaManagerInstagramAccountPermissionMessageDialog")));const e=await new Promise((t=>{let e;const n=window.open;window.open=(o,i,a)=>{if(!o.includes("/oauth/authorize/"))return n(o,i,a);(async()=>{a=_e();const r=n(o,i,a);window.open=n,await gt((()=>r.closed)),e=setTimeout((()=>{t({error:"auth-window-closed-by-user"})}),5e3)})()};const o=window.require("ReloadPage"),i=o.now;o.now=()=>{clearTimeout(e),o.now=i,t({success:!0})},Ft.onDispatch((n=>{clearTimeout(e),"SET_LOGIN_INSTAGRAM_ACCOUNT_SUCCESS"===n.type&&t({error:"not-connected-to-fb-page"})})),Ft.dispatch({type:"AUTHENTICATE_INSTAGRAM_USER"})}));return Ft.dispatch({type:"SELECT_TAB",tab:"instagram_content",source:"left_nav"}),await gt((()=>location.href.includes("instagram_content"))),e}async function ge(){if(await Ft.waitForInit(),!Ft.dispatch)return{error:"failed-to-init-dispatcher"};return await new Promise((t=>{let e;const n=window.open;window.open=(o,i,a)=>{if(!(o=o.toString()).includes("/oauth/authorize/"))return n(o,i,a);(async()=>{a=_e();const r=n(o,i,a);window.open=n,await gt((()=>r.closed)),e=setTimeout((()=>{t({error:"auth-window-closed-by-user"})}),5e3)})()};const o=window.require("URI"),i=o.goURIOnWindow;o.goURIOnWindow=(...n)=>{clearTimeout(e),o.goURIOnWindow=i,t({success:!0})},window.dispatchController=Ft,Ft.dispatch({type:"IG_AUTHENTICATION_LOG_IN"})}))}function _e(){return`scrollbars,top=${Math.round(screen.height/2-350)},left=${Math.round(screen.width/2-300)},width=600,height=700`}var ye={init:async function(){if(be=at.getConfig().fcsSelectors,we=at.getConfig().fcs,await At.waitForInit(),await Ft.waitForInit(),!lt.user)return;(function(){let t,e;nt((()=>{t=N(be.sidePanel.mediaPreview),e=F(be.sidePanel.mediaPreviewVideo)})),ht.onRequest((({url:n,onResponse:o})=>{if(!function(t){return t.includes(we["/media/manager/instagram_composer/create_post"])}(n))return;let i,a;i=t.length>1?"carousel":e?"video":"photo",t.length>0?a=t[0].getAttribute("src"):console.error("failed to find media preview image"),G.send("schedule.fcs-create-post-request",{type:i,image:a,crosspostToFb:lt.crosspostToFb,localPostId:lt.selectedPostId||null}),o((()=>{G.send("schedule.fcs-create-post-response",{image:a})}))})),ht.onRequest((({url:t,query:e,onResponse:n})=>{if(!function(t){return t.includes(we["/media/manager/instagram_media/edit/save"])}(t))return;const o=lt.selectedPostId;let i,a;"true"===e[we["edit_data[save_as_draft]"]]?(i=null,a="draft"):"true"===e[we["edit_data[save_as_scheduled]"]]?(i=ve,a="scheduled"):(i=null,a="posted"),G.send("schedule.fcs-edit-post-request",{postId:o,status:a,on:i}),n((t=>{G.send("schedule.fcs-edit-post-response",{postId:o,status:a})}))}))})(),function(){const t=we.MIN_MINUTES_FROM_NOW;et`
    <style>
      ${be.dateDialog.root} {
        position: fixed;
        left: 10000px;
  ...
  `}(t),function(){let t,e;G.on("schedule.fcs-date-dialog-set-selected-option",(e=>{t=e,n()})),G.on("schedule.fcs-date-dialog-set-publish-time",(t=>{e=t,n()})),Ft.onDispatch((t=>{t.type===xe.TOGGLE_CROSSPOST_TO_FACEBOOK_CHECKBOX&&n()}));const n=()=>{"save-as-draft"===t?Ft.dispatch({type:xe.SWITCH_CROSSPOST_POST_MODE,[xe.postMode]:xe.postModeDraft}):"publish-now"===t?Ft.dispatch({type:xe.SWITCH_CROSSPOST_POST_MODE,[xe.postMode]:xe.postModePublish}):"schedule"===t&&(Ft.dispatch({type:xe.SWITCH_CROSSPOST_POST_MODE,[xe.postMode]:xe.postModeSchedule}),e&&Ft.dispatch({type:xe.SELECT_CROSSPOST_SCHEDULED_DATE,[xe.scheduledDate]:new Date(e)}))}}(),function(t){const e=Symbol("handled");nt((async()=>{const n=F(".delete-post-button");if(!n)return;if(n[e])return;n[e]=!0;const o=await G.send("schedule.get-post",lt.selectedPostId);if(!o)return;if(!o.crosspostToFb)return;let i;i="draft"===o.status?`${t.url}/publishing_tools?section=DRAFTS`:"scheduled"===o.status?`${t.url}/publishing_tools?section=SCHEDULED_POSTS`:`${t.url}/publishing_tools`,n.insertAdjacentHTML("afterend",`\n      <a\n        class="manage-fb-posts-link"\n        href="${i}"\n        target="_blank">\n        MANAGE FACEBOOK POSTS\n      </a>\n      <div style="flex-grow: 1"></div>\n    `)}),!0),et`
    <style>
